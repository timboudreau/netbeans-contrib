...
/**
 * Based on org.netbeans.modules.php.editor.PHPCodeCompletion
 *
 * @author Andrea Lucarelli
 */
/*
public class AdaCodeCompletion implements CodeCompletionHandler {
    private static final Logger LOGGER = Logger.getLogger(AdaCodeCompletion.class.getName());
