...
/**
 * Represent a delay statement
 * <pre>e.g.<pre> 
 * delay 3.0; -- delay 3.0 seconds
 * delay until Next_Time; -- ex. Next_Time : Time := Clock + Period;
 */
public class DelayStatement extends Statement {

    private Expression expression;

    public DelayStatement(int start, int end, Expression expr) {
        super(start, end);
        this.expression = expr;
    }

    /**
     * Returns the expression of this delay statement.
     * 
