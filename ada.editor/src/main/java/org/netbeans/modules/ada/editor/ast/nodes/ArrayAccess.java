...
/**
 * Based on org.netbeans.modules.php.editor.parser.astnodes.ArrayAccess
 * 
...
public class ArrayAccess extends Variable {
    ...
    public ArrayAccess(int start, int end, Identifier variableName, Expression index, ArrayAccess.Type arrayType) {
