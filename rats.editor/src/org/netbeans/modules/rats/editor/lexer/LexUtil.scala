...
import org.netbeans.modules.rats.editor.lexer.RatsTokenId._
...
/**
 * Special functions for RatsTokenId
 */
trait LanguageLexUtil {
  protected val language = RatsTokenId.language

  protected val LPAREN = RatsTokenId.LParen
  protected val RPAREN = RatsTokenId.RParen
  protected val LINE_COMMENT = RatsTokenId.LineComment

  protected val Ws = RatsTokenId.Ws

  protected val WS = Set(RatsTokenId.Ws,
                         RatsTokenId.Nl
  )

  protected val WS_COMMENT = Set(RatsTokenId.Ws,
                                 RatsTokenId.Nl,
                                 RatsTokenId.LineComment,
                                 RatsTokenId.DocCommentStart,
                                 RatsTokenId.DocCommentBody,
                                 RatsTokenId.DocCommentEnd,
                                 RatsTokenId.BlockCommentStart,
                                 RatsTokenId.BlockCommentBody,
                                 RatsTokenId.BlockCommentEnd,
                                 RatsTokenId.CommentTag
  )


  def isWs(id:TokenId) = {id == RatsTokenId.Ws}
  def isNl(id:TokenId) = {id == RatsTokenId.Nl}

  def isComment(id:TokenId) :Boolean = id match {
    case RatsTokenId.LineComment => true
    case RatsTokenId.DocCommentStart => true
    case RatsTokenId.DocCommentBody => true
    case RatsTokenId.DocCommentEnd => true
    case RatsTokenId.BlockCommentStart => true
    case RatsTokenId.BlockCommentBody => true
    case RatsTokenId.BlockCommentEnd => true
    case RatsTokenId.CommentTag  => true
    case _ => false
  }
