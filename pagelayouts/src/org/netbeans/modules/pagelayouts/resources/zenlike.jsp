...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${folder}/zenlike/default.css" />
    </head>
    <body>
            ...
            <div id="content">
                ...
                <div id="normalcontent">
                    ...
                    <div class="contentarea">
                        ...
                        <img src="${folder}/zenlike/images/pic1.jpg" class="left" alt="A chinese lion statue" />
                ...
                <div id="primarycontainer">
                    <div id="primarycontent">
                        ...
                        <div class="post">
                            ...
                            <div class="contentarea">
                                <div class="details">Posted by <a href="#">Jane Doe</a> on September 25, 2006</div>	
                                <img src="${folder}/zenlike/images/pic3.jpg" class="left" alt="A chinese dragon" />
                ...
                <div id="secondarycontent">
                    ...
                    <div class="box">
                        ...
                        <div class="contentarea">
                            <img src="${folder}/zenlike/images/pic2.jpg" class="left" alt="Random foliage" />
