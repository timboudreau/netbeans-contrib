...
public class AccPropPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel7.setLayout(new java.awt.GridLayout(13, 1));

        defaultColor = this.getForeground();
        isLabel.setForeground(java.awt.Color.black);
        isLabel.setText("Implements Accessible");
        jPanel7.add(isLabel);

        anLabel.setForeground(java.awt.Color.black);
        anLabel.setText("Accessible Name");
        jPanel7.add(anLabel);

        adLabel.setForeground(java.awt.Color.black);
        adLabel.setText("Accessible Description");
        jPanel7.add(adLabel);

        jPanel7.add(jSeparator11);

        jLabel1211.setForeground(java.awt.Color.black);
        jLabel1211.setText(" Layout");
        jPanel7.add(jLabel1211);

        jLabel121.setForeground(java.awt.Color.black);
        ...
        jLabel151.setForeground(java.awt.Color.black);
        ...
        jLabel161.setForeground(java.awt.Color.black);
        jLabel161.setText(" Focusable");
        jPanel7.add(jLabel161);

        jPanel81.add(jPanel7);

        jPanel8.setLayout(new java.awt.GridLayout(13, 1));
