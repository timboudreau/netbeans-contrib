...
package org.netbeans.modules.erlang.platform.gems;
...
import org.netbeans.modules.erlang.platform.PlatformComponentFactory;
import org.netbeans.modules.erlang.platform.RubyPlatformCustomizer;
...
public final class GemPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {
        ...
        platforms = PlatformComponentFactory.getRubyPlatformsComboxBox();
    ...
    */
    ...
    private void showGemErrors(final List<String> errors) {
        ...
        Util.notifyLocalized(GemPanel.class, "GemPanel.NoNetwork", NotifyDescriptor.ERROR_MESSAGE, new Object[] { sb.toString() });
    }
