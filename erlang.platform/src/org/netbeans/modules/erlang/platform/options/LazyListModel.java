...
implements ListModel, Runnable, javax.swing.event.ListDataListener {
    ...
    /** This method is currently called from org.openide.nodes.EntrySupport to create lazy filtering list
     * for nodes, excludes everything that is not node, as default value it return null
     * @param model model to filter
     */
    public static LazyListModel create (final org.openide.nodes.Children.Keys ch, ListModel model) {
        class NodeF implements Filter {
            private java.lang.reflect.Method m;
            
            public boolean accept (Object obj) {
                return obj instanceof org.openide.nodes.Node;
            }
        ...
        return create (model, new NodeF (), 1.0, null);
    }
