...
public final class ErlangOptionsCategory extends OptionsCategory {
	...
	return NbBundle.getMessage(ErlangOptionsCategory.class, "OptionsCategory_Name");
    }
    
    public String getTitle() {
	return NbBundle.getMessage(ErlangOptionsCategory.class, "OptionsCategory_Title");
    }
    
    public OptionsPanelController create() {
	return new ErlangOptionsPanelController();
    }
}
