...
import org.netbeans.modules.erlang.platform.gsf.Formatter;
...
public class FmtOptions {
    ...
    public static Preferences getPreferences() {
        return MimeLookup.getLookup(Erlang.MIME_TYPE).lookup(Preferences.class);
    }
    ...
    public static Class<? extends EditorKit> getKitClass() {
        if (kitClass == null) {
            EditorKit kit = MimeLookup.getLookup(MimePath.get(Erlang.MIME_TYPE)).lookup(EditorKit.class); //NOI18N
    ...
    public static class CategorySupport extends FormatingOptionsPanel.Category implements ActionListener, DocumentListener {
        ...
        public static final String OPTION_ID = "org.netbeans.modules.erlang.platform.options.FormatingOptions.ID";
        ...
        public void refreshPreview(JEditorPane pane, Preferences p) {
            ...
            try {
                ...
                doc.putProperty("mimeType", Erlang.MIME_TYPE);
//                doc.putProperty(org.netbeans.api.lexer.Language.class, );
        ...
        private void storeData(JComponent jc, String optionID, Preferences p) {
            Preferences node = p == null ? getPreferences() : p;
