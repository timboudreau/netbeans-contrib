...
public class NewCarWizardVisualPanel extends JPanel implements DocumentListener {

    // FIXME -- I created this via copy and paste on project template wizard
    // it should be cleaned up and made nice for how I am actually trying to use it.
    
    public static final String PROP_PROJECT_NAME = "projectName";
    private NewCarWizardPanel panel;

    public NewCarWizardVisualPanel(NewCarWizardPanel panel) {
        initComponents();
        this.panel = panel;
