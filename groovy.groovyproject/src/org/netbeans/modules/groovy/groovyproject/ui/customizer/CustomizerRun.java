 ...
 * @author  phrebejk
 */
public class CustomizerRun extends JPanel implements GroovyCustomizer.Panel, HelpCtx.Provider {
    
    // Helper for storing properties
    private GroovyProjectProperties groovyProperties;
    private VisualPropertySupport vps;
    private VisualClasspathSupport vcs;
    private VisualMainScriptSupport vms;
    
    /** Creates new form CustomizerCompile */
    public CustomizerRun( GroovyProjectProperties groovyProperties ) {
        initComponents();                
        ...
        vcs = new VisualClasspathSupport(
            ...
            jButtonMoveUp,
            jButtonMoveDown );
        Project p = groovyProperties.getProject ();

        // better way to obtain the source directory
        // groovyProperties.get(SRC_DIR) returns non-evaluated
        // property for a project with existing sources
        // which cannot be used for construct sources root
        FileObject sourceRoot = GroovyProjectUtil.getProjectSourceDirectory (p);
        vms = new VisualMainScriptSupport (jTextFieldMainScript, jButtonMainScript, sourceRoot);
    }
    
    
    public void initValues() {
        
        vps.register (vms, GroovyProjectProperties.MAIN_SCRIPT);
        vps.register( jTextFieldArgs, GroovyProjectProperties.APPLICATION_ARGS );
        vps.register( vcs, GroovyProjectProperties.RUN_CLASSPATH );
        vps.register( jTextVMOptions, GroovyProjectProperties.RUN_JVM_ARGS);
        vps.register( jTextWorkingDirectory, GroovyProjectProperties.RUN_WORK_DIR);
   
        jButtonMainScript.setVisible( true );
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabelMainScript = new javax.swing.JLabel();
        jTextFieldMainScript = new javax.swing.JTextField();
        jButtonMainScript = new javax.swing.JButton();
        ...
        jLabelMainScript.setLabelFor(jTextFieldMainScript);
        org.openide.awt.Mnemonics.setLocalizedText(jLabelMainScript, org.openide.util.NbBundle.getMessage(CustomizerRun.class, "LBL_CustomizeRun_Run_MainScript_JLabel"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(12, 12, 5, 0);
        add(jLabelMainScript, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(12, 12, 5, 0);
        add(jTextFieldMainScript, gridBagConstraints);
        jTextFieldMainScript.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getBundle(CustomizerRun.class).getString("AD_jTextFieldMainScript"));

        org.openide.awt.Mnemonics.setLocalizedText(jButtonMainScript, org.openide.util.NbBundle.getMessage(CustomizerRun.class, "LBL_CustomizeRun_Run_MainScript_JButton"));
        jButtonMainScript.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonMainScriptActionPerformed(evt);
            }
        });
        ...
        add(jButtonMainScript, gridBagConstraints);
        jButtonMainScript.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getBundle(CustomizerRun.class).getString("AD_jButtonMainScript"));
        ...
        jLabelWorkingDirectory.setLabelFor(jTextFieldMainScript);
        ...
        jLabelVMOptions.setLabelFor(jTextFieldMainScript);
        ...
        jLabelVMOptionsExample.setLabelFor(jTextFieldMainScript);
    ...
    private void jButtonMainScriptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMainScriptActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonMainScriptActionPerformed
    ...
    private void jButtonWorkingDirectoryBrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonWorkingDirectoryBrowseActionPerformed
        ...
        if (workDir.equals("")) {
            workDir = FileUtil.toFile(groovyProperties.getProject().getProjectDirectory()).getAbsolutePath();
        }
    ...
    private javax.swing.JTextField jTextFieldMainScript;
