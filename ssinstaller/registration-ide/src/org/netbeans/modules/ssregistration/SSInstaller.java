 ...
 * 
 */
public class SSInstaller extends ModuleInstall {
    
    private static final String KEY_ENABLED = "nb.registration.enabled";
    
    private static final Logger LOG = Logger.getLogger("org.netbeans.modules.registration.SSInstaller"); // NOI18N
    
    public static String PRODUCT_ID = "ss";
    ...
    public void restored() {        
        ...
        if (value != null) {
            ...
            String s = NbBundle.getMessage(SSInstaller.class,KEY_ENABLED);
            if ("false".equals(s)) {
                moduleEnabled = false;
                LOG.log(Level.FINE,"Set moduleEnabled: " + moduleEnabled);
        ...
        try {
            SSServiceTagSupport.createSSServiceTag (NbBundle.getMessage
                    (SSInstaller.class,"nb.product.name"));
