...
public class ReminderPanel extends javax.swing.JPanel {
    ...
    private void loadImages () {
        ...
        img = Utilities.loadImage("org/netbeans/modules/ssregistration/resources/sun.png");
        icon = new ImageIcon(img);
        jLeftLabel.setIcon(icon);
        /*
        img = Utilities.loadImage("org/netbeans/modules/ssregistration/resources/netbeans.png");
        icon = new ImageIcon(img);
        jRightLabel.setIcon(icon);
        */
        img = Utilities.loadImage("org/netbeans/modules/ssregistration/resources/dot.png");
        icon = new ImageIcon(img);
