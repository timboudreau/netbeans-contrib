 ...
 * @author ks152834
 */
public class CreateBundle2 extends Task {
    ...
    public void setComponentList(File list) {
    ...
    public void execute() throws BuildException {
        try {
            ...
            if ( componentList != null && componentList.exists()) {
                BufferedReader reader = new BufferedReader( new FileReader(componentList));
                String line;
