...
public class Solaris10CPUInfoParser extends SolarisCPUInfoParser {

    private final String PARAMETERS = "-vp";
    ...
    protected String extractCPUInformation() {
        ...
        if (lines != null) {
            if (lines.size() >= 3) {
                ...
                int i = lines.get(1).indexOf("(");
                return (i != -1)? lines.get(1).substring(0, i - 1).trim(): null;
            }
        }
        return null;
    }
