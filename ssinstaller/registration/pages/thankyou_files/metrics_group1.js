...
/* Author: Neil Evans */
/* metrics_group1.V1.0 - Base Code */
/* metrics_group1.V1.1 - Added Pre & Post Plugin Functions */
/* metrics_group1.V1.2 - Take out s.currencyCode="USD" */
/* metrics_group1.V1.3 - Add if() statements for linkTrackVars & linkTrackEvents. Add s_resetstandard() */
/* metrics_group1.V1.4 - Only set pageName if s_pageType="" */
/* metrics_group1.V1.5 - Only set campaign if cid <30 */
/* metrics_group1.V1.6 - jsession remover */
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,doc,pdf,xls,bin,tar,Z,gz,txt,bz2,mp4"
s.linkInternalFilters="javascript:,sun.com,java.com,opensolaris.org,sun-catalogue.com,java.net,netbeans.org,openmediacommons.org,sunspotworld.com,openoffice.org,opensparc.net,sunsource.net"
