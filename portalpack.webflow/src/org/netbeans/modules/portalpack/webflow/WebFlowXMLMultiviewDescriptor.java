...
public class WebFlowXMLMultiviewDescriptor implements MultiViewDescription, Serializable{
    ...
    public WebFlowXMLMultiviewDescriptor(WebFlowEditorContext context) {
    ...
    public MultiViewElement createElement() {
        ...
        try {
            ...
            WebFlowDataObject jsfDataObject = (WebFlowDataObject) dObject;
    ...
    class WebFlowMultiviewElement extends CloneableEditor implements MultiViewElement, Serializable {
        ...
        private transient WebFlowDataObject jsfDataObject;
        
        public WebFlowMultiviewElement(WebFlowEditorContext context, WebFlowEditorSupport support) {
            super(support);
        ...
        private void init() {            
            try {
                ...
                jsfDataObject = (WebFlowDataObject) dObject;
            }
            catch (DataObjectNotFoundException ex) {
