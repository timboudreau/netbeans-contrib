 ...
 * @author satyaranjan
 */
class WebFlowSceneUtility {

    public static void addShapeToScene(WebFlowScene scene,ShapeNode shapeNode, Point point) {
        Shape s;
        try {
            s = shapeNode.getShape().getClone();
            Widget widget = scene.addNode(s);
