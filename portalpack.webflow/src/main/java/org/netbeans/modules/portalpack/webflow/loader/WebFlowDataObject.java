...
import org.netbeans.modules.portalpack.webflow.SAXParseError;
import org.netbeans.modules.portalpack.webflow.WebFlowEditorSupport;
...
public class WebFlowDataObject extends MultiDataObject implements org.openide.nodes.CookieSet.Factory {
    ...
    private transient WebFlowEditorSupport editorSupport;
    ...
    public WebFlowDataObject(FileObject pf, WebFlowDataLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
        CookieSet cookies = getCookieSet();
        getCookieSet().add(WebFlowEditorSupport.class, this);
    ...
    protected Node createNodeDelegate() {
        return new WebFlowDataNode(this, getLookup());
    }

     /** Implements <code>CookieSet.Factory</code> interface. */
    public Node.Cookie createCookie(Class clazz) {
        if(clazz.isAssignableFrom(WebFlowEditorSupport.class))
    ...
    public WebFlowEditorSupport getEditorSupport() {
        if(editorSupport == null) {
            synchronized(this) {
                if(editorSupport == null)
                    editorSupport = new WebFlowEditorSupport(this);
            }
        }
...
//            }
    ...
    */
    ...
    public static class J2eeErrorHandler implements ErrorHandler {
        ...
        public J2eeErrorHandler(WebFlowDataObject obj) {
             dataObject=obj;
        }
