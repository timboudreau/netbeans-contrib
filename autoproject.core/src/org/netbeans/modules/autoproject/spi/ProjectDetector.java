...
/**
 * Permit natures to detect project directories.
 * Register in global lookup.
 */
public interface ProjectDetector {

    /**
     * Check whether this is a project directory.
     * @param projectDirectory a candidate directory
     * @return true if this is a project
     * @see ProjectFactory#isProject
     */
