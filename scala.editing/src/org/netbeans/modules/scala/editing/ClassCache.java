...
public class ClassCache {
    ...
    private void initialize(ScalaIndex index) {
        if (superClasses == null) {
            superClasses = index.getAllExtends();
        }
    }
    
    public String getExtends(String fqn, ScalaIndex index) {
        initialize(index);
        
        return superClasses.get(fqn);
    }
    
    public List<String> getAncestors(String fqn, ScalaIndex index) {
        initialize(index);
