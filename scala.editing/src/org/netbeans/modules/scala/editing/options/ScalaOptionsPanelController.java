 ...
 * @author Caoyuan Deng
 */
final class ScalaOptionsPanelController extends OptionsPanelController {
    
    private static final String TAB_FOLDER = "org.netbeans.modules.scala/options/";
    ...
    public ScalaOptionsPanelController() {
        readPanels();
    }
