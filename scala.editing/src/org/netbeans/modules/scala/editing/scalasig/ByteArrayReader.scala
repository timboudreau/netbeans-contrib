...
// $Id: ByteArrayReader.scala 5837 2006-02-23 17:37:25Z michelou $
...
class ByteArrayReader(content: Array[Byte]) {
  ...
  /** read a float
   */
  def nextFloat: Float = _root_.java.lang.Float.intBitsToFloat(nextInt)

  /** read a double
   */
  def nextDouble: Double = _root_.java.lang.Double.longBitsToDouble(nextLong)
   ...
   */
  def getFloat(bp: Int): Float = _root_.java.lang.Float.intBitsToFloat(getInt(bp))

  /** extract a double at position bp from buf
   */
  def getDouble(bp: Int): Double = _root_.java.lang.Double.longBitsToDouble(getLong(bp))
