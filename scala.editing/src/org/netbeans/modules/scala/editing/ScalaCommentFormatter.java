...
public class ScalaCommentFormatter {
    ...
    private final TokenSequence<ScalaTokenId> ts;
    ...
    public ScalaCommentFormatter(String comment) {
        ...
        TokenHierarchy<?> hi = TokenHierarchy.create(comment, ScalaTokenId.language());
        this.ts = hi.tokenSequence(ScalaTokenId.language());
    ...
    String toHtml() {
        ...
        if (!formattedComment && summary.length() > 0) {
            ...
            if (summaryText.length() > 0) {
                sb.append("<b>");
                sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "Summary"));
        ...
        if (deprecation != null) {
            ...
            sb.append(">");
            sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "Deprecated"));
            sb.append("</b>");
        ...
        if (params.size() > 0) {
            sb.append("<b>");
            sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "Parameters"));
        ...
        if (returnTag != null || returnType != null) {
            sb.append("<b>"); // NOI18N
            sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "Returns"));
            sb.append("</b><blockquote>"); //NOI18N
            if (returnTag != null) {
                sb.append(returnTag);
                if (returnType != null) {
            ...
            if (returnType != null) {
                sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "ReturnType"));
                sb.append(" <i>"); // NOI18N
        ...
        if (exceptions.size() > 0) {
            sb.append("<b>");
            sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "Throws"));
            sb.append("</b><blockquote>"); //NOI18N
        ...
        if (code != null) {
            sb.append("<b>");
            sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "CodeExample"));
            sb.append("</b><blockquote>"); //NOI18N
        ...
        if (rest.length() > 0) {
            sb.append("<b>");
            sb.append(NbBundle.getMessage(ScalaCommentFormatter.class, "Miscellaneous"));
            sb.append("</b><blockquote>"); //NOI18N
            sb.append(rest);
            sb.append("</blockquote>"); // NOI18N
        }
