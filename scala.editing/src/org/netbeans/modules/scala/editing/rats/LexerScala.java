...
// on Sunday, March 30, 2008 at 9:56:06 PM.
...
public final class LexerScala extends ParserBase {
  ...
  private Result pSeparator(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = GNode.create("Separator", v$g$2);
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = GNode.create("Separator", v$g$3);
    ...
    yyResult = pRParen(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Node v$g$4 = yyResult.semanticValue();

      yyValue = GNode.create("Separator", v$g$4);
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = GNode.create("Separator", v$g$5);
    ...
    yyResult = pRBracket(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Node v$g$6 = yyResult.semanticValue();

      yyValue = GNode.create("Separator", v$g$6);
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = GNode.create("Separator", v$g$7);
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = GNode.create("Separator", v$g$8);
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = GNode.create("Separator", v$g$9);
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = GNode.create("Separator", v$g$10);
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Symbol.LBrace.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pLBrace(final int yyStart) throws IOException {
    ...
    // Done.
    yyError = yyError.select("l brace expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Symbol.RBrace.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pRBrace(final int yyStart) throws IOException {
    ...
    if ('}' == yyC) {
      ...
      yyValue = GNode.create("RBrace", v$g$1);

      return new SemanticValue(yyValue, yyIndex, yyError);
    }

    // Done.
    yyError = yyError.select("r brace expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Symbol.LParen.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pLParen(final int yyStart) throws IOException {
    ...
    if ('(' == yyC) {
      ...
      yyValue = GNode.create("LParen", v$g$1);
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Symbol.RParen.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pRParen(final int yyStart) throws IOException {
    ...
    if (')' == yyC) {
      ...
      yyValue = GNode.create("RParen", v$g$1);
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.scala.editing.rats.Symbol.LBracket.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pLBracket(final int yyStart) throws IOException {
    ...
    if ('[' == yyC) {
      ...
      yyValue = GNode.create("LBracket", v$g$1);
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.scala.editing.rats.Symbol.RBracket.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pRBracket(final int yyStart) throws IOException {
    ...
    if (']' == yyC) {
      ...
      yyValue = GNode.create("RBracket", v$g$1);
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Symbol.Comma.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pComma(final int yyStart) throws IOException {
    ...
    if (',' == yyC) {
      ...
      yyValue = GNode.create("Comma", v$g$1);
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Symbol.Dot.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pDot(final int yyStart) throws IOException {
    ...
    if ('.' == yyC) {
      ...
      yyValue = GNode.create("Dot", v$g$1);
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.scala.editing.rats.Symbol.Semicolon.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pSemicolon(final int yyStart) throws IOException {
    ...
    if (';' == yyC) {
      ...
      yyValue = GNode.create("Semicolon", v$g$1);
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Symbol.Bar.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pBar(final int yyStart) throws IOException {
    ...
    if ('|' == yyC) {
      ...
      yyValue = GNode.create("Bar", v$g$1);
