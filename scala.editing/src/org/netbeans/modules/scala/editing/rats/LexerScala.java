...
// on Saturday, March 29, 2008 at 9:22:01 PM.
    ...
    if ('(' == yyC) {
      ...
      if (yyResult.hasValue()) {
        ...
        { // Start scope for v$g$4.
          ...
          yyResult = pXmlElement(yyOption1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            Node v$g$5 = yyResult.semanticValue();
            ...
            { // Start scope for v$g$6.
              ...
              if (')' == yyC) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyValue = GNode.create("XmlExpr", v$g$3, v$g$4, v$g$5, v$g$6, v$g$7);
            ...
            { // Start scope for v$g$11.
              ...
              if ('}' == yyC) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyValue = GNode.create("XmlExpr", v$g$8, v$g$9, v$g$10, v$g$11, v$g$12);
