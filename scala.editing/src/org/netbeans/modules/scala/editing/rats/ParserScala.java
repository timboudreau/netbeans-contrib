...
// on Saturday, March 29, 2008 at 9:22:04 PM.
...
public final class ParserScala extends ParserBase {
  ...
  /**
   * Parse nonterminal org.netbeans.modules.scala.editing.rats.Xml.xmlCDData.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pxmlCDData(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyRepetition1;
    String     yyValue;
    ParseError yyError = ParseError.DUMMY;
