...
// on Wednesday, March 26, 2008 at 11:53:06 PM.
...
public final class ParserScala extends ParserBase {
  ...
  private Result pkey$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue("catch")) {
        ...
        yyResult = pIGNORE_TILL_N(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.scala.editing.rats.Spacing.IGNORE_TILL_N.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pIGNORE_TILL_N(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyBase;
  ...
  private Result pIGNORE(final int yyStart) throws IOException {
    ...
    // Done.
    yyError = yyError.select("IGNORE expected", yyStart);
    return yyError;
  }
