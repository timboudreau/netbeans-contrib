...
// on Thursday, March 27, 2008 at 3:56:38 PM.
...
public final class ParserScala extends ParserBase {
   ...
   * and org.netbeans.modules.scala.editing.rats.ParserScala.StableId$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pStableId$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = GNode.create("StableId", v$g$1, v$g$2);
    ...
    { // Start scope for v$g$3.
      ...
      if (yyResult.hasValue("this")) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("StableId", v$g$3, v$g$4, v$g$5);
      ...
      if (yyResult.hasValue("super")) {
        ...
        { // Start scope for v$g$7.
          ...
          yyResult = pStableId$$Star3(yyOption1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            Pair<Node> v$g$8 = yyResult.semanticValue();

            yyValue = GNode.create("StableId", v$g$3, v$g$6, v$g$7, v$g$8);
  ...
  private Result pPatternWFunType(final int yyStart) throws IOException {
    ParserScalaColumn yyColumn = (ParserScalaColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fPatternWFunType) 
      yyColumn.chunk3.fPatternWFunType = pPatternWFunType$1(yyStart);
    return yyColumn.chunk3.fPatternWFunType;
  }
  ...
  private Result p$$Shared4(final int yyStart) throws IOException {
    ParserScalaColumn yyColumn = (ParserScalaColumn)column(yyStart);
    if (null == yyColumn.chunk5) yyColumn.chunk5 = new Chunk5();
    if (null == yyColumn.chunk5.f$$Shared4) 
      yyColumn.chunk5.f$$Shared4 = p$$Shared4$1(yyStart);
    return yyColumn.chunk5.f$$Shared4;
  }
  ...
  private Result pkey(final int yyStart) throws IOException {
    ParserScalaColumn yyColumn = (ParserScalaColumn)column(yyStart);
    if (null == yyColumn.chunk5) yyColumn.chunk5 = new Chunk5();
    if (null == yyColumn.chunk5.fkey) yyColumn.chunk5.fkey = pkey$1(yyStart);
    return yyColumn.chunk5.fkey;
  }
