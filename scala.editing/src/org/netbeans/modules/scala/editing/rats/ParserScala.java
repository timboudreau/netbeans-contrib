...
// on Thursday, March 27, 2008 at 1:41:07 PM.
...
public final class ParserScala extends ParserBase {
  ...
  private Result pPatternWType(final int yyStart) throws IOException {
    ...
    yyPredResult = pkey(yyStart);
    if (yyPredResult.hasValue("case")) {
    ...
    if (! yyPredMatched) {
      ...
      yyError = yyError.select("pattern w type expected", yyStart);
    }
  ...
  private Result pSimplePattern(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("_")) {
      ...
      { // Start scope for v$g$2.
        ...
        yyValue = GNode.create("SimplePattern", v$g$1, v$g$2);
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = GNode.create("SimplePattern", v$g$5, v$g$6);
  ...
  private Result pBindings(final int yyStart) throws IOException {
    ParserScalaColumn yyColumn = (ParserScalaColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fBindings) 
      yyColumn.chunk4.fBindings = pBindings$1(yyStart);
    return yyColumn.chunk4.fBindings;
  }
  ...
  private Result pBindings$$Star1(final int yyStart) throws IOException {
    ParserScalaColumn yyColumn = (ParserScalaColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fBindings$$Star1) 
      yyColumn.chunk4.fBindings$$Star1 = pBindings$$Star1$1(yyStart);
    return yyColumn.chunk4.fBindings$$Star1;
  }
