...
// on Wednesday, March 26, 2008 at 10:54:11 AM.
...
public final class ParserScala extends ParserBase {
  ...
  private Result pop(final int yyStart) throws IOException {
    ...
    yyPredResult = pop$$Choice1(yyStart);
    if (yyPredResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal 
   * org.netbeans.modules.scala.editing.rats.ParserScala.op$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
