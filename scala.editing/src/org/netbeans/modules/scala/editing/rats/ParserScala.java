...
// on Monday, March 24, 2008 at 1:33:12 PM.
  ...
  private Result pStableId$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = GNode.createFromPair("StableId", v$g$1, v$g$2);
        ...
        if ('h' == yyC) {
          ...
          if ('i' == yyC) {
            ...
            if ('s' == yyC) {
              ...
              yyResult = pStableId$$Star2(yyIndex);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                Pair<Node> v$g$5 = yyResult.semanticValue();

                yyValue = GNode.create("StableId", v$g$5.size() + 2).
                  add(v$g$3).add(v$g$4).addAll(v$g$5);
              ...
              if ('r' == yyC) {
                ...
                { // Start scope for v$g$7.
                  ...
                  if (yyResult.hasValue()) {
                    ...
                    yyValue = GNode.create("StableId", v$g$8.size() + 3).
                      add(v$g$3).add(v$g$6).add(v$g$7).addAll(v$g$8);
                    ...
                    if (yyResult.hasValue()) {
                      ...
                      { // Start scope for v$g$3.
                        ...
                        if ('}' == yyC) {
                          ...
                          yyValue = GNode.create("ExistentialClause", v$g$3.size() + 2).
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for v$g$2.
        ...
        { // Start scope for v$g$3.
          ...
          yyValue = GNode.create("Patterns", v$g$2.size() + 2).
            add(v$g$1).addAll(v$g$2).add(v$g$3);
