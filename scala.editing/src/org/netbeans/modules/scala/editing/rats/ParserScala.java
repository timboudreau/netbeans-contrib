...
// on Sunday, March 30, 2008 at 2:22:43 AM.
...
public final class ParserScala extends ParserBase {
  ...
  private Result pParserScala$XmlEmptyElemTag(final int yyStart) 
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pParserScala$XmlName(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Node v$g$2 = yyResult.semanticValue();
  ...
  private Result pStableId$1(final int yyStart) throws IOException {
    ...
    { // Start scope for v$g$1.
      ...
      if (yyResult.hasValue("this")) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Pair<String> v$g$3 = yyResult.semanticValue();
      ...
      if (yyResult.hasValue("super")) {
        ...
        { // Start scope for v$g$5.
          Node v$g$5 = cast(yyOpValue1);

          yyResult = pStableId$$Star2(yyOption1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            Pair<String> v$g$6 = yyResult.semanticValue();
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<String> v$g$8 = yyResult.semanticValue();
  ...
  private Result pStableId$$Star2$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue(".")) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Pair<String> v$6 = yyResult.semanticValue();

          yyValue = new Pair<String>(v$el$5, v$6);
  ...
  private Result pStableId$$Star3$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue(".")) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Pair<String> v$8 = yyResult.semanticValue();

          yyValue = new Pair<String>(v$el$7, v$8);
  ...
  private Result pSimpleType(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(".")) {
        ...
        if (yyResult.hasValue("type")) {
          ...
          { // Start scope for v$g$2.
            Pair<Node> v$g$2 = cast(yyRepValue1.reverse());
            ...
            { // Start scope for v$g$3.
              Pair<String> v$g$3 = cast(yyRepValue1.reverse());
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for v$g$5.
        Pair<Node> v$g$5 = cast(yyRepValue1.reverse());
        ...
        { // Start scope for v$g$6.
          Pair<String> v$g$6 = cast(yyRepValue1.reverse());
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyRepetition1 = yyResult.index;
          yyRepValue1   = new Pair<Object>(v$el$5, yyRepValue1);
          continue;
        }
        break;
      }
      { // Start scope for v$g$8.
        Pair<Node> v$g$8 = cast(yyRepValue1.reverse());
        ...
        while (true) {
          ...
          if (yyResult.hasValue("#")) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyRepetition1 = yyResult.index;
              yyRepValue1   = new Pair<Object>(v$el$6, yyRepValue1);
              continue;
            }
          } else {
            yyError = yyError.select("\"#\" expected", yyBase);
        ...
        { // Start scope for v$g$9.
          Pair<String> v$g$9 = cast(yyRepValue1.reverse());
