...
public final class PasteAsJavaSourceNewlinesToSpaces extends CookieAction {
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        Object pa = lup.lookup(PasteAction.class);
        if(content.isDataFlavorSupported(DataFlavor.stringFlavor)){
            try{
                String realc = (String)content.getTransferData(DataFlavor.stringFlavor);
                realc = StringParser.convertTextToJava(realc, true);
    ...
    public String getName() {
        return NbBundle.getMessage(PasteAsJavaSourceNewlinesToSpaces.class, "CTL_PasteAsJavaSourceNewlinesToSpaces");
    }
