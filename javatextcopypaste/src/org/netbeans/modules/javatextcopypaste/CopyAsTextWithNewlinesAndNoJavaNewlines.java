...
public final class CopyAsTextWithNewlinesAndNoJavaNewlines extends CookieAction {
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        if(epane!=null){
            ...
            if(text!=null||text.length()<1){
                try{
                    String newText = StringParser.convertJavaToText(text, false, false, false, true);
    ...
    public String getName() {
        return NbBundle.getMessage(CopyAsTextWithNewlines.class, "CTL_CopyAsTextWithNewlinesAndNoJavaNewlines");
    }
