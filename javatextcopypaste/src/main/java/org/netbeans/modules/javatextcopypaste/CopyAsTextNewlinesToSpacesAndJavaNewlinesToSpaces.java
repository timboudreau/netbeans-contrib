...
public final class CopyAsTextNewlinesToSpacesAndJavaNewlinesToSpaces extends CookieAction {
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        if(epane!=null){
            ...
            if(text!=null||text.length()<1){
                try{
                    String newText = StringParser.convertJavaToText(text, true, true);
    ...
    public String getName() {
        return NbBundle.getMessage(CopyAsTextNewlinesToSpacesAndJavaNewlinesToSpaces.class, "CTL_CopyAsTextNewlinesToSpacesAndJavaNewlinesToSpaces");
    }
