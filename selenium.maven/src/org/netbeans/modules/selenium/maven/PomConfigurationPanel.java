 ...
 */
class PomConfigurationPanel implements WizardDescriptor.Panel<WizardDescriptor> {
    private JCheckBox modifyPom;
    ...
    public boolean modifyPom(){
        return modifyPom.isSelected();
    }
