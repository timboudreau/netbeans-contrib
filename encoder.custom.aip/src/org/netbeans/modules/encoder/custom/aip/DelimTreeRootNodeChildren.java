 ...
 * @author Jun Xu
 */
public class DelimTreeRootNodeChildren extends Children.Keys
    ...
    protected Node[] createNodes(Object object) {
        DelimTreeLevelNodeChildren children =
                new DelimTreeLevelNodeChildren((DelimiterLevel) object);
        children.addDelimiterSetChangeListener(getDelimiterSetChangeListeners());
        DelimTreeLevelNode node =
                new DelimTreeLevelNode(
                        (DelimiterLevel) object,
                        children,
