 ...
 * @author Jun Xu
 */
public class DelimTreeLevelNodeChildren extends Children.Keys 
    ...
    protected Node[] createNodes(Object object) {
        DelimTreeDelimiterNode node =
                new DelimTreeDelimiterNode((Delimiter) object, Lookups.singleton(object));
