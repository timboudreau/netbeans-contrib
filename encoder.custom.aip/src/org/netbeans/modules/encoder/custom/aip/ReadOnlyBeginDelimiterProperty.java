 ...
 * @author jxu
 */
public class ReadOnlyBeginDelimiterProperty<T>
     ...
     */
    public ReadOnlyBeginDelimiterProperty(EncodingOption encodingOption, Class clazz,
    ...
    public T getValue() throws IllegalAccessException, IllegalArgumentException,
        ...
        return (T) mEncodingOption.getBeginDelimitersAsString();
    }
}
