 ...
 * @author pblaha
 */
class OC4JTargetModuleID implements TargetModuleID {
    ...
    OC4JTargetModuleID(Target target) {
        this( target, "");
    }
    
    OC4JTargetModuleID(Target target, String jar_name) {
        this.target = target;
    ...
    public void setParent( OC4JTargetModuleID parent) {
        this.parent = parent;
        
    }
    
    public void addChild( OC4JTargetModuleID child) {
        childs.add( child );
