 ...
 */
public final class OC4JCustomizerSupport {
    ...
    public static Component createUserCustomizer(InstanceProperties ip) {
        ...
        return new OC4JCustomizerUserPanel(ip);
    }
    ...
    private static class PathView extends JPanel {
        ...
        private void initComponents(PathModel model) {
            ...
            label.setText(NbBundle.getMessage(OC4JCustomizerSupport.class,key));
            label.setDisplayedMnemonic(NbBundle.getMessage(OC4JCustomizerSupport.class,mneKey).charAt(0));
            ...
            resources.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(OC4JCustomizerSupport.class,ad));
            ...
            if (type == JAVADOC) {
                ...
                String text = NbBundle.getMessage(OC4JCustomizerSupport.class, "CTL_AddZip");
                char mne = NbBundle.getMessage(OC4JCustomizerSupport.class, "MNE_AddZip").charAt(0);
                ad = NbBundle.getMessage(OC4JCustomizerSupport.class, "AD_AddZip");
                ...
                removeButton = new JButton(NbBundle.getMessage(OC4JCustomizerSupport.class, "CTL_Remove"));
                removeButton.setMnemonic(NbBundle.getMessage(OC4JCustomizerSupport.class, "MNE_Remove").charAt(0));
                removeButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(OC4JCustomizerSupport.class,"AD_Remove"));
                ...
                moveUpButton = new JButton(NbBundle.getMessage(OC4JCustomizerSupport.class, "CTL_Up"));
                moveUpButton.setMnemonic(NbBundle.getMessage(OC4JCustomizerSupport.class, "MNE_Up").charAt(0));
                moveUpButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(OC4JCustomizerSupport.class,"AD_Up"));
                ...
                moveDownButton = new JButton(NbBundle.getMessage(OC4JCustomizerSupport.class, "CTL_Down"));
                moveDownButton.setMnemonic(NbBundle.getMessage(OC4JCustomizerSupport.class, "MNE_Down").charAt(0));
                moveDownButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(OC4JCustomizerSupport.class,"AD_Down"));
        ...
        private void addPathElement() {
            ...
            if (chooser.showOpenDialog(this)==JFileChooser.APPROVE_OPTION) {
                ...
                if (addingFailed) {
                    new NotifyDescriptor.Message(NbBundle.getMessage(OC4JCustomizerSupport.class,"TXT_CanNotAddResolve"),
