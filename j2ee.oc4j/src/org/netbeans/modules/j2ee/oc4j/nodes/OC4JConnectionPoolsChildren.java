...
/**
 * It describes children nodes of the Connection Pools node
 *
 * @author Michal Mocnak
 */
public class OC4JConnectionPoolsChildren extends Children.Keys implements Refreshable {
    
    private Lookup lookup;
    private final static Node WAIT_NODE = OC4JItemNode.createWaitNode();
    
    OC4JConnectionPoolsChildren(Lookup lookup) {
        this.lookup = lookup;
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    while(i.hasNext()) {
                        ...
                        Node node = new OC4JItemNode(lookup, Children.LEAF, name, OC4JItemNode.ItemType.CONNECTION_POOLS);
