...
/**
 * Helper class for datasources management
 *
 * @author Michal Mocnak
 */
public class OC4JResourceConfigurationHelper {
    
    private OC4JResourceConfigurationHelper() {}
        ...
        try {
            ...
            if (cfolder == null) {
                ...
                try {
                    ...
                    throw new ConfigurationException(NbBundle.getMessage(OC4JModuleConfiguration.class, "MSG_FailedToCreateConfigFolder", parentFile.getAbsolutePath()));
                }
            }
