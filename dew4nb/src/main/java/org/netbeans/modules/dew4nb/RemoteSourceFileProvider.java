...
public final class RemoteSourceFileProvider implements SourceFileObjectProvider {
    ...
    public AbstractSourceFileObject createJavaFileObject(
        ...
        //Todo: content = null, renderNow = false now
        return new RemoteSourceFileObject(handle, filter, null, false);
    }
}
