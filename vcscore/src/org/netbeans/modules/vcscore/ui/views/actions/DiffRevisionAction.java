 ...
 * @author  Milos Kleint
 */
public class DiffRevisionAction extends FileVcsInfoAction {

    /** Creates new UpdateCommandAction */
    public DiffRevisionAction() {
    }
    ...
    public String getName() {
        return NbBundle.getMessage(DiffRevisionAction.class, "LBL_DiffRevisionAction"); //NOI18N
    }
