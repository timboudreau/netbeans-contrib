/**
 *	This generated bean class Put matches the schema element 'Put'.
...
public class Put extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	static public final String PCDATA = "pcdata";	// NOI18N
	...
	static public final String SYSTEMPROPERTY = "SystemProperty";	// NOI18N
	static public final String SYSTEMPROPERTYNAME = "SystemPropertyName";	// NOI18N
	static public final String SYSTEMPROPERTYDEFAULT = "SystemPropertyDefault";	// NOI18N
	static public final String SYSTEMPROPERTYID = "SystemPropertyId";	// NOI18N
	...
	public Put(int options)
	{
		super(comparators, runtimeVersion);
		// Properties (see root bean comments for the bean graph)
		initPropertyTables(8);
		this.createProperty("#PCDATA", 	// NOI18N
			PCDATA, Common.SEQUENCE_OR | 
		...
		this.createAttribute(GET, "id", "Id", 
						AttrProp.NMTOKEN | AttrProp.IMPLIED,
						null, null);
		this.createProperty("SystemProperty", 	// NOI18N
			SYSTEMPROPERTY, Common.SEQUENCE_OR | 
			Common.TYPE_0_N | Common.TYPE_BOOLEAN | Common.TYPE_KEY, 
			Boolean.class);
		this.createAttribute(SYSTEMPROPERTY, "name", "Name", 
						AttrProp.NMTOKEN | AttrProp.REQUIRED,
						null, null);
		this.createAttribute(SYSTEMPROPERTY, "default", "Default", 
						AttrProp.CDATA | AttrProp.IMPLIED,
						null, null);
		this.createAttribute(SYSTEMPROPERTY, "id", "Id", 
						AttrProp.NMTOKEN | AttrProp.IMPLIED,
						null, null);
	...
	public void setpcdata(int index, String value) {
		this.setValue(PCDATA, index, value);
	}

	//
	public String getpcdata(int index) {
		return (String)this.getValue(PCDATA, index);
	}

	// Return the number of properties
	public int sizepcdata() {
		return this.size(PCDATA);
	}

	// This attribute is an array, possibly empty
	public void setpcdata(String[] value) {
		this.setValue(PCDATA, value);
	}

	//
	public String[] getpcdata() {
		return (String[])this.getValues(PCDATA);
	}

	// Add a new element returning its index in the list
	public int addpcdata(String value) {
		int positionOfNewItem = this.addValue(PCDATA, value);
	...
	//
	public int removepcdata(String value) {
		return this.removeValue(PCDATA, value);
	}
	...
	// This attribute is an array, possibly empty
	public void setSystemProperty(int index, boolean value) {
		this.setValue(SYSTEMPROPERTY, index, (value ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE));
	}

	//
	public boolean isSystemProperty(int index) {
		Boolean ret = (Boolean)this.getValue(SYSTEMPROPERTY, index);
		if (ret == null)
	...
	public int sizeSystemProperty() {
		return this.size(SYSTEMPROPERTY);
	}
	...
	public void setSystemProperty(boolean[] value) {
		...
		this.setValue(SYSTEMPROPERTY, values);
	}

	//
	public boolean[] getSystemProperty() {
		boolean[] ret = null;
		Boolean[] values = (Boolean[])this.getValues(SYSTEMPROPERTY);
		if (values != null)
		{
	...
	// Add a new element returning its index in the list
	public int addSystemProperty(boolean value) {
		int positionOfNewItem = this.addValue(SYSTEMPROPERTY, (value ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE));
		return positionOfNewItem;
	}
	...
	// Returns the index the element had in the list
	//
	public int removeSystemProperty(boolean value) {
		return this.removeValue(SYSTEMPROPERTY, (value ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE));
	}

	//
	// Remove an element using its index
	//
	public void removeSystemProperty(int index) {
		this.removeValue(SYSTEMPROPERTY, index);
	}

	// This attribute is an array, possibly empty
	public void setSystemPropertyName(int index, java.lang.String value) {
		// Make sure we've got a place to put this attribute.
		if (size(SYSTEMPROPERTY) == 0) {
			addValue(SYSTEMPROPERTY, java.lang.Boolean.TRUE);
		}
		setValue(SYSTEMPROPERTY, index, java.lang.Boolean.TRUE);
		setAttributeValue(SYSTEMPROPERTY, index, "Name", value);
	}

	//
	public java.lang.String getSystemPropertyName(int index) {
		// If our element does not exist, then the attribute does not exist.
		if (size(SYSTEMPROPERTY) == 0) {
			return null;
		} else {
			return getAttributeValue(SYSTEMPROPERTY, index, "Name");
		}
	}

	// Return the number of properties
	public int sizeSystemPropertyName() {
		return this.size(SYSTEMPROPERTY);
	}

	// This attribute is an array, possibly empty
	public void setSystemPropertyDefault(int index, java.lang.String value) {
		// Make sure we've got a place to put this attribute.
		if (size(SYSTEMPROPERTY) == 0) {
			addValue(SYSTEMPROPERTY, java.lang.Boolean.TRUE);
		}
		setValue(SYSTEMPROPERTY, index, java.lang.Boolean.TRUE);
		setAttributeValue(SYSTEMPROPERTY, index, "Default", value);
	}

	//
	public java.lang.String getSystemPropertyDefault(int index) {
		// If our element does not exist, then the attribute does not exist.
		if (size(SYSTEMPROPERTY) == 0) {
			return null;
		} else {
			return getAttributeValue(SYSTEMPROPERTY, index, "Default");
		}
	}

	// Return the number of properties
	public int sizeSystemPropertyDefault() {
		return this.size(SYSTEMPROPERTY);
	}

	// This attribute is an array, possibly empty
	public void setSystemPropertyId(int index, java.lang.String value) {
		// Make sure we've got a place to put this attribute.
		if (size(SYSTEMPROPERTY) == 0) {
			addValue(SYSTEMPROPERTY, java.lang.Boolean.TRUE);
		}
		setValue(SYSTEMPROPERTY, index, java.lang.Boolean.TRUE);
		setAttributeValue(SYSTEMPROPERTY, index, "Id", value);
	}

	//
	public java.lang.String getSystemPropertyId(int index) {
		// If our element does not exist, then the attribute does not exist.
		if (size(SYSTEMPROPERTY) == 0) {
			return null;
		} else {
			return getAttributeValue(SYSTEMPROPERTY, index, "Id");
		}
	}

	// Return the number of properties
	public int sizeSystemPropertyId() {
		return this.size(SYSTEMPROPERTY);
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("pcdata["+this.sizepcdata()+"]");	// NOI18N
		for(int i=0; i<this.sizepcdata(); i++)
		{
			str.append(indent+"\t");
			str.append("#"+i+":");
			...
			str.append(">\n");	// NOI18N
			this.dumpAttributes(PCDATA, i, str, indent);
		}
		...
		for(int i=0; i<this.sizeSystemProperty(); i++)
		{
			...
			str.append("#"+i+":");
			str.append(indent+"\t");	// NOI18N
			str.append((this.isSystemProperty(i)?"true":"false"));
			this.dumpAttributes(SYSTEMPROPERTY, i, str, indent);
		}
...
$Id: Put.java,v 1.3 2008/04/29 06:42:17 cvsuser Exp $
-->
