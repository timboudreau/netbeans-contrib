/**
 *	This generated bean class Ref matches the schema element 'Ref'.
...
public class Ref extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	public void setId(int index, java.lang.String value) {
		...
		setAttributeValue(REF, index, "Id", value);
	}
	...
	public java.lang.String getId(int index) {
		...
		if (size(REF) == 0) {
			...
			return getAttributeValue(REF, index, "Id");
		}
	}
