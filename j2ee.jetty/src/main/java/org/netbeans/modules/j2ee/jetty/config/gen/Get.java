/**
 *	This generated bean class Get matches the schema element 'Get'.
...
public class Get extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	public void setName(int index, java.lang.String value) {
		...
		setAttributeValue(GET, index, "Name", value);
	}
	...
	public java.lang.String getName(int index) {
		...
		if (size(GET) == 0) {
			...
			return getAttributeValue(GET, index, "Name");
		}
	}
	...
	public void setClass2(int index, java.lang.String value) {
		...
		setAttributeValue(GET, index, "Class2", value);
	}
	...
	public java.lang.String getClass2(int index) {
		...
		if (size(GET) == 0) {
			...
			return getAttributeValue(GET, index, "Class2");
		}
	}
	...
	public void setId(int index, java.lang.String value) {
		...
		setAttributeValue(GET, index, "Id", value);
	}
	...
	public java.lang.String getId(int index) {
		...
		if (size(GET) == 0) {
			...
			return getAttributeValue(GET, index, "Id");
		}
	}
...
$Id: Get.java,v 1.3 2008/04/29 06:42:17 cvsuser Exp $
-->
