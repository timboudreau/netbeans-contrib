 ...
 * @author novakm
 */
public class JetProgressUI implements ProgressListener {
    ...
    /** Creates a new instance of JetProgressUI */
    public JetProgressUI(String title, boolean modal) {
        this(title, modal, null);
    }
    
    public JetProgressUI(String title, boolean modal, Deployment.Logger logger) {
        this.modal = modal;
        this.title = title;
        this.logger = logger;        
            ...
            Mutex.EVENT.readAccess(new Runnable() {
                public void run() {
                    if (messageLabel != null) {
                        ...
                        synchronized (JetProgressUI.this) {
                            lastMessage = message;
                        }
                    }
                }
    ...
    private JComponent createProgressDialog(ProgressHandle handle, String message) {
        ...
        JButton cancel = new JButton(NbBundle.getMessage(JetProgressUI.class,"LBL_Cancel"));
        cancel.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JetProgressUI.class,"AD_Cancel"));
