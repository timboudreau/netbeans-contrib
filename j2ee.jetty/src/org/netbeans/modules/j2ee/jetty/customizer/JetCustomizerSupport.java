 ...
 * @author novakm
 */
public final class JetCustomizerSupport {
    ...
    private static final Logger LOGGER = Logger.getLogger(JetCustomizerSupport.class.getName());
    
    /** Do not allow to create instances of this class */
    private JetCustomizerSupport() {
    }
    ...
    public static Component createUserCustomizer(InstanceProperties ip) {
        ...
        return new JetCustomizerUserTab(ip);
    }
    ...
    private static class PathView extends JPanel {
        ...
        private void initComponents(PathModel model) {
            ...
            label.setText(NbBundle.getMessage(JetCustomizerSupport.class,key));
            label.setDisplayedMnemonic(NbBundle.getMessage(JetCustomizerSupport.class,mneKey).charAt(0));
            ...
            resources.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JetCustomizerSupport.class,ad));
            ...
            if (type == JAVADOC) {
                ...
                String text = NbBundle.getMessage(JetCustomizerSupport.class, "CTL_AddZip");
                char mne = NbBundle.getMessage(JetCustomizerSupport.class, "MNE_AddZip").charAt(0);
                ad = NbBundle.getMessage(JetCustomizerSupport.class, "AD_AddZip");
                ...
                removeButton = new JButton(NbBundle.getMessage(JetCustomizerSupport.class, "CTL_Remove"));
                removeButton.setMnemonic(NbBundle.getMessage(JetCustomizerSupport.class, "MNE_Remove").charAt(0));
                removeButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JetCustomizerSupport.class,"AD_Remove"));
                ...
                moveUpButton = new JButton(NbBundle.getMessage(JetCustomizerSupport.class, "CTL_Up"));
                moveUpButton.setMnemonic(NbBundle.getMessage(JetCustomizerSupport.class, "MNE_Up").charAt(0));
                moveUpButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JetCustomizerSupport.class,"AD_Up"));
                ...
                moveDownButton = new JButton(NbBundle.getMessage(JetCustomizerSupport.class, "CTL_Down"));
                moveDownButton.setMnemonic(NbBundle.getMessage(JetCustomizerSupport.class, "MNE_Down").charAt(0));
                moveDownButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(JetCustomizerSupport.class,"AD_Down"));
        ...
        private void addPathElement() {
            ...
            if (this.type == JAVADOC) {
                title = NbBundle.getMessage(JetCustomizerSupport.class,"TXT_OpenJavadoc");
                message = NbBundle.getMessage(JetCustomizerSupport.class,"TXT_Javadoc");
                approveButtonName = NbBundle.getMessage(JetCustomizerSupport.class,"TXT_OpenJavadoc");
                approveButtonNameMne = NbBundle.getMessage(JetCustomizerSupport.class,"MNE_OpenJavadoc");
            }
            ...
            if (chooser.showOpenDialog(this)==JFileChooser.APPROVE_OPTION) {
                ...
                if (addingFailed) {
                    new NotifyDescriptor.Message(NbBundle.getMessage(JetCustomizerSupport.class,"TXT_CanNotAddResolve"),
