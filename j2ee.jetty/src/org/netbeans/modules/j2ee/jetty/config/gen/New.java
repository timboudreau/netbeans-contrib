/**
 *	This generated bean class New matches the schema element 'New'.
...
public class New extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	public void setClass2(int index, java.lang.String value) {
		...
		setAttributeValue(NEW, index, "Class2", value);
	}
	...
	public java.lang.String getClass2(int index) {
		...
		if (size(NEW) == 0) {
			...
			return getAttributeValue(NEW, index, "Class2");
		}
	}
	...
	public void setId(int index, java.lang.String value) {
		...
		setAttributeValue(NEW, index, "Id", value);
	}
	...
	public java.lang.String getId(int index) {
		...
		if (size(NEW) == 0) {
			...
			return getAttributeValue(NEW, index, "Id");
		}
	}
...
$Id: New.java,v 1.3 2008/04/29 06:42:17 cvsuser Exp $
-->
