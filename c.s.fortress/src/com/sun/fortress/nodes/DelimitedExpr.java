...
/**
 * Class DelimitedExpr, a component of the Node composite hierarchy.
...
public abstract class DelimitedExpr extends Expr {
     ...
     */
    public DelimitedExpr(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public DelimitedExpr(boolean in_parenthesized) {
