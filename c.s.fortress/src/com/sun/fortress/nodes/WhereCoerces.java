...
/**
 * Class WhereCoerces, a component of the Node composite hierarchy.
...
public class WhereCoerces extends WhereConstraint {
     ...
     */
    public WhereCoerces(Span in_span, Type in_left, Type in_right) {
        super(in_span);
        if (in_left == null) {
     ...
     */
    public WhereCoerces(Type in_left, Type in_right) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forWhereCoerces(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forWhereCoerces(this); }
