...
/**
 * Class WhereExtends, a component of the Node composite hierarchy.
...
public class WhereExtends extends WhereConstraint {
     ...
     */
    public WhereExtends(Span in_span, Id in_name, List<TraitType> in_supers) {
        super(in_span);
        if (in_name == null) {
     ...
     */
    public WhereExtends(Id in_name, List<TraitType> in_supers) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forWhereExtends(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forWhereExtends(this); }
