...
/**
 * Class FlowExpr, a component of the Node composite hierarchy.
...
public abstract class FlowExpr extends Expr {
     ...
     */
    public FlowExpr(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public FlowExpr(boolean in_parenthesized) {
