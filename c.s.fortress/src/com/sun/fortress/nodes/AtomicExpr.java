...
/**
 * Class AtomicExpr, a component of the Node composite hierarchy.
...
public class AtomicExpr extends FlowExpr {
     ...
     */
    public AtomicExpr(Span in_span, boolean in_parenthesized, Expr in_expr) {
     ...
     * A constructor with some fields provided by default values.
     */
    public AtomicExpr(boolean in_parenthesized, Expr in_expr) {
     ...
     * A constructor with some fields provided by default values.
     */
    public AtomicExpr(Expr in_expr) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forAtomicExpr(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forAtomicExpr(this); }
