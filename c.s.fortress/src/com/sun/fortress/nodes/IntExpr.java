...
/**
 * Class IntExpr, a component of the Node composite hierarchy.
...
public abstract class IntExpr extends StaticExpr {
     ...
     */
    public IntExpr(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public IntExpr(boolean in_parenthesized) {
