...
/**
 * Class TraitDecl, a component of the Node composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Tue Mar 11 23:25:23 CST 2008
 */
public class TraitDecl extends TraitAbsDeclOrDecl implements GenericDecl {

    /**
     * Constructs a TraitDecl.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, List<Modifier> in_mods, Id in_name, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<StaticParam> in_staticParams, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Span in_span, Id in_name, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<StaticParam> in_staticParams, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(List<Modifier> in_mods, Id in_name, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<TraitTypeWhere> in_extendsClause, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<StaticParam> in_staticParams, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, WhereClause in_where, List<TraitType> in_excludes, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, WhereClause in_where, List<TraitType> in_excludes, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, WhereClause in_where, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, WhereClause in_where, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, Option<List<TraitType>> in_comprises, List<Decl> in_decls) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitDecl(Id in_name, List<Decl> in_decls) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forTraitDecl(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forTraitDecl(this); }
