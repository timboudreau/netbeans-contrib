...
/**
 * Class BigOprApp, a component of the Node composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Tue Mar 11 23:25:23 CST 2008
 */
public abstract class BigOprApp extends FlowExpr {
    private final List<StaticArg> _staticArgs;

    /**
     * Constructs a BigOprApp.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public BigOprApp(Span in_span, boolean in_parenthesized, List<StaticArg> in_staticArgs) {
        super(in_span, in_parenthesized);
        if (in_staticArgs == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'staticArgs' to the BigOprApp constructor was null");
        }
     ...
     */
    public BigOprApp(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public BigOprApp(Span in_span, List<StaticArg> in_staticArgs) {
     ...
     * A constructor with some fields provided by default values.
     */
    public BigOprApp(boolean in_parenthesized, List<StaticArg> in_staticArgs) {
     ...
     * A constructor with some fields provided by default values.
     */
    public BigOprApp(boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public BigOprApp(List<StaticArg> in_staticArgs) {
