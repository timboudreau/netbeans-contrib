...
/**
 * Class AndPredicateSymbol, a component of the Node composite hierarchy.
...
public class AndPredicateSymbol extends SyntaxSymbol {
     ...
     */
    public AndPredicateSymbol(Span in_span, SyntaxSymbol in_symbol) {
        super(in_span);
        if (in_symbol == null) {
     ...
     */
    public AndPredicateSymbol(SyntaxSymbol in_symbol) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forAndPredicateSymbol(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forAndPredicateSymbol(this); }
    ...
    public void outputHelp(TabPrintWriter writer, boolean lossless) {
        writer.print("AndPredicateSymbol:");
        writer.indent();
