...
/**
 * Class TraitType, a component of the Node composite hierarchy.
...
public abstract class TraitType extends NonArrowType {
     ...
     */
    public TraitType(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public TraitType(boolean in_parenthesized) {
