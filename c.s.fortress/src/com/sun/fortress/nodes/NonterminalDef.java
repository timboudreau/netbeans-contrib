...
/**
 * Class NonterminalDef, a component of the Node composite hierarchy.
...
public class NonterminalDef extends NonterminalDecl {
     ...
     */
    public NonterminalDef(Span in_span, QualifiedIdName in_name, Option<TraitType> in_type, Option<? extends Modifier> in_modifier, List<SyntaxDef> in_syntaxDefs) {
     ...
     */
    public NonterminalDef(QualifiedIdName in_name, Option<TraitType> in_type, Option<? extends Modifier> in_modifier, List<SyntaxDef> in_syntaxDefs) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forNonterminalDef(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forNonterminalDef(this); }
