...
/**
 * Class AsIfExpr, a component of the Node composite hierarchy.
...
public class AsIfExpr extends TypeAnnotatedExpr {
     ...
     */
    public AsIfExpr(Span in_span, boolean in_parenthesized, Expr in_expr, Type in_type) {
     ...
     */
    public AsIfExpr(Span in_span, Expr in_expr, Type in_type) {
     ...
     * A constructor with some fields provided by default values.
     */
    public AsIfExpr(boolean in_parenthesized, Expr in_expr, Type in_type) {
     ...
     * A constructor with some fields provided by default values.
     */
    public AsIfExpr(Expr in_expr, Type in_type) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forAsIfExpr(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forAsIfExpr(this); }
