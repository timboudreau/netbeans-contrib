...
/**
 * Class ArrayExpr, a component of the Node composite hierarchy.
...
public abstract class ArrayExpr extends Primary {
     ...
     */
    public ArrayExpr(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public ArrayExpr(boolean in_parenthesized) {
