...
/**
 * Class DimExpr, a component of the Node composite hierarchy.
...
public abstract class DimExpr extends Type {
     ...
     */
    public DimExpr(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public DimExpr(boolean in_parenthesized) {
