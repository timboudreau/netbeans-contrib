...
/**
 * Class KeywordExpr, a component of the Node composite hierarchy.
...
public class KeywordExpr extends AbstractNode {
     ...
     */
    public KeywordExpr(Span in_span, Id in_name, Expr in_init) {
        super(in_span);
        if (in_name == null) {
     ...
     */
    public KeywordExpr(Id in_name, Expr in_init) {
        this(new Span(), in_name, in_init);
    }
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forKeywordExpr(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forKeywordExpr(this); }
