...
/**
 * Class BoolExpr, a component of the Node composite hierarchy.
...
public abstract class BoolExpr extends StaticExpr {
     ...
     */
    public BoolExpr(Span in_span, boolean in_parenthesized) {
     ...
     * A constructor with some fields provided by default values.
     */
    public BoolExpr(boolean in_parenthesized) {
