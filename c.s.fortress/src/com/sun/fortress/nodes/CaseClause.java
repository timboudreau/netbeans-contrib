...
/**
 * Class CaseClause, a component of the Node composite hierarchy.
...
public class CaseClause extends AbstractNode {
     ...
     */
    public CaseClause(Span in_span, Expr in_match, Block in_body) {
        super(in_span);
        if (in_match == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'match' to the CaseClause constructor was null");
        }
        _match = in_match;
        if (in_body == null) {
     ...
     */
    public CaseClause(Expr in_match, Block in_body) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forCaseClause(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forCaseClause(this); }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            Expr temp_match = getMatch();
            Expr casted_match = casted.getMatch();
