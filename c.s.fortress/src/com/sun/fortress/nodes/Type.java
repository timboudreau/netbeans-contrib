...
/**
 * Class Type, a component of the Node composite hierarchy.
...
public abstract class Type extends AbstractNode {
     ...
     */
    public Type(Span in_span, boolean in_parenthesized) {
        super(in_span);
     ...
     * A constructor with some fields provided by default values.
     */
    public Type(boolean in_parenthesized) {
