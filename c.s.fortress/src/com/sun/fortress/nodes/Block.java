...
/**
 * Class Block, a component of the Node composite hierarchy.
...
public class Block extends DelimitedExpr {
     ...
     */
    public Block(Span in_span, boolean in_parenthesized, List<Expr> in_exprs) {
     ...
     * A constructor with some fields provided by default values.
     */
    public Block(boolean in_parenthesized, List<Expr> in_exprs) {
     ...
     * A constructor with some fields provided by default values.
     */
    public Block(List<Expr> in_exprs) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forBlock(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forBlock(this); }
