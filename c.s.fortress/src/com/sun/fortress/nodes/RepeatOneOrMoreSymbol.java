...
/**
 * Class RepeatOneOrMoreSymbol, a component of the Node composite hierarchy.
...
public class RepeatOneOrMoreSymbol extends SyntaxSymbol {
     ...
     */
    public RepeatOneOrMoreSymbol(Span in_span, SyntaxSymbol in_symbol) {
        super(in_span);
        if (in_symbol == null) {
     ...
     */
    public RepeatOneOrMoreSymbol(SyntaxSymbol in_symbol) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forRepeatOneOrMoreSymbol(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forRepeatOneOrMoreSymbol(this); }
    ...
    public void outputHelp(TabPrintWriter writer, boolean lossless) {
        writer.print("RepeatOneOrMoreSymbol:");
        writer.indent();
