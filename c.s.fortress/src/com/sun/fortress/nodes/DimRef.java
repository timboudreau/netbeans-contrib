...
/**
 * Class DimRef, a component of the Node composite hierarchy.
...
public class DimRef extends DimExpr {
     ...
     */
    public DimRef(Span in_span, boolean in_parenthesized, QualifiedIdName in_name) {
     ...
     */
    public DimRef(Span in_span, QualifiedIdName in_name) {
     ...
     * A constructor with some fields provided by default values.
     */
    public DimRef(boolean in_parenthesized, QualifiedIdName in_name) {
     ...
     * A constructor with some fields provided by default values.
     */
    public DimRef(QualifiedIdName in_name) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forDimRef(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forDimRef(this); }
