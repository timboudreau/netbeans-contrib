...
/**
 * Class NonParenthesisDelimitedMI, a component of the Node composite hierarchy.
...
public class NonParenthesisDelimitedMI extends ExprMI {
     ...
     */
    public NonParenthesisDelimitedMI(Span in_span, Expr in_expr) {
     ...
     */
    public NonParenthesisDelimitedMI(Expr in_expr) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forNonParenthesisDelimitedMI(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forNonParenthesisDelimitedMI(this); }
    ...
    public void outputHelp(TabPrintWriter writer, boolean lossless) {
        writer.print("NonParenthesisDelimitedMI:");
        writer.indent();
