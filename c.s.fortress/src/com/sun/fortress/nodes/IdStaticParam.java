...
/**
 * Class IdStaticParam, a component of the Node composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Tue Mar 11 23:25:23 CST 2008
 */
public abstract class IdStaticParam extends StaticParam {
    private final Id _name;

    /**
     * Constructs a IdStaticParam.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public IdStaticParam(Span in_span, Id in_name) {
        super(in_span);
        if (in_name == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'name' to the IdStaticParam constructor was null");
        }
        _name = in_name;
    }
     ...
     */
    public IdStaticParam(Id in_name) {
