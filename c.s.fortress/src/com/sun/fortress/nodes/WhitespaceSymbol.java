...
/**
 * Class WhitespaceSymbol, a component of the Node composite hierarchy.
...
public class WhitespaceSymbol extends SpecialSymbol {
     ...
     */
    public WhitespaceSymbol(Span in_span, String in_s) {
        super(in_span);
        if (in_s == null) {
     ...
     */
    public WhitespaceSymbol(String in_s) {
        this(new Span(), in_s);
    }
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forWhitespaceSymbol(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forWhitespaceSymbol(this); }
