...
/**
 * Class TokenSymbol, a component of the Node composite hierarchy.
...
public class TokenSymbol extends SyntaxSymbol {
     ...
     */
    public TokenSymbol(Span in_span, String in_token) {
        super(in_span);
        if (in_token == null) {
     ...
     */
    public TokenSymbol(String in_token) {
    ...
    public <RetType> RetType accept(NodeVisitor<RetType> visitor) { return visitor.forTokenSymbol(this); }
    public void accept(NodeVisitor_void visitor) { visitor.forTokenSymbol(this); }
