...
package org.netbeans.modules.contrib.testng.output.antutils;

import org.apache.tools.ant.module.spi.AntEvent;
import org.apache.tools.ant.module.spi.TaskStructure;
import org.netbeans.modules.contrib.testng.output.TestNGAntLogger;
...
public final class TestCounter {
    ...
    private int countTestClasses() {
        ...
        if (taskName.equals(TestNGAntLogger.TASK_TESTNG)) {
            return countTestClassesInJUnitTask();
        } else if (taskName.equals(TestNGAntLogger.TASK_JAVA)) {
