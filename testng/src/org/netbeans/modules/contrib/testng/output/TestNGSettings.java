...
//    static final String JUNIT4_GENERATOR = JUnitVersion.JUNIT4.name().toLowerCase();
    ...
    public String displayName () {
        return NbBundle.getMessage (TestNGSettings.class, "LBL_junit_settings");
    }

    public HelpCtx getHelpCtx () {
        return new HelpCtx(TestNGSettings.class);
    }
    ...
    public String getGenerateMainMethodBody() {
        return getPreferences().get(PROP_GENERATE_MAIN_METHOD_BODY,
                NbBundle.getMessage(TestNGSettings.class, "PROP_generate_main_method_body_default_value"));
    }
    ...
    public String getRootSuiteClassName() {        
        return getPreferences().get(PROP_ROOT_SUITE_CLASSNAME,
                NbBundle.getMessage(TestNGSettings.class, "PROP_root_suite_classname_default_value"));
    }
