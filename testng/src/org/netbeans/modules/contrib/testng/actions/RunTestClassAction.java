...
@ActionID(id = "org.netbeans.modules.contrib.testng.actions.RunTestClassAction", category = "TestNG")
@ActionRegistration(displayName = "#CTL_RunTestClassAction")
@ActionReferences(value = {
    @ActionReference(path = "Loaders/text/x-java/Actions", position = 2193),
    @ActionReference(path = "Editors/text/x-java/Popup/TestNG", position = 300)})
