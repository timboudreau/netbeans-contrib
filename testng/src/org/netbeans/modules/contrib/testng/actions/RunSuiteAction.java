 ...
 * @author lukas
 */
@ActionID(id = "org.netbeans.modules.contrib.testng.actions.RunSuiteAction", category="Build")
...
public class RunSuiteAction extends NodeAction {
    ...
    public String getName() {
        return NbBundle.getMessage(RunSuiteAction.class, "CTL_RunSuiteAction");
    }
