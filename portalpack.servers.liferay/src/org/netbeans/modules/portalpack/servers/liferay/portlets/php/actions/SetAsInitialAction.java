...
package org.netbeans.modules.portalpack.servers.liferay.portlets.php.actions;
...
import org.netbeans.modules.portalpack.servers.liferay.portlets.php.util.PortletSupportException;
import org.netbeans.modules.portalpack.servers.liferay.portlets.php.util.PortletProjectUtils;
import org.netbeans.modules.portalpack.servers.liferay.portlets.php.util.PortletSupportImpl;
 ...
 */
public class SetAsInitialAction extends AbstractAction
    ...
    private SetAsInitialAction(int type, DataObject inDataObject) {
        this.type = type;
                    ...
                    if(null != currentViewPage) {
                        ...
                        if(null != currentFO) {
                            try {
                                ...
                                ((DataNode)currentDO.getNodeDelegate()).setIconBaseWithExtension("org/netbeans/modules/portalpack/servers/liferay/portlets/resources/php16.png"); //NOI18N
    ...
    private static boolean isPhpInPortletProject(FileObject fo){
        //check for jsp extension
        if(fo == null) return false;
        if(fo.getExt().compareToIgnoreCase("php") == 0){ // NOI18N
    ...
    private class InitialItemListener implements MenuListener {
        ...
        public void menuSelected(MenuEvent e) {
            ...
            JRadioButtonMenuItem rbViewItem = new JRadioButtonMenuItem(NbBundle.getMessage(SetAsInitialAction.class, "MNU_VIEWMODE"));
            ...
            JRadioButtonMenuItem rbEditItem = new JRadioButtonMenuItem(NbBundle.getMessage(SetAsInitialAction.class, "MNU_EDITMODE"));
            ...
            JRadioButtonMenuItem rbHelpItem = new JRadioButtonMenuItem(NbBundle.getMessage(SetAsInitialAction.class, "MNU_HELPMODE"));
            ...
            JRadioButtonMenuItem rbNoneItem = new JRadioButtonMenuItem(NbBundle.getMessage(SetAsInitialAction.class, "MNU_NONEMODE"));
