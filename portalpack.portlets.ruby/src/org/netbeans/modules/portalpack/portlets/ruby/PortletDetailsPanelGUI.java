...
public final class PortletDetailsPanelGUI extends JPanel implements DocumentListener{
    ...
    public PortletDetailsPanelGUI(PortletDetailsPanel panel) {
        ...
        isRubyPortletExists = panel.isPhpPortletAlreadyExists();
    ...
    public void enableComponents(boolean status)
    {
        ...
        packageTextField.setEditable(status);
    ...
    private void initComponents() {
        ...
        jLabel6.setLabelFor(packageTextField);
        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(PortletDetailsPanelGUI.class, "LBL_JAVA_PACKAGE")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(48, 48, 48)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(packageTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE)
    ...
    {
        if(isRubyPortletExists) return true;
        
        String packageName = getPackageName();
        if (!PortletProjectUtils.isValidJavaPackageName(packageName)) {
            wizardDescriptor.putProperty("WizardPanel_errorMessage", NbBundle.getMessage(PortletDetailsPanelGUI.class, "MSG_InvalidPackageName", packageName)); // NOI18N
            return false;
        }
