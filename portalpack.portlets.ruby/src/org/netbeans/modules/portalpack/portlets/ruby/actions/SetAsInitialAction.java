...
package org.netbeans.modules.portalpack.portlets.ruby.actions;
...
public class SetAsInitialAction extends AbstractAction
    ...
    private static boolean isRubyInPortletProject(FileObject fo){
        //check for jsp extension
        if(fo == null) return false;
        if(fo.getExt().compareToIgnoreCase("rb") == 0){ // NOI18N
