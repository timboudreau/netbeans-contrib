 ...
 * @author Satya
 */
public class RubyProjectConstants {
    public final static String VISUAL_WEB_FRAMEWWORK = "org.netbeans.modules.visualweb.project.jsf.framework.JSFFrameworkProvider"; // NOI18N
    public final static String RAVE_AUX_NAMESPACE = "http://www.sun.com/creator/ns"; // NOI18N
    public final static String RAVE_AUX_NAME = "creator-data"; // NOI18N
    ...
    public final static String[] CreatorProperties = {
        PROP_CURRENT_THEME,
        PROP_JSF_PAGEBEAN_PACKAGE,
