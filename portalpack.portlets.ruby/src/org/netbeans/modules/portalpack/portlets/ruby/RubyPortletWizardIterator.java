...
import org.netbeans.modules.portalpack.portlets.ruby.util.RubyPortletProjectUtil;
import org.netbeans.modules.portalpack.portlets.ruby.util.RubyTemplateUtil;
...
public final class RubyPortletWizardIterator implements TemplateWizard.Iterator, RubyPortletConstants/*WizardDescriptor.InstantiatingIterator*/ {
...
//    }
    public Set<DataObject> instantiate(TemplateWizard wizard) throws IOException {
        ...
        if (targetName == null) {
            ...
            if ("rb".equals(template.getExt())) { // NOI18N
    ...
    public void initialize(TemplateWizard wizard) {
        ...
        FileObject webInfDir = PortletProjectUtils.getWebInf(project);
        //FileObject rubyFolderObj = FileUtil.toFileObject(webInfDir);
        ...
        if ((relativePath == null) || (relativePath.indexOf("WEB-INF") != -1)) {
            ...
            Templates.setTargetFolder(wizard, webInfDir);
            jspDir = docRoot;
        ...
        String prefix = "rb".equals(ext) ? "view" : "view"; // NOI18N
    ...
    public String name() {
        return NbBundle.getMessage(RubyPortletWizardIterator.class, "TITLE_x_of_y", new Integer(index + 1), new Integer(panels.length));
    }
    ...
    private void addRubyPortlet(Project project, String packageName, String className, PortletContext pc, String viewPhp,String actionRb,String[] globalfiles) {
        ...
        if (!PortletDDHelper.isRubyPortletEntryPresent(portletApp)) {
