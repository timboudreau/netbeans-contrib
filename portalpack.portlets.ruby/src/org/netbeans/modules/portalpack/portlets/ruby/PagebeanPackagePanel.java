...
final class PagebeanPackagePanel implements WizardDescriptor.Panel, ChangeListener {
    ...
    public void storeSettings(Object settings) { 
        ...
        if (isValid()) {
            ((WizardDescriptor) settings).putProperty(RubyProjectConstants.PROP_JSF_PAGEBEAN_PACKAGE, gui.getPackageName());
        }
    }

    public void stateChanged(ChangeEvent e) {        
        if (wizard != null && isValid()) {
            wizard.putProperty(RubyProjectConstants.PROP_JSF_PAGEBEAN_PACKAGE, gui.getPackageName());
        }
