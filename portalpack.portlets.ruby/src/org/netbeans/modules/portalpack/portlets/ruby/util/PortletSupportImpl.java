...
public class PortletSupportImpl {
    ...
    public File getPortletDD() throws PortletSupportException {
        FileObject portletDDFO = project.getProjectDirectory().getFileObject(RubyProjectConstants.PATH_WEB_INF + "/portlet.xml");  // NOI18N
        if(null == portletDDFO) {
    ...
    public String getPortletPageFolderPath(FileObject inFO) {
        ...
        FileObject webRoot = project.getProjectDirectory().getFileObject(RubyProjectConstants.PATH_DOC_ROOT);
        if(webRoot == null) {
            return null;
        }
