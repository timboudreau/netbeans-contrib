...
public class GnatCompilerCommand extends CompilerCommand {
     ...
     * @param project
     */
    public GnatCompilerCommand(AdaPlatform platform, String projectPath, String objectFolder, String sourceFolder, String mainProgram, String executableName) {
        ...
        GnatCommand[] gnatCommandArray = new GnatCommand[] {
            new GnatMake(platform, projectPath, objectFolder, sourceFolder, mainProgram, executableName)
        };
