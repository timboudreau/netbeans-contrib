...
public class HtmlProjectPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private HtmlProjectWizardPanel panel;

    /** Creates new form PanelProjectLocationVisual */
    public HtmlProjectPanelVisual(HtmlProjectWizardPanel panel) {
        initComponents();
        this.panel = panel;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, "Character Set");
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(encodings, 0, 191, Short.MAX_VALUE)
...
private void encodingChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_encodingChanged
    ...
    boolean valid(WizardDescriptor wizardDescriptor) {
        ...
        String nm = projectNameTextField.getText();
        if (nm.length() == 0) {
            wizardDescriptor.putProperty("WizardPanel_errorMessage", //NOI18N
                    "Project Name is empty.");
            return false; // Display name not specified
        } else if (nm.indexOf('\\') >= 0 || nm.indexOf('/') >= 0) {
            wizardDescriptor.putProperty("WizardPanel_errorMessage", //NOI18N
                    "/ and \\ characters not allowed in name.");
            return false; // Display name not specified
        }
        File f = FileUtil.normalizeFile(new File(projectLocationTextField.getText()).getAbsoluteFile());
        if (!f.isDirectory()) {
            String message = "Project Folder is not a valid folder path.";
            wizardDescriptor.putProperty("WizardPanel_errorMessage", message); //NOI18N
            return false;
        }
//        final File destFolder = FileUtil.normalizeFile(new File(
//                createdFolderTextField.getText()).getAbsoluteFile());
        ...
        try {
            ...
            wizardDescriptor.putProperty("WizardPanel_errorMessage", e.getLocalizedMessage()); //NOI18N
        }
    ...
    void store(WizardDescriptor d) {
        ...
        String folder = projectLocationTextField.getText();
        d.putProperty("projdir", new File(folder)); //NOI18N
        d.putProperty("name", name); //NOI18N
        d.putProperty("encoding", encodings.getSelectedItem());
    }
    ...
    void read(WizardDescriptor settings) {
        ...
        String enc = (String) settings.getProperty("encoding");
        if (enc == null) {
            enc = "UTF-8"; //NOI18NB
        }
