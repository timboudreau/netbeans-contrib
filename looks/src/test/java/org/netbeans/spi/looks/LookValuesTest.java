 ...
 */
public class LookValuesTest extends TestBaseValues {

    // Methods of testCase -----------------------------------------------------

    public LookValuesTest(java.lang.String testName) {
        super(testName);
    }
    ...
    public static NbTest suite() {
        NbTestSuite suite = new NbTestSuite(LookValuesTest.class);
        return suite;
    }    
    
    protected void setUp() throws Exception {
        
        Look look = new SampleLook( "LookValuesTest" );
