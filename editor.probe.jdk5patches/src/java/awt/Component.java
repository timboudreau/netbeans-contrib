                                           ...
                                           Serializable
{
    ...
    private static final Map<Component, Throwable> origins = Collections.synchronizedMap(new WeakHashMap<Component, Throwable>());
    ...
    final boolean requestFocusHelper(boolean temporary,
        ...
        boolean success = _requestFocusHelper(temporary, focusedWindowChangeAllowed);
        if (!success) {
