...
public class GenerateWsdlAction extends NodeAction  {
    ...
    public String getName() {
        return NbBundle.getMessage(ServiceConfigurationAction.class, "LBL_GenerateWsdlAction");
    }
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        if (wsdlAlreadyExists) {
            String message = NbBundle.getMessage(ServiceConfigurationAction.class, "TXT_ConfirmWsdlReplace", serviceName);
