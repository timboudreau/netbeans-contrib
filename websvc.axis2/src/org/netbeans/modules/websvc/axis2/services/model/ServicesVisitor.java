...
public interface ServicesVisitor {
     ...
     */
    public static class Default implements ServicesVisitor {
        ...
        public void visit(MessageReceiver receiver) {
        }
        
        public void visit(MessageReceivers receivers) {
        }
    ...
    public static class Deep extends Default {
        protected void visitChild(ServicesComponent component) {
            for (ServicesComponent child : component.getChildren()) {
                child.accept(this);
            }
        }
    }
