...
public class WsFromJavaPanel1 implements  WizardDescriptor.FinishablePanel<WizardDescriptor>, ChangeListener {
    ...
    public WsFromJavaPanel1(Project project, WizardDescriptor wizardDescriptor) {
    ...
    public Component getComponent() {
        if (component == null) {
            component = new WsFromJavaGUIPanel1(this);
        }
    ...
    public HelpCtx getHelp() {
        return new HelpCtx(WsFromJavaPanel1.class);
    }
