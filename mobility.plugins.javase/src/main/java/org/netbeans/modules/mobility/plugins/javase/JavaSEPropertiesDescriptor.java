...
public class JavaSEPropertiesDescriptor implements ProjectPropertiesDescriptor {
    ...
    /** Creates a new instance of JavaSEPropertiesDescriptor */
    public JavaSEPropertiesDescriptor() {
    }

    public Set<PropertyDescriptor> getPropertyDescriptors() {
        return Collections.singleton(new PropertyDescriptor(MAIN_CLASS, true, DefaultPropertyParsers.STRING_PARSER, "")); //NOI18N
    }
