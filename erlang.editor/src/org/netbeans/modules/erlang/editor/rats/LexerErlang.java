...
// on Saturday, February 7, 2009 at 4:48:40 PM.
...
public final class LexerErlang extends ParserBase {
      ...
      if ('#' == yyC) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = GNode.create("Rec", v$g$1, v$g$2);
          ...
          if (yyResult.hasValue("spec")) {
            ...
            yyValue = GNode.create("Rec", v$g$1, v$g$3);
  ...
  private Result pKeyword(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("spec")) {
      ...
      yyValue = GNode.create("Spec", v$g$25);
    ...
    if (yyResult.hasValue("try")) {
      ...
      yyValue = GNode.create("Try", v$g$26);
    ...
    if (yyResult.hasValue("when")) {
      ...
      yyValue = GNode.create("When", v$g$27);
    ...
    if (yyResult.hasValue("xor")) {
      ...
      yyValue = GNode.create("Xor", v$g$28);
  ...
  /**
   * Parse synthetic nonterminal 
   * org.netbeans.modules.erlang.editor.rats.LexerErlang.$$Shared1.
   * This nonterminal represents the duplicate productions 
   * org.netbeans.modules.erlang.editor.rats.LexerErlang.stop$$Choice1 
   * and org.netbeans.modules.erlang.editor.rats.LexerErlang.separator$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
