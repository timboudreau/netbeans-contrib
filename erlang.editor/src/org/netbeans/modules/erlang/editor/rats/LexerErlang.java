...
// on Wednesday, February 4, 2009 at 9:36:08 AM.
...
public final class LexerErlang extends ParserBase {
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.erlang.editor.rats.LexerErlang.Literal.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pSeparator(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("=")) {
      ...
      yyValue = GNode.create("Eq", v$g$35);
    ...
    if (yyResult.hasValue("!")) {
      ...
      yyValue = GNode.create("Exclamation", v$g$36);
