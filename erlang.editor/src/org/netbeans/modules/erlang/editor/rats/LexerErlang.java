...
// on Saturday, July 4, 2009 at 1:02:36 PM.
...
public final class LexerErlang extends ParserBase {
  ...
  private Result pSeparator$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("<=")) {
      ...
      yyValue = GNode.create("LArrow", v$g$15);
    ...
    if (yyResult.hasValue("<")) {
      ...
      yyValue = GNode.create("Lt", v$g$16);
    ...
    if (yyResult.hasValue(">>")) {
      ...
      yyValue = GNode.create("DGt", v$g$17);
    ...
    if (yyResult.hasValue(">=")) {
      ...
      yyValue = GNode.create("Ge", v$g$18);
    ...
    if (yyResult.hasValue(">")) {
      ...
      yyValue = GNode.create("Gt", v$g$19);
    ...
    if (yyResult.hasValue(":-")) {
      ...
      yyValue = GNode.create("ColonMinus", v$g$20);
    ...
    if (yyResult.hasValue("::")) {
      ...
      yyValue = GNode.create("DColon", v$g$21);
    ...
    if (yyResult.hasValue(":")) {
      ...
      yyValue = GNode.create("Colon", v$g$22);
    ...
    if (yyResult.hasValue("#")) {
      ...
      yyValue = GNode.create("Hash", v$g$23);
    ...
    if (yyResult.hasValue("++")) {
      ...
      yyValue = GNode.create("DPlus", v$g$24);
    ...
    if (yyResult.hasValue("+")) {
      ...
      yyValue = GNode.create("Plus", v$g$25);
    ...
    if (yyResult.hasValue("--")) {
      ...
      yyValue = GNode.create("DMinus", v$g$26);
    ...
    if (yyResult.hasValue("->")) {
      ...
      yyValue = GNode.create("RArrow", v$g$27);
    ...
    if (yyResult.hasValue("-")) {
      ...
      yyValue = GNode.create("Minus", v$g$28);
    ...
    if (yyResult.hasValue("*")) {
      ...
      yyValue = GNode.create("Star", v$g$29);
    ...
    if (yyResult.hasValue("/=")) {
      ...
      yyValue = GNode.create("Ne", v$g$30);
    ...
    if (yyResult.hasValue("/")) {
      ...
      yyValue = GNode.create("Slash", v$g$31);
    ...
    if (yyResult.hasValue("=:=")) {
      ...
      yyValue = GNode.create("EEq", v$g$32);
    ...
    if (yyResult.hasValue("=/=")) {
      ...
      yyValue = GNode.create("ENe", v$g$33);
    ...
    if (yyResult.hasValue("==")) {
      ...
      yyValue = GNode.create("DEq", v$g$34);
    ...
    if (yyResult.hasValue("=<")) {
      ...
      yyValue = GNode.create("Le", v$g$35);
    ...
    if (yyResult.hasValue("=>")) {
      ...
      yyValue = GNode.create("RArrow", v$g$36);
    ...
    if (yyResult.hasValue("=")) {
      ...
      yyValue = GNode.create("Eq", v$g$37);
    ...
    if (yyResult.hasValue("!")) {
      ...
      yyValue = GNode.create("Exclamation", v$g$38);
