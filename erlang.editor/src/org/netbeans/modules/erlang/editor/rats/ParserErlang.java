...
// on Saturday, July 4, 2009 at 1:02:38 PM.
...
public final class ParserErlang extends ParserBase {
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.erlang.editor.rats.ParserErlang.Script.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pScript(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    Result     yyPredResult;
      ...
      if ('!' == yyC) {
        ...
        while (true) {
          ...
          if (! yyPredMatched) {
            ...
            yyError = yyError.select("script expected", yyStart);
          }
          break;
        }
  ...
  private Result pForm(final int yyStart) throws IOException {
    ...
    yyResult = pSYNTAX_ERROR(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = GNode.create("Form", false);
        yyValue.setLocation(location(yyStart));
                        ...
                        if (yyResult.hasValue()) {
                          ...
                          while (true) {
                            ...
                            if (! yyPredMatched) {
                              ...
                              if (-1 != yyC) {
                                yyIndex = yyRepetition1 + 1;
                                char v$el$5 = (char)yyC;

                                yyRepetition1 = yyIndex;
                                yyRepValue1   = 
                                  new Pair<Object>(v$el$5, yyRepValue1);
                                continue;
                              }
                            } else {
                          ...
                          { // Start scope for v$g$4.
                            Pair<Character> v$g$4 = cast(yyRepValue1.reverse());
                  ...
                  if (yyResult.hasValue("(")) {
                    ...
                    if (yyResult.hasValue()) {
                      ...
                      { // Start scope for v$g$10.
                        Pair<Node> v$g$10 = cast(yyRepValue1.reverse());
                  ...
                  if (yyResult.hasValue("(")) {
                    ...
                    if (yyResult.hasValue()) {
                      ...
                      while (true) {
                        ...
                        if (yyResult.hasValue(".")) {
                          ...
                          if (yyResult.hasValue()) {
                            ...
                            yyRepetition1 = yyResult.index;
                            yyRepValue1   = 
                              new Pair<Object>(v$el$10, yyRepValue1);
                            continue;
                          }
                        } else {
                          yyError = yyError.select("'.' expected", yyBase);
                      ...
                      { // Start scope for v$g$14.
                        Pair<Node> v$g$14 = cast(yyRepValue1.reverse());
                      ...
                      if ('l' == yyC) {
                        ...
                        if ('i' == yyC) {
                          ...
                          if ('b' == yyC) {
                            ...
                            yyError = yyError.select("'include_lib' expected", yyBase);
                          }
                        } else {
                          yyError = yyError.select("'include_lib' expected", yyBase);
                        }
  ...
  private Result pRecordExpr(final int yyStart) throws IOException {
    ...
    yyResult = pRecordExpr1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Node v$g$1 = yyResult.semanticValue();

      yyValue = GNode.create("RecordExpr", v$g$1);
      yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pRecordExpr1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Node v$g$3 = yyResult.semanticValue();

        yyValue = GNode.create("RecordExpr", v$g$2, v$g$3);
        yyValue.setLocation(location(yyStart));
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.erlang.editor.rats.ParserErlang.RecordExpr1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pRecordExpr1(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyBase;
    Node       yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(".")) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("RecordExpr1", v$g$1, v$g$2);
          yyValue.setLocation(location(yyStart));
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("RecordExpr1", v$g$1, v$g$3);
          yyValue.setLocation(location(yyStart));
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = GNode.create("RecordExpr1", v$g$1, v$g$4);
        yyValue.setLocation(location(yyStart));
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue(".")) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = GNode.create("RecordExpr1", v$g$5, v$g$6);
            yyValue.setLocation(location(yyStart));
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = GNode.create("RecordExpr1", v$g$5, v$g$7);
            yyValue.setLocation(location(yyStart));
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("RecordExpr1", v$g$5, v$g$8);
          yyValue.setLocation(location(yyStart));
    ...
    // Done.
    yyError = yyError.select("record expr1 expected", yyStart);
    return yyError;
  }
  ...
  private Result pSTOP(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fSTOP) 
      yyColumn.chunk2.fSTOP = pSTOP$1(yyStart);
    return yyColumn.chunk2.fSTOP;
  }

  /** Actually parse org.netbeans.modules.erlang.editor.rats.Symbol.STOP. */
  private Result pSTOP$1(final int yyStart) throws IOException {
    Result     yyResult;
    Void       yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pseparator(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fseparator) 
      yyColumn.chunk2.fseparator = pseparator$1(yyStart);
    return yyColumn.chunk2.fseparator;
  }

  /** Actually parse org.netbeans.modules.erlang.editor.rats.Symbol.separator. */
