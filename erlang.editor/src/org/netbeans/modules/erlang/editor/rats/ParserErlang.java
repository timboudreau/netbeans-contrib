...
// on Sunday, February 22, 2009 at 7:07:32 PM.
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(":")) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("SpecFun", v$g$1, v$g$2);
          yyValue.setLocation(location(yyStart));
      ...
      if (yyResult.hasValue(")")) {
        ...
        if (yyResult.hasValue("->")) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = GNode.create("FunType", v$g$1);
            yyValue.setLocation(location(yyStart));
        ...
        if (yyResult.hasValue(")")) {
          ...
          if (yyResult.hasValue("->")) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyValue = GNode.create("FunType", v$g$2, v$g$3);
              yyValue.setLocation(location(yyStart));
  ...
  private Result pExpr800(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue(":")) {
        ...
        yyResult = pExprMax(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Node v$el$1 = yyResult.semanticValue();
