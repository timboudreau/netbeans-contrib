...
// on Wednesday, February 11, 2009 at 7:39:52 PM.
  ...
  private Result pExprMax$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("(")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue(")")) {
          ...
          yyValue = GNode.create("ParenExpr", v$g$8);
          yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue("begin")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("BeginExpr", v$g$9);
          yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for v$g$17.
        ...
        yyValue = GNode.create("MacroExpr", v$g$16, v$g$17);
        yyValue.setLocation(location(yyStart));
    ...
    // Done.
    yyError = yyError.select("expr max expected", yyStart);
    return yyError;
  }
  ...
  private Result pArgumentList$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("(")) {
      ...
      if (yyResult.hasValue(")")) {
        ...
        yyValue = GNode.create("ArgumentList", false);
        yyValue.setLocation(location(yyStart));
