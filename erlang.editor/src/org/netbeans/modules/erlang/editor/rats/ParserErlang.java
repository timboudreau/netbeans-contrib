...
// on Friday, February 6, 2009 at 6:35:54 PM.
...
public final class ParserErlang extends ParserBase {
  ...
  private Result pAtomId(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fAtomId) 
      yyColumn.chunk2.fAtomId = pAtomId$1(yyStart);
    return yyColumn.chunk2.fAtomId;
  }
  ...
  private Result pVarId(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fVarId) 
      yyColumn.chunk2.fVarId = pVarId$1(yyStart);
    return yyColumn.chunk2.fVarId;
  }
