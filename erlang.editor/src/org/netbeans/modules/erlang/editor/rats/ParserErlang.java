...
// on Sunday, February 15, 2009 at 10:51:59 PM.
    ...
    if (yyResult.hasValue("-")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("Attribute", v$g$1, v$g$3);
          yyValue.setLocation(location(yyStart));
        ...
        if (yyResult.hasValue("(")) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue(")")) {
              ...
              yyValue = GNode.create("Attribute", v$g$1, v$g$4);
              yyValue.setLocation(location(yyStart));
      ...
      if (yyResult.hasValue("spec")) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("Attribute", v$g$5);
          yyValue.setLocation(location(yyStart));
