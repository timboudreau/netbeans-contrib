...
// on Monday, February 9, 2009 at 1:05:42 PM.
...
public final class ParserErlang extends ParserBase {
  ...
  private Result pTypedExprs$$Choice1(final int yyStart) throws IOException {
    ...
    // Done.
    yyError = yyError.select("typed exprs expected", yyStart);
    return yyError;
  }
  ...
  private Result pExprMax$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("begin")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("ExprMax", v$g$9, v$g$10);
          yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for v$g$18.
        ...
        yyValue = GNode.create("ExprMax", v$g$17, v$g$18);
        yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue("if")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("IfExpr", v$g$1, v$g$2);
          yyValue.setLocation(location(yyStart));
        ...
        if (yyResult.hasValue("of")) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyValue = GNode.create("CaseExpr", v$g$1, v$g$2, v$g$3);
              yyValue.setLocation(location(yyStart));
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyValue = GNode.create("ReceiveExpr", v$g$3, v$g$4, v$g$5);
              yyValue.setLocation(location(yyStart));
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyValue = GNode.create("ReceiveExpr", v$g$6, v$g$7, v$g$8, v$g$9);
                yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue("fun")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("FunExpr", v$g$5, v$g$6);
          yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue("catch")) {
      ...
      if (yyResult.hasValue()) {
        ...
        { // Start scope for v$g$2.
          ...
          yyResult = pEND(yyOption1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            Node v$g$3 = yyResult.semanticValue();

            yyValue = GNode.create("TryCatch", v$g$1, v$g$2, v$g$3);
            yyValue.setLocation(location(yyStart));
    ...
    if (yyResult.hasValue("after")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("TryCatch", v$g$4, v$g$5);
          yyValue.setLocation(location(yyStart));
  ...
  /**
   * Parse nonterminal org.netbeans.modules.erlang.editor.rats.Error.END.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pEND(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("end")) {
      ...
      yyValue = GNode.create("END", false);
      yyValue.setLocation(location(yyStart));
    ...
    yyResult = pEndExpected(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Node v$g$1 = yyResult.semanticValue();

      yyValue = GNode.create("END", v$g$1);
      yyValue.setLocation(location(yyStart));
  ...
  /**
   * Parse nonterminal 
   * org.netbeans.modules.erlang.editor.rats.Error.EndExpected.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pEndExpected(final int yyStart) throws IOException {
    int        yyC;
    boolean    yyPredMatched;
    Node       yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (! yyPredMatched) {
      ...
      yyValue = GNode.create("Error", "keyword: end expected");

      setLocation(yyValue, yyStart);
      return new SemanticValue(yyValue, yyStart, yyError);
    } else {
      yyError = yyError.select("end expected expected", yyStart);
    }
