...
// on Sunday, February 22, 2009 at 1:45:27 PM.
...
public final class ParserErlang extends ParserBase {
  ...
  private Result pPredAttr(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("-")) {
            ...
            while (true) {
              ...
              if (yyResult.hasValue(".")) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyRepetition1 = yyResult.index;
                  yyRepValue1   = new Pair<Node>(v$el$8, yyRepValue1);
                  continue;
                }
              } else {
                yyError = yyError.select("\".\" expected", yyBase);
            ...
            while (true) {
              ...
              if (yyResult.hasValue(".")) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyRepetition1 = yyResult.index;
                  yyRepValue1   = new Pair<Node>(v$el$10, yyRepValue1);
                  continue;
                }
              } else {
                yyError = yyError.select("\".\" expected", yyBase);
      ...
      yyResult = pAtomId(yyBase);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue("includelib")) {
    ...
    if (yyResult.hasValue("fun")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue(":")) {
          ...
          yyResult = pFunExpr$$Choice2(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            Node v$g$2 = yyResult.semanticValue();
        ...
        if (yyResult.hasValue("/")) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = GNode.create("FunExpr", v$g$1, v$g$4);
            yyValue.setLocation(location(yyStart));
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = GNode.create("FunExpr", v$g$5);
          yyValue.setLocation(location(yyStart));
