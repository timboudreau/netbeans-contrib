...
// on Monday, February 9, 2009 at 3:51:30 PM.
...
public final class ParserErlang extends ParserBase {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("of")) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pTryCatch(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              Node v$g$3 = yyResult.semanticValue();
        ...
        yyResult = pTryCatch(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Node v$g$4 = yyResult.semanticValue();

          yyValue = GNode.create("TryExpr", v$g$1, v$g$4);
          yyValue.setLocation(location(yyStart));
  ...
  private Result pTryCatch(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fTryCatch) 
      yyColumn.chunk1.fTryCatch = pTryCatch$1(yyStart);
    return yyColumn.chunk1.fTryCatch;
  }

  /** Actually parse org.netbeans.modules.erlang.editor.rats.ParserErlang.TryCatch. */
  ...
  private Result pEND_E(final int yyStart) throws IOException {
    ...
    yyPredResult = pEND_E$$Choice1(yyStart);
    yyError      = yyPredResult.select(yyError);
    if (yyPredResult.hasValue()) {
  ...
  private Result pSEMI_E(final int yyStart) throws IOException {
    ...
    yyPredResult = pSEMI_E$$Choice1(yyStart);
    yyError      = yyPredResult.select(yyError);
    if (yyPredResult.hasValue()) {
