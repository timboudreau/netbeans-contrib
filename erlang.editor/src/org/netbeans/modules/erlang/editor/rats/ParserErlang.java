...
// on Friday, February 6, 2009 at 8:25:39 PM.
...
public final class ParserErlang extends ParserBase {
  ...
  private Result pMacroId(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pMacro(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Node v$g$1 = yyResult.semanticValue();
      ...
      if (yyResult.hasValue()) {
        ...
        { // Start scope for v$g$2.
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = GNode.create("Macro", v$g$1, v$g$2, v$g$3);
            yyValue.setLocation(location(yyStart));
          ...
          if (yyResult.hasValue()) {
            ...
            yyValue = GNode.create("Macro", v$g$1, v$g$2, v$g$4);
            yyValue.setLocation(location(yyStart));
  ...
  /**
   * Parse synthetic nonterminal 
   * org.netbeans.modules.erlang.editor.rats.ParserErlang.Macro$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
