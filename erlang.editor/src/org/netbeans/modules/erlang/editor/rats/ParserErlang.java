...
// on Friday, February 6, 2009 at 3:53:34 PM.
...
public final class ParserErlang extends ParserBase {
  ...
  private Result pAtomId(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk6) yyColumn.chunk6 = new Chunk6();
    if (null == yyColumn.chunk6.fAtomId) 
      yyColumn.chunk6.fAtomId = pAtomId$1(yyStart);
    return yyColumn.chunk6.fAtomId;
  }

  /** Actually parse org.netbeans.modules.erlang.editor.rats.Identifier.AtomId. */
  private Result pAtomId$1(final int yyStart) throws IOException {
    Result     yyResult;
    Node       yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pVarId(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk6) yyColumn.chunk6 = new Chunk6();
    if (null == yyColumn.chunk6.fVarId) 
      yyColumn.chunk6.fVarId = pVarId$1(yyStart);
    return yyColumn.chunk6.fVarId;
  }

  /** Actually parse org.netbeans.modules.erlang.editor.rats.Identifier.VarId. */
  private Result pVarId$1(final int yyStart) throws IOException {
    Result     yyResult;
    Node       yyValue;
    ParseError yyError = ParseError.DUMMY;
