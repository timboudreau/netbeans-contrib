...
// on Monday, February 9, 2009 at 8:24:09 PM.
...
public final class ParserErlang extends ParserBase {
  ...
  private Result pTypedExprs(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        yyResult = pTypedExprs$$Choice1(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Node v$el$1 = yyResult.semanticValue();
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        yyResult = pTypedExprs$$Choice2(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  private Result pExprMax(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fExprMax) 
      yyColumn.chunk1.fExprMax = pExprMax$1(yyStart);
    return yyColumn.chunk1.fExprMax;
  }
  ...
  private Result pLcExpr(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fLcExpr) 
      yyColumn.chunk1.fLcExpr = pLcExpr$1(yyStart);
    return yyColumn.chunk1.fLcExpr;
  }
  ...
  private Result pFunClauses(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pFunClauses(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Node v$el$1 = yyResult.semanticValue();
  ...
  private Result pTryClause(final int yyStart) throws IOException {
    ParserErlangColumn yyColumn = (ParserErlangColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fTryClause) 
      yyColumn.chunk1.fTryClause = pTryClause$1(yyStart);
    return yyColumn.chunk1.fTryClause;
  }
