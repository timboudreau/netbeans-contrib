...
class ErlangKeystrokeHandler extends KeystrokeHandler {
  ...
  override def beforeBreak(document:Document, _offset:Int, target:JTextComponent) :Int = {
    isAfter = false
    var offset = _offset
  ...
  @throws(classOf[BadLocationException])
  override def beforeCharInserted(document:Document, _caretOffset:Int, target:JTextComponent, ch:Char) :Boolean = {
    isAfter = false
  ...
  override def findLogicalRanges(pResult:ParserResult, caretOffset:Int) :List[OffsetRange] = {
