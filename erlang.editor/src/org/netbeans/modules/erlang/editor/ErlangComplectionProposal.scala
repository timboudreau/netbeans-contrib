...
class KeywordProposal(keyword:String, description:String, anchor:Int) extends ErlangComplectionProposal(null, anchor) {
  ...
  override def getIcon :ImageIcon = keywordIcon

  override def getModifiers :Set[Modifier] = Collections.emptySet[Modifier]

  override def getElement :ElementHandle = PseudoElement(keyword, ElementKind.KEYWORD) // For completion documentation
...
class TagProposal(tag:String, description:String, anchor:Int) extends ErlangComplectionProposal(null, anchor) {
  ...
  override def getKind :ElementKind = ElementKind.TAG
  ...
  override def getElement :ElementHandle = PseudoElement(tag, ElementKind.TAG) // For completion documentation
