...
/**
 * Task scanning scope for the main project.
 * 
 * @author S. Aubrecht
 */
public class MainProjectNoDepsScanningScope extends TaskScanningScope 
    ...
    private MainProjectNoDepsScanningScope( String displayName, String description, Image icon ) {
     ...
     */
    public static MainProjectNoDepsScanningScope create() {
        return new MainProjectNoDepsScanningScope(
                NbBundle.getBundle( MainProjectNoDepsScanningScope.class  ).getString( "LBL_MainProjectNoDepsScope" ), //NOI18N
                NbBundle.getBundle( MainProjectNoDepsScanningScope.class  ).getString( "HINT_MainProjectNoDepsScope" ), //NOI18N
                Utilities.loadImage( "org/netbeans/modules/tasklist/scanningscopes/main_project_nodeps_scope.png" ) //NOI18N
                );
    }
