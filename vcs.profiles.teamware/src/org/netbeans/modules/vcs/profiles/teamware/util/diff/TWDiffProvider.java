 ...
 *  <code>Lookup.getDefault().lookup(TWDiffProvider.class)</code>)
 *
 *
 * @author Martin Entlicher
 */
public abstract class TWDiffProvider extends Object {

    /*
    public static TWDiffProvider getDefault() {
        return (TWDiffProvider) Lookup.getDefault().lookup(TWDiffProvider.class);
    }
     */
