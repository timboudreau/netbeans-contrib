/**
 *	This generated bean class DependencyType matches the schema element 'dependencyType'.
...
public class DependencyType extends org.netbeans.modules.j2ee.geronimo2.config.gen.ArtifactType
{
	...
	static public final String IMPORT = "Import";	// NOI18N
	...
	static public final String IMPORT2 = "Import2";	// NOI18N
	...
	static public final String IMPORT3 = "Import3";	// NOI18N
	...
	public DependencyType(int options)
	{
		...
		this.createProperty("type", 	// NOI18N
			...
			Common.TYPE_0_1 | Common.TYPE_STRING | Common.TYPE_KEY, 
			java.lang.String.class);
		this.createProperty("import", 	// NOI18N
			IMPORT, 
			Common.TYPE_0_1 | Common.TYPE_STRING | Common.TYPE_KEY, 
			java.lang.String.class);
		this.createProperty("groupId", 	// NOI18N
	...
	public void setImport(java.lang.String value) {
		this.setValue(IMPORT, value);
	}

	//
	public java.lang.String getImport() {
		return (java.lang.String)this.getValue(IMPORT);
	}
	...
	// This attribute is optional
	public void setImport2(java.lang.String value) {
		this.setValue(IMPORT2, value);
	}

	//
	public java.lang.String getImport2() {
		return (java.lang.String)this.getValue(IMPORT2);
	}
	...
	// This attribute is optional
	public void setImport3(java.lang.String value) {
		this.setValue(IMPORT3, value);
	}

	//
	public java.lang.String getImport3() {
		return (java.lang.String)this.getValue(IMPORT3);
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("Import");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		o = this.getImport();
		str.append((o==null?"null":o.toString().trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(IMPORT, 0, str, indent);
		...
		str.append(indent);
		str.append("Import2");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		o = this.getImport2();
		str.append((o==null?"null":o.toString().trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(IMPORT2, 0, str, indent);
		...
		str.append(indent);
		str.append("Import3");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		o = this.getImport3();
		str.append((o==null?"null":o.toString().trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(IMPORT3, 0, str, indent);

	}
	public String dumpBeanNode(){
		StringBuffer str = new StringBuffer();
		str.append("DependencyType\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
