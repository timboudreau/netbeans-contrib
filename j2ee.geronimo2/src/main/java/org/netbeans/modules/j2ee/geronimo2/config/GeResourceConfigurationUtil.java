...
/**
 * Helper class for writing descriptors
 * @author Max Sauer
 */
public class GeResourceConfigurationUtil {
        ...
        try {
            ...
            if (cfolder == null) {
                ...
                try {
                    ...
                    throw new ConfigurationException(NbBundle.getMessage(GeModuleConfiguration.class, "MSG_FailedToCreateConfigFolder", parentFile.getAbsolutePath()));
                }
            }
    ...
    static void replaceDocument(final StyledDocument doc, WebApp graph) {
    ...
    private GeResourceConfigurationUtil() {
    }
}
