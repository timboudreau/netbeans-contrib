/**
 *	This generated bean class Persistence matches the schema element 'persistence'.
...
public class Persistence extends org.netbeans.modules.schema2beans.BaseBean
{

	static Vector comparators = new Vector();
	private static final org.netbeans.modules.schema2beans.Version runtimeVersion = new org.netbeans.modules.schema2beans.Version(5, 0, 0);

	static public final String EEVERSION = "EeVersion";	// NOI18N
	...
	public Persistence(int options)
	{
		super(comparators, runtimeVersion);
		// Properties (see root bean comments for the bean graph)
		initPropertyTables(1);
		this.createProperty("persistence-unit", 	// NOI18N
			PERSISTENCE_UNIT, 
			Common.TYPE_0_N | Common.TYPE_BEAN | Common.TYPE_KEY, 
			PersistenceUnit.class);
		this.createAttribute(PERSISTENCE_UNIT, "ee:name", "EeName", 
						AttrProp.CDATA | AttrProp.REQUIRED,
						null, null);
		this.createAttribute(PERSISTENCE_UNIT, "ee:transaction-type", "EeTransactionType", 
	...
	public void setEeVersion(java.lang.String value) {
		setAttributeValue(EEVERSION, value);
	}

	//
	public java.lang.String getEeVersion() {
		return getAttributeValue(EEVERSION);
	}

	// This attribute is an array, possibly empty
	public void setPersistenceUnit(int index, PersistenceUnit value) {
		this.setValue(PERSISTENCE_UNIT, index, value);
	}

	//
	public PersistenceUnit getPersistenceUnit(int index) {
		return (PersistenceUnit)this.getValue(PERSISTENCE_UNIT, index);
	}

	// Return the number of properties
	public int sizePersistenceUnit() {
		return this.size(PERSISTENCE_UNIT);
	}

	// This attribute is an array, possibly empty
	public void setPersistenceUnit(PersistenceUnit[] value) {
		this.setValue(PERSISTENCE_UNIT, value);
	}

	//
	public PersistenceUnit[] getPersistenceUnit() {
		return (PersistenceUnit[])this.getValues(PERSISTENCE_UNIT);
	}

	// Add a new element returning its index in the list
	public int addPersistenceUnit(org.netbeans.modules.j2ee.geronimo2.config.gen.PersistenceUnit value) {
		int positionOfNewItem = this.addValue(PERSISTENCE_UNIT, value);
	...
	//
	public int removePersistenceUnit(org.netbeans.modules.j2ee.geronimo2.config.gen.PersistenceUnit value) {
		return this.removeValue(PERSISTENCE_UNIT, value);
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("PersistenceUnit["+this.sizePersistenceUnit()+"]");	// NOI18N
		for(int i=0; i<this.sizePersistenceUnit(); i++)
		{
			str.append(indent+"\t");
			str.append("#"+i+":");
			n = (org.netbeans.modules.schema2beans.BaseBean) this.getPersistenceUnit(i);
			if (n != null)
				n.dump(str, indent + "\t");	// NOI18N
			else
				str.append(indent+"\tnull");	// NOI18N
			this.dumpAttributes(PERSISTENCE_UNIT, i, str, indent);
		}
