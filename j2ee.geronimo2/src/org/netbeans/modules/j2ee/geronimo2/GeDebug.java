 ...
 * @author pblaha
 */
public class GeDebug {

    private static final String PROPERTY = "serverplugins.geronimo2.debug";
	...
	if (isEnabled()) {
	    System.out.println("serverplugins.geronimo2.debug: Class " + className + ", Message: " + msg);
	}
    }
}