 ...
 * @author maxa
 */
public final class GeCustomizerSupport {
    ...
    private GeCustomizerSupport() {
    }
    
    /**
     * Creates an editable customizer user pane.
     *
     * @param custData A model prepresenting the class path entries.
     *
     * @return A Component representing the classes pane.
     *
     * @throws NullPointerException If null model is passed in.
     */
    public static Component createUserCustomizer(GeCustomizerDataSupport custData) {
        if (custData == null) {
            throw new NullPointerException();
        }
        
        return new GeCustomizerUserPanel(custData);
    }
    ...
    private static class PathView extends JPanel {
        ...
        private void initComponents(PathModel model) {
            ...
            label.setText(NbBundle.getMessage(GeCustomizerSupport.class,key));
            label.setDisplayedMnemonic(NbBundle.getMessage(GeCustomizerSupport.class,mneKey).charAt(0));
            ...
            resources.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(GeCustomizerSupport.class,ad));
            ...
            if (type == JAVADOC) {
                ...
                String text = NbBundle.getMessage(GeCustomizerSupport.class, "CTL_AddZip");
                char mne = NbBundle.getMessage(GeCustomizerSupport.class, "MNE_AddZip").charAt(0);
                ad = NbBundle.getMessage(GeCustomizerSupport.class, "AD_AddZip");
                ...
                removeButton = new JButton(NbBundle.getMessage(GeCustomizerSupport.class, "CTL_Remove"));
                removeButton.setMnemonic(NbBundle.getMessage(GeCustomizerSupport.class, "MNE_Remove").charAt(0));
                removeButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(GeCustomizerSupport.class,"AD_Remove"));
                ...
                moveUpButton = new JButton(NbBundle.getMessage(GeCustomizerSupport.class, "CTL_Up"));
                moveUpButton.setMnemonic(NbBundle.getMessage(GeCustomizerSupport.class, "MNE_Up").charAt(0));
                moveUpButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(GeCustomizerSupport.class,"AD_Up"));
                ...
                moveDownButton = new JButton(NbBundle.getMessage(GeCustomizerSupport.class, "CTL_Down"));
                moveDownButton.setMnemonic(NbBundle.getMessage(GeCustomizerSupport.class, "MNE_Down").charAt(0));
                moveDownButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(GeCustomizerSupport.class,"AD_Down"));
        ...
        private void addPathElement() {
            ...
            if (this.type == JAVADOC) {
                title = NbBundle.getMessage(GeCustomizerSupport.class,"TXT_OpenJavadoc");
                message = NbBundle.getMessage(GeCustomizerSupport.class,"TXT_Javadoc");
                approveButtonName = NbBundle.getMessage(GeCustomizerSupport.class,"TXT_OpenJavadoc");
                approveButtonNameMne = NbBundle.getMessage(GeCustomizerSupport.class,"MNE_OpenJavadoc");
            }
            ...
            if (chooser.showOpenDialog(this)==JFileChooser.APPROVE_OPTION) {
                ...
                if (addingFailed) {
                    new NotifyDescriptor.Message(NbBundle.getMessage(GeCustomizerSupport.class,"TXT_CanNotAddResolve"),
