/**
 *	This generated bean class OpenejbJarType matches the schema element 'openejb-jarType'.
...
public class OpenejbJarType extends org.netbeans.modules.schema2beans.BaseBean
{
	...
	public OpenejbJarType(int options)
	{
	...
	public org.w3c.dom.Element getAny() {
		return (org.w3c.dom.Element)this.getValue(ANY);
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("Any");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		o = this.getAny();
		str.append((o==null?"null":o.toString().trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(ANY, 0, str, indent);

	}
	public String dumpBeanNode(){
		StringBuffer str = new StringBuffer();
		str.append("OpenejbJarType\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
