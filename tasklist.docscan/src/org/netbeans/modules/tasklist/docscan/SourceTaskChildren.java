...
/**
 * Children for SourceTaskNode. Implemented for regularity and
 * readability of the structure : children for node.
 */
final class SourceTaskChildren extends SuggestionChildren {

  public SourceTaskChildren(SuggestionImpl parent) {
    super(parent);
  }
