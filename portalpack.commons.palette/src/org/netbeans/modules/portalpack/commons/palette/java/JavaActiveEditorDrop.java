...
import org.netbeans.modules.portalpack.commons.palette.util.TemplateHelper;
import org.netbeans.modules.portalpack.commons.palette.util.TemplateNotFoundException;
...
public abstract class JavaActiveEditorDrop implements ActiveEditorDrop {
    ...
    protected String createBody(Map map) {
        ...
        TemplateHelper templateHelper = new TemplateHelper(TEMPLATE_PATH_PREFIX + "/" + getTemplateFolder());
