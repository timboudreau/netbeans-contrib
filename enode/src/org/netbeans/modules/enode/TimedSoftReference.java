...
/**
 * Copied from org.openide.util where this class is not public.
 *
 ...
 * @author Jesse Glick
 */
public final class TimedSoftReference extends SoftReference implements Runnable {
    
    private static final int TIMEOUT = 30000;
    
    private static final RequestProcessor RP = new RequestProcessor("enode-TimedSoftReference"); // NOI18N
