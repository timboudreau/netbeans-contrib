...
/**
 * Code template filter for EJS (from rhtml equivalent)
 * 
 * @author Tor Norbye
 */
public class EJSCodeTemplateFilter implements CodeTemplateFilter {
    
    private int startOffset;
    private int endOffset;
    
    private EJSCodeTemplateFilter(JTextComponent component, int offset) {
    ...
    public static final class Factory implements CodeTemplateFilter.Factory {
        ...
        public CodeTemplateFilter createFilter(JTextComponent component, int offset) {
            return new EJSCodeTemplateFilter(component, offset);
        }
    }
}
