 ...
 */
public class EJSEditorSettings extends Settings.AbstractInitializer {
    private static final String SETTINGS_NAME = "ejs-editor-settings-initializer"; // NOI18N

    public EJSEditorSettings() {
        super(SETTINGS_NAME);
    }
