...
public class LiferayPortletApp extends org.netbeans.modules.schema2beans.BaseBean
	 implements org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.LiferayPortletAppInterface
{
	...
	public int addPortlet(org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.Portlet value) {
	...
	//
	public int removePortlet(org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.Portlet value) {
	...
	// Add a new element returning its index in the list
	public int addRoleMapper(org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.RoleMapper value) {
	...
	// Returns the index the element had in the list
	//
	public int removeRoleMapper(org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.RoleMapper value) {
	...
	// Add a new element returning its index in the list
	public int addCustomUserAttribute(org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.CustomUserAttribute value) {
	...
	// Returns the index the element had in the list
	//
	public int removeCustomUserAttribute(org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.CustomUserAttribute value) {
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		for (int _index = 0; _index < sizePortlet(); ++_index) {
			org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.Portlet element = getPortlet(_index);
			if (element != null) {
				element.validate();
			}
		}
		...
		for (int _index = 0; _index < sizeRoleMapper(); ++_index) {
			org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.RoleMapper element = getRoleMapper(_index);
			if (element != null) {
				element.validate();
			}
		}
		...
		for (int _index = 0; _index < sizeCustomUserAttribute(); ++_index) {
			org.netbeans.modules.portalpack.servers.websynergy.dd.lp.impl440.CustomUserAttribute element = getCustomUserAttribute(_index);
			if (element != null) {
				element.validate();
			}
		}
