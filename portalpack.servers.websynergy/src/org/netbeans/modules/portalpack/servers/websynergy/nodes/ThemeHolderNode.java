 ...
 */
public class ThemeHolderNode extends AbstractNode {

    private static String ICON_BASE = "org/netbeans/modules/portalpack/servers/websynergy/resources/mfolder.gif";
        public ThemeHolderNode (PSDeploymentManager dm,String dn){
            super(new ThemeChildrenNode(dm,LiferayNodeConstants.THEME_NODE_TYPE,dn));
            setDisplayName("Themes");  // NOI18N
            setIconBaseWithExtension(ICON_BASE);
            setShortDescription(getShortDescription());
            getCookieSet().add(new RefreshThemeChildren ((ThemeChildrenNode)getChildren()));
        }
...
class RefreshThemeChildren implements RefreshCookie {
