/**
 *	This generated bean class DeploymentSettings matches the schema element 'deployment-settings'.
...
public class DeploymentSettings extends org.netbeans.modules.schema2beans.BaseBean
	 implements org.netbeans.modules.portalpack.servers.websynergy.dd.lpp.impl430.DeploymentSettingsInterface
{

	static Vector comparators = new Vector();
	private static final org.netbeans.modules.schema2beans.Version runtimeVersion = new org.netbeans.modules.schema2beans.Version(5, 0, 0);

	static public final String SETTING = "Setting";	// NOI18N

	public DeploymentSettings() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public DeploymentSettings(int options)
	{
		super(comparators, runtimeVersion);
		// Properties (see root bean comments for the bean graph)
		initPropertyTables(1);
		this.createProperty("setting", 	// NOI18N
			SETTING, 
			Common.TYPE_1_N | Common.TYPE_STRING | Common.TYPE_KEY, 
			String.class);
		this.createAttribute(SETTING, "name", "Name", 
						AttrProp.CDATA | AttrProp.IMPLIED,
						null, null);
		this.createAttribute(SETTING, "value", "Value", 
						AttrProp.CDATA | AttrProp.IMPLIED,
						null, null);
	...
	public void setSetting(int index, String value) {
		this.setValue(SETTING, index, value);
	}

	//
	public String getSetting(int index) {
		return (String)this.getValue(SETTING, index);
	}
	...
	public String[] getSetting() {
		return (String[])this.getValues(SETTING);
	}

	// Add a new element returning its index in the list
	public int addSetting(String value) {
		int positionOfNewItem = this.addValue(SETTING, value);
	...
	//
	public int removeSetting(String value) {
		return this.removeValue(SETTING, value);
	}
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		// Validating property setting
		if (sizeSetting() == 0) {
			throw new org.netbeans.modules.schema2beans.ValidateException("sizeSetting() == 0", org.netbeans.modules.schema2beans.ValidateException.FailureType.NULL_VALUE, "setting", this);	// NOI18N
		}
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("Setting["+this.sizeSetting()+"]");	// NOI18N
		for(int i=0; i<this.sizeSetting(); i++)
		{
			str.append(indent+"\t");
			str.append("#"+i+":");
			...
			str.append(">\n");	// NOI18N
			this.dumpAttributes(SETTING, i, str, indent);
		}

	}
	public String dumpBeanNode(){
		StringBuffer str = new StringBuffer();
		str.append("DeploymentSettings\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
