/**
 *	This generated bean class Screenshot matches the schema element 'screenshot'.
...
public class Screenshot extends org.netbeans.modules.schema2beans.BaseBean
	 implements org.netbeans.modules.portalpack.servers.websynergy.dd.lpp.impl430.ScreenshotInterface
{

	static Vector comparators = new Vector();
	private static final org.netbeans.modules.schema2beans.Version runtimeVersion = new org.netbeans.modules.schema2beans.Version(5, 0, 0);

	static public final String THUMBNAIL_URL = "ThumbnailUrl";	// NOI18N
	static public final String LARGE_IMAGE_URL = "LargeImageUrl";	// NOI18N

	public Screenshot() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public Screenshot(int options)
	{
		super(comparators, runtimeVersion);
		// Properties (see root bean comments for the bean graph)
		initPropertyTables(2);
		this.createProperty("thumbnail-url", 	// NOI18N
			THUMBNAIL_URL, 
			Common.TYPE_1 | Common.TYPE_STRING | Common.TYPE_KEY, 
			String.class);
		this.createProperty("large-image-url", 	// NOI18N
			LARGE_IMAGE_URL, 
			Common.TYPE_1 | Common.TYPE_STRING | Common.TYPE_KEY, 
			String.class);
	...
	public void setThumbnailUrl(String value) {
		this.setValue(THUMBNAIL_URL, value);
	}

	//
	public String getThumbnailUrl() {
		return (String)this.getValue(THUMBNAIL_URL);
	}

	// This attribute is mandatory
	public void setLargeImageUrl(String value) {
		this.setValue(LARGE_IMAGE_URL, value);
	}

	//
	public String getLargeImageUrl() {
		return (String)this.getValue(LARGE_IMAGE_URL);
	}
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		// Validating property thumbnailUrl
		if (getThumbnailUrl() == null) {
			throw new org.netbeans.modules.schema2beans.ValidateException("getThumbnailUrl() == null", org.netbeans.modules.schema2beans.ValidateException.FailureType.NULL_VALUE, "thumbnailUrl", this);	// NOI18N
		}
		// Validating property largeImageUrl
		if (getLargeImageUrl() == null) {
			throw new org.netbeans.modules.schema2beans.ValidateException("getLargeImageUrl() == null", org.netbeans.modules.schema2beans.ValidateException.FailureType.NULL_VALUE, "largeImageUrl", this);	// NOI18N
		}
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("ThumbnailUrl");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		o = this.getThumbnailUrl();
		str.append((o==null?"null":o.toString().trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(THUMBNAIL_URL, 0, str, indent);

		str.append(indent);
		str.append("LargeImageUrl");	// NOI18N
		str.append(indent+"\t");	// NOI18N
		str.append("<");	// NOI18N
		o = this.getLargeImageUrl();
		str.append((o==null?"null":o.toString().trim()));	// NOI18N
		str.append(">\n");	// NOI18N
		this.dumpAttributes(LARGE_IMAGE_URL, 0, str, indent);
