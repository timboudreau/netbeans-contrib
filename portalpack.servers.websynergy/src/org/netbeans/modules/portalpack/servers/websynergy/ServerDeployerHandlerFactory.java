...
import org.netbeans.modules.portalpack.servers.websynergy.impl.SunAppServerDeployHandler;
import org.netbeans.modules.portalpack.servers.websynergy.impl.TomcatDeployHandler;
...
public class ServerDeployerHandlerFactory {
    ...
    public static ServerDeployHandler getServerDeployerHandler(PSDeploymentManager dm)
    {
         ...
         {
             return new SunAppServerDeployHandler(dm);
         }
         else{
