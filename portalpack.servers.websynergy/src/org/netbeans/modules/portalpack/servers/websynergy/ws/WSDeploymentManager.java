...
import org.netbeans.modules.portalpack.servers.websynergy.LiferayDeploymentManager;

/**
 *
 * @author satyaranjan
 */
public class WSDeploymentManager extends LiferayDeploymentManager{
    
    public WSDeploymentManager(String uri, String psVersion) {
        super(uri, psVersion);
    }
