/**
 *	This generated bean class Licenses matches the schema element 'licenses'.
...
public class Licenses extends org.netbeans.modules.schema2beans.BaseBean
	 implements org.netbeans.modules.portalpack.servers.websynergy.dd.lpp.impl430.LicensesInterface
{
	...
	public Licenses(int options)
	{
		...
		this.createProperty("license", 	// NOI18N
			...
			String.class);
		this.createAttribute(LICENSE, "osi-approved", "OsiApproved", 
		...
		this.createAttribute(LICENSE, "url", "Url", 
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		// Validating property license
		if (sizeLicense() == 0) {
			throw new org.netbeans.modules.schema2beans.ValidateException("sizeLicense() == 0", org.netbeans.modules.schema2beans.ValidateException.FailureType.NULL_VALUE, "license", this);	// NOI18N
		}
	}
