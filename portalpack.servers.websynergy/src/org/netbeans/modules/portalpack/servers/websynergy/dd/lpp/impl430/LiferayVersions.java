/**
 *	This generated bean class LiferayVersions matches the schema element 'liferay-versions'.
...
public class LiferayVersions extends org.netbeans.modules.schema2beans.BaseBean
	 implements org.netbeans.modules.portalpack.servers.websynergy.dd.lpp.impl430.LiferayVersionsInterface
{

	static Vector comparators = new Vector();
	private static final org.netbeans.modules.schema2beans.Version runtimeVersion = new org.netbeans.modules.schema2beans.Version(5, 0, 0);

	static public final String LIFERAY_VERSION = "LiferayVersion";	// NOI18N

	public LiferayVersions() {
		this(Common.USE_DEFAULT_VALUES);
	}

	public LiferayVersions(int options)
	{
		super(comparators, runtimeVersion);
		// Properties (see root bean comments for the bean graph)
		initPropertyTables(1);
		this.createProperty("liferay-version", 	// NOI18N
			LIFERAY_VERSION, 
	...
	public void setLiferayVersion(int index, String value) {
		this.setValue(LIFERAY_VERSION, index, value);
	}

	//
	public String getLiferayVersion(int index) {
		return (String)this.getValue(LIFERAY_VERSION, index);
	}

	// Return the number of properties
	public int sizeLiferayVersion() {
		return this.size(LIFERAY_VERSION);
	}

	// This attribute is an array containing at least one element
	public void setLiferayVersion(String[] value) {
		this.setValue(LIFERAY_VERSION, value);
	}

	//
	public String[] getLiferayVersion() {
		return (String[])this.getValues(LIFERAY_VERSION);
	}

	// Add a new element returning its index in the list
	public int addLiferayVersion(String value) {
		int positionOfNewItem = this.addValue(LIFERAY_VERSION, value);
	...
	//
	public int removeLiferayVersion(String value) {
		return this.removeValue(LIFERAY_VERSION, value);
	}
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		// Validating property liferayVersion
		if (sizeLiferayVersion() == 0) {
			throw new org.netbeans.modules.schema2beans.ValidateException("sizeLiferayVersion() == 0", org.netbeans.modules.schema2beans.ValidateException.FailureType.NULL_VALUE, "liferayVersion", this);	// NOI18N
		}
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("LiferayVersion["+this.sizeLiferayVersion()+"]");	// NOI18N
		for(int i=0; i<this.sizeLiferayVersion(); i++)
		{
			str.append(indent+"\t");
			str.append("#"+i+":");
			str.append(indent+"\t");	// NOI18N
			str.append("<");	// NOI18N
			o = this.getLiferayVersion(i);
			str.append((o==null?"null":o.toString().trim()));	// NOI18N
			str.append(">\n");	// NOI18N
			this.dumpAttributes(LIFERAY_VERSION, i, str, indent);
		}

	}
	public String dumpBeanNode(){
		StringBuffer str = new StringBuffer();
		str.append("LiferayVersions\n");	// NOI18N
		this.dump(str, "\n  ");	// NOI18N
		return str.toString();
	}}
