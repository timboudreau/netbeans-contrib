/**
 *	This generated bean class Types matches the schema element 'types'.
...
public class Types extends org.netbeans.modules.schema2beans.BaseBean
	 implements org.netbeans.modules.portalpack.servers.websynergy.dd.lpp.impl430.TypesInterface
{
	...
	public void setType(int index, String value) {
		this.setValue(TYPE, index, value);
	}

	//
	public String getType(int index) {
		return (String)this.getValue(TYPE, index);
	}
	...
	public String[] getType() {
		return (String[])this.getValues(TYPE);
	}

	// Add a new element returning its index in the list
	public int addType(String value) {
		int positionOfNewItem = this.addValue(TYPE, value);
	...
	//
	public int removeType(String value) {
		return this.removeValue(TYPE, value);
	}
	...
	public void validate() throws org.netbeans.modules.schema2beans.ValidateException {
		...
		if (sizeType() == 0) {
			throw new org.netbeans.modules.schema2beans.ValidateException("sizeType() == 0", org.netbeans.modules.schema2beans.ValidateException.FailureType.NULL_VALUE, "type", this);	// NOI18N
		}
	}
	...
	public void dump(StringBuffer str, String indent){
		...
		str.append(indent);
		str.append("Type["+this.sizeType()+"]");	// NOI18N
		for(int i=0; i<this.sizeType(); i++)
		{
			str.append(indent+"\t");
			str.append("#"+i+":");
			...
			str.append(">\n");	// NOI18N
			this.dumpAttributes(TYPE, i, str, indent);
		}
