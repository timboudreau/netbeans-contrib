...
public class PortletSupportImpl {
     ...
     */
    public void setInitialPage(PortletModeType inMode, String inFilePath) throws PortletSupportException {
     ...
     */
    public void setInitialPage(PortletModeType inMode, FileObject inFileObject) throws PortletSupportException {
     ...
     * @throws org.netbeans.modules.visualweb.project.jsf.JsfPortletSupportException thrown if inFileObject == null
     */
    public void unsetInitialPage(FileObject inFileObject) throws PortletSupportException {
        if(null == inFileObject ) {
            throw new PortletSupportException(NbBundle.getMessage(PortletSupportImpl.class, "MSG_JsfPortletSupportImpl_DATAOBJECT_NULL"));
        }
        /**
     ...
     * @throws org.netbeans.modules.visualweb.project.jsf.JsfPortletSupportException thrown if inFileObject == null
     */
    public boolean isInitialPage(PortletModeType inMode, FileObject inFileObject) throws PortletSupportException {
        if(null == inFileObject ) {
            throw new PortletSupportException(NbBundle.getMessage(PortletSupportImpl.class, "MSG_JsfPortletSupportImpl_DATAOBJECT_NULL"));
        }
        if(null == inMode) {
     ...
     * @throws org.netbeans.modules.visualweb.project.jsf.JsfPortletSupportException thrown if inFileObject == null
     */
    public PortletModeType getPortletMode(FileObject inFileObject) throws PortletSupportException {
        if(null == inFileObject ) {
            throw new PortletSupportException(NbBundle.getMessage(PortletSupportImpl.class, "MSG_JsfPortletSupportImpl_DATAOBJECT_NULL"));
        }
     ...
     */
    public String getInitialPage(PortletModeType inMode) throws PortletSupportException {
    ...
    public File getPortletDD() throws PortletSupportException {
        FileObject portletDDFO = project.getProjectDirectory().getFileObject(PhpProjectConstants.PATH_WEB_INF + "/portlet.xml");  // NOI18N
        if(null == portletDDFO) {
    ...
    public String getPortletPageFolderPath(FileObject inFO) {
        ...
        FileObject webRoot = project.getProjectDirectory().getFileObject(PhpProjectConstants.PATH_DOC_ROOT);
        if(webRoot == null) {
            return null;
        }
