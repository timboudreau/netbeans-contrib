...
package org.netbeans.modules.portalpack.servers.websynergy.nodes.actions;

import org.netbeans.modules.portalpack.servers.core.nodes.actions.ActionUtil;

import org.netbeans.modules.portalpack.servers.websynergy.nodes.HookNode;
...
import org.netbeans.modules.portalpack.servers.websynergy.nodes.ThemeNode;
...
public final class UndeployAction extends CookieAction {
    ...
    protected void performAction(Node[] nodes) {
        ...
        {
            BaseNode cookie = null;
			String name = null;
            cookie = (HookNode)nodes[i].getCookie(HookNode.class);
            if (cookie == null)
            {
                cookie = (ThemeNode)nodes[i].getCookie(ThemeNode.class);
