...
import org.netbeans.modules.portalpack.servers.websynergy.portlets.php.PhpPortletConstants;
...
public class PortletDDHelper {
  ...
  public static boolean isPhpPortletEntryPresent(PortletApp portletApp) {
        if (portletApp == null) {
            return false;
        }
        PortletType[] portletTypes = portletApp.getPortlet();
        for (PortletType portletType : portletTypes) {
            if (portletType.getPortletClass().equals(PhpPortletConstants.PHP_PORTLET_CLASS)) {
