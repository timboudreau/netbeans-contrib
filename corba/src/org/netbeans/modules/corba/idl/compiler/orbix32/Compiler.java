...
class Compiler {
    ...
    public static final String _S_cmd = "idlj";
	...
	//    System.out.println (__i + " : " + __cmd[__i]);  
	//}	
	...
	String __file_line, __err_line, __file_name = "";
	for (;;) {
		...
		if (__err_line != null && !__err_line.equals ("")) {
		    //System.out.println (__err_line);
		    System.out.println (__file_name + ":" + __err_line);
		}
		else
		    break;
		/*
