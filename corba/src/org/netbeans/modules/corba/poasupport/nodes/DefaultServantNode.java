...
public class DefaultServantNode extends POAMemberElementNode {
    ...
    "/org/netbeans/modules/corba/poasupport/resources/DefaultServantNodeIcon"; // NOI18N
    
    public DefaultServantNode(DefaultServantElement _element) {
        super (_element);
    ...
    public DefaultServantElement getDefaultServantElement () {
        return (DefaultServantElement)element;
    }
    
    public void setName (String nue) {
        if (isWriteable()) {
            if (POAChecker.checkPOAMemberVarName(nue, getDefaultServantElement(), (getDefaultServantElement().getTypeName() != null) && (getDefaultServantElement().getConstructor() != null), true))
            getDefaultServantElement().setVarName(nue);
        }
    }
