...
public class NewDefaultServantCustomizerDialog extends JDialogOperator {

    /** Creates new NewDefaultServantCustomizerDialog that can handle it.
     */
    public NewDefaultServantCustomizerDialog() {
        super("Customizer Dialog");
    }

    private JLabelOperator _lblVariable;
    private JTextFieldOperator _txtVariable;
    private JCheckBoxOperator _cbGenerateDefaultServantInstantiationCode;
    ...
    /** Tries to find "Generate default servant instantiation code" JCheckBox in this dialog.
     * @return JCheckBoxOperator
     */
    public JCheckBoxOperator cbGenerateDefaultServantInstantiationCode() {
        if (_cbGenerateDefaultServantInstantiationCode==null) {
            _cbGenerateDefaultServantInstantiationCode = new JCheckBoxOperator(this, "Generate default servant instantiation code");
        }
        return _cbGenerateDefaultServantInstantiationCode;
    }
     ...
     */
    public void checkGenerateDefaultServantInstantiationCode(boolean state) {
        if (cbGenerateDefaultServantInstantiationCode().isSelected()!=state) {
            cbGenerateDefaultServantInstantiationCode().push();
        }
    }
    ...
    /** Performs verification of NewDefaultServantCustomizerDialog by accessing all its components.
     */
    public void verify() {
        lblVariable();
        txtVariable();
        cbGenerateDefaultServantInstantiationCode();
        lblType();
        cboType();
        lblConstructor();
        cboConstructor();
    ...
    /** Performs simple test of NewDefaultServantCustomizerDialog
    * @param args the command line arguments
    */
    public static void main(String args[]) {
        new NewDefaultServantCustomizerDialog().verify();
        System.out.println("NewDefaultServantCustomizerDialog verification finished.");
    }
}
