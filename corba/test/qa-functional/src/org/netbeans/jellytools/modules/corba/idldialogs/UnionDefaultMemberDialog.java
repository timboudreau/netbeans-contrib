...
/** Class implementing all necessary methods for handling "Create Union Default Member" NbDialog.
 *
 * @author dave
 * @version 1.0
 */
public class UnionDefaultMemberDialog extends JDialogOperator {

    /** Creates new UnionDefaultMemberDialog that can handle it.
     */
    public UnionDefaultMemberDialog(boolean customize) {
        super(customize ? "Customize" : "Create Union Default Member");
    }
    ...
    /** Performs verification of UnionDefaultMemberDialog by accessing all its components.
     */
    public void verify() {
        lblName();
        lblType();
    ...
    /** Performs simple test of UnionDefaultMemberDialog
    * @param args the command line arguments
    */
    public static void main(String args[]) {
        new UnionDefaultMemberDialog(false).verify();
        System.out.println("UnionDefaultMemberDialog verification finished.");
    }
}
