...
public class NewDefaultServantDialog extends JDialogOperator {

    /** Creates new NewDefaultServantDialog that can handle it.
     */
    public NewDefaultServantDialog() {
        super("New Default Servant");
    }
    ...
    /** Performs verification of NewDefaultServantDialog by accessing all its components.
     */
    public void verify() {
        lblVariable();
        txtVariable();
    ...
    /** Performs simple test of NewDefaultServantDialog
    * @param args the command line arguments
    */
    public static void main(String args[]) {
        new NewDefaultServantDialog().verify();
        System.out.println("NewDefaultServantDialog verification finished.");
    }
}
