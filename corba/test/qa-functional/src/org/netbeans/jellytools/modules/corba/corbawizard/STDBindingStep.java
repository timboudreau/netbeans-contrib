 ...
 * @version 1.0
 */
public class STDBindingStep extends WizardOperator {

    /** Creates new STDBindingStep that can handle it.
     */
    public STDBindingStep() {
        super("CORBA Wizard");
    ...
    /** Performs verification of STDBindingStep by accessing all its components.
     */
    public void verify() {
        txtJTextArea();
    }

    /** Performs simple test of STDBindingStep
    * @param args the command line arguments
    */
    public static void main(String args[]) {
        new STDBindingStep().verify();
        System.out.println("STDBindingStep verification finished.");
    }
}
