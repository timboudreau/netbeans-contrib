...
public class NewPOAActivatorDialog extends JDialogOperator {

    /** Creates new NewPOAActivatorDialog that can handle it.
     */
    public NewPOAActivatorDialog() {
        super("New POA Activator");
    }
    ...
    /** Performs verification of NewPOAActivatorDialog by accessing all its components.
     */
    public void verify() {
        lblVariable();
        txtVariable();
    ...
    /** Performs simple test of NewPOAActivatorDialog
    * @param args the command line arguments
    */
    public static void main(String args[]) {
        new NewPOAActivatorDialog().verify();
        System.out.println("NewPOAActivatorDialog verification finished.");
    }
}
