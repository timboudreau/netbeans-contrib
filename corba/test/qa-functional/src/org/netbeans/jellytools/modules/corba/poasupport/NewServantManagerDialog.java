...
public class NewServantManagerDialog extends JDialogOperator {

    /** Creates new NewServantManagerDialog that can handle it.
     */
    public NewServantManagerDialog() {
        super("New Servant Manager");
    }
    ...
    /** Performs verification of NewServantManagerDialog by accessing all its components.
     */
    public void verify() {
        lblVariable();
        txtVariable();
    ...
    /** Performs simple test of NewServantManagerDialog
    * @param args the command line arguments
    */
    public static void main(String args[]) {
        new NewServantManagerDialog().verify();
        System.out.println("NewServantManagerDialog verification finished.");
    }
}
