...
/*
 * ServerMain_1.java  --  server side implementation
 *
 * Created on November 9, 2001, 10:53 AM for Orbix 2000 1.x for Java
...
public class ServerMain_1 {
    ...
    */
	...
	try {
            ...
            POA poa = POAHelper.narrow(orb.resolve_initial_references("RootPOA"));//GEN-BEGIN:poa_section_orbix20004j
            
            Policy[] _policies;
            
            _policies = new Policy[] {
            };
            POA myPOA1 = poa.create_POA("MyPOA1", null, _policies);//GEN-END:poa_section_orbix20004j
