...
public class VcsCustomizer extends javax.swing.JPanel implements Customizer {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        advancedButton.setText(java.util.ResourceBundle.getBundle("org/netbeans/modules/vcs/advanced/Bundle").getString("VcsCustomizer.advancedButton.text"));
        ...
        relMountLabel.setText(java.util.ResourceBundle.getBundle("org/netbeans/modules/vcs/advanced/Bundle").getString("VcsCustomizer.relMountLabel.text"));
          ...
          gridBagConstraints2.insets = new java.awt.Insets(4, 4, 4, 4);
          gridBagConstraints2.anchor = java.awt.GridBagConstraints.WEST;
          propsPanel.add(relMountLabel, gridBagConstraints2);
        ...
        relMountTextField.addActionListener(new java.awt.event.ActionListener() {
          ...
          gridBagConstraints2.insets = new java.awt.Insets(4, 4, 4, 4);
          gridBagConstraints2.weightx = 1.0;
          propsPanel.add(relMountTextField, gridBagConstraints2);
        ...
        relMountButton.setText(java.util.ResourceBundle.getBundle("org/netbeans/modules/vcs/advanced/Bundle").getString("VcsCustomizer.relMountButton.text"));
          ...
          gridBagConstraints2.gridy = 3;
          gridBagConstraints2.weightx = 1.0;
          propsPanel.add(relMountButton, gridBagConstraints2);
...
//        String dir = work;
        ...
        int index = selected.indexOf(work);
        if (index < 0) return;
        index += work.length();
        if (selected.length() > index + 1) {
            if (selected.charAt(index) == File.separatorChar) index++;
            else return;
        }
