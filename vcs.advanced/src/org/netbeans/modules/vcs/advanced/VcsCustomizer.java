...
public class VcsCustomizer extends javax.swing.JPanel implements Customizer {
    ...
    private void initAccessibility()
    {
        ...
        jLabel4.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getBundle(VcsCustomizer.class).getString("ACS_VcsCustomizer.jLabel4.textA11yDesc"));  // NOI18N
        refreshTextField.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getBundle(VcsCustomizer.class).getString("ACS_VcsCustomizer.refreshTextField.textA11yName"));  // NOI18N
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 5, 12);
        propsPanel.add(jLabel4, gridBagConstraints);

        refreshTextField.setToolTipText(org.openide.util.NbBundle.getBundle(VcsCustomizer.class).getString("ACS_VcsCustomizer.refreshTextField.textA11yDesc"));
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 5, 5);
        propsPanel.add(refreshTextField, gridBagConstraints);
