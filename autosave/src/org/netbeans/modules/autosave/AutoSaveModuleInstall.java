...
/**
 * Listen on the editor registry and automatically save files that loose focus
 *
 * @author Tor Norbye
 */
@SuppressWarnings("serial")
public class AutoSaveModuleInstall extends ModuleInstall implements PropertyChangeListener {
