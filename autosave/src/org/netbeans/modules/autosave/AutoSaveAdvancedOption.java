...
public final class AutoSaveAdvancedOption extends AdvancedOption {
    ...
    public String getDisplayName() {
        return NbBundle.getMessage(AutoSaveAdvancedOption.class, "AdvancedOption_DisplayName");
    }
    
    public String getTooltip() {
        return NbBundle.getMessage(AutoSaveAdvancedOption.class, "AdvancedOption_Tooltip");
    }
    
    public OptionsPanelController create() {
        return new AutoSaveOptionsPanelController();
    }
