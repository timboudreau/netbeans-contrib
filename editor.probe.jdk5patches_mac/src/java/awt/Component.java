...
// disable/enable flushin to avoid screen flickering
...
if (sd != null)
{
    ...
    {
        boolean success = requestFocusHelper_BCK(temporary, focusedWindowChangeAllowed);
        if (!success) {
    ...
    final boolean requestFocusHelper_BCK(boolean temporary,
                                     boolean focusedWindowChangeAllowed) {
