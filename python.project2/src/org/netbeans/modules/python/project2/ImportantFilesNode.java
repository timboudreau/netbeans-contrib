 ...
 * @author jenselme
 */
class ImportantFilesNode extends FilterNode {
    @StaticResource
    private static final String IMAGE = "org/netbeans/modules/"
            + "python/project2/resources/brokenProjectBadge.gif";

    public ImportantFilesNode(Project proj) throws DataObjectNotFoundException {
        super(DataObject.find(proj.getProjectDirectory()).getNodeDelegate(), new ImportantFilesChildren());
        proj.getProjectDirectory().getChildren(false);
    }
