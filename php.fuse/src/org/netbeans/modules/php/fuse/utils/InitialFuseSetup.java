...
public class InitialFuseSetup {
    ...
    // boolean setup
    private boolean copyFuseFrameworkIntoProject;
    ...
    public boolean isCopyFuseFrameworkIntoProject() {
        return copyFuseFrameworkIntoProject;
    }

    public void setCopyFuseFrameworkIntoProject(boolean copyFuseFrameworkIntoProject) {
        this.copyFuseFrameworkIntoProject = copyFuseFrameworkIntoProject;
    }
    ...
    public void setupDatabase(boolean setupDatabase) {
