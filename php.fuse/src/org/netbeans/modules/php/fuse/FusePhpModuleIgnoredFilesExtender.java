...
public class FusePhpModuleIgnoredFilesExtender extends PhpModuleIgnoredFilesExtender {
    ...
    public FusePhpModuleIgnoredFilesExtender(PhpModule phpModule) {
        ...
        htaccess = new File(FileUtil.toFile(phpModule.getSourceDirectory()), ".htaccess"); // NOI18N
    }

    @Override
    public Set<File> getIgnoredFiles() {
        Set<File> ignoredFilesSet = new HashSet<File>();
        ignoredFilesSet.add(cache);
        ignoredFilesSet.add(htaccess);
