 ...
 * @author David Strupl
 */
final class ClosingTabsOptionsPanelController extends OptionsPanelController {

    private ClosingTabsPanel panel;
    ...
    private ClosingTabsPanel getPanel() {
        if (panel == null) {
            panel = new ClosingTabsPanel(this);
        }
        return panel;
    }
