 ...
 * @author Jesse Glick
 */
public final class XMLNavigatorPanel implements NavigatorPanel {
    ...
    public String getDisplayName() {
        return "XML Outline"; // XXX I18N
    }
    
    public String getDisplayHint() {
        return "Displays an outline of interesting XML elements."; // XXX I18N
    }
    ...
    static Item[] parse(InputSource src, final DataObject d) throws IOException, SAXException, ParserConfigurationException {
        ...
        class Handler extends DefaultHandler {
            ...
            // XXX do not match <xsl:call-template name="..."/>!
