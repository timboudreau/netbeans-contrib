...
public class GraphicsDemosPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private GraphicsDemosWizardPanel panel;

    public GraphicsDemosPanelVisual(GraphicsDemosWizardPanel panel) {
        initComponents();
        this.panel = panel;
