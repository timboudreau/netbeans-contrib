...
package org.netbeans.modules.edm.project.ui;
...
import org.netbeans.modules.edm.project.EdmproProject;

/**
 * Support for creating logical views.
 * @author Petr Hrebejk
 */
public class EdmproLogicalViewProvider implements LogicalViewProvider {
    ...
    public EdmproLogicalViewProvider(Project project, AntProjectHelper helper, PropertyEvaluator evaluator, SubprojectProvider spp, ReferenceHelper resolver) {
    ...
    public Node createLogicalView() {
        return new EdmLogicalViewRootNode();
    }
     ...
     */
    private final class EdmLogicalViewRootNode extends AbstractNode {
        
        private Action brokenLinksAction;
        private boolean broken;
        
        
        public EdmLogicalViewRootNode() {
            super( new EdmproViews.LogicalViewChildren( helper, evaluator, project ), createLookup( project )  );
            setIconBaseWithExtension( "org/netbeans/modules/edm/project/ui/resources/edmproProjectIcon.gif" ); // NOI18N
        ...
        protected Sheet createSheet() {
            ...
            Property nameProp = new PropertySupport.Name(this, "Name", "EDM Project Name");                            
            set.put(nameProp);                
            sheet.put(set);
            return sheet;
        }
        ...
        private Action[] getAdditionalActions() {
            ...
            return new Action[] {
                ...
                null,ProjectSensitiveActions.projectCommandAction( EdmproProject.COMMAND_GENWSDL, "Generate WSDL", null  ), // NOI18N
                null,
