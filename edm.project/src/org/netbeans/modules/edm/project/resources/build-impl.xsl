  ...
  - cleanup
	   ...
	   <target name="do-init">
            ...
            <target name="init-taskdefs">
                    <taskdef name="generate-wsdl" classname="org.netbeans.modules.edm.project.anttasks.GenerateWSDL">
                        <classpath>
			...
			<target name="pre-dist">
				...
				<!--
					<xslt in="${{basedir}}/${{build.dir}}/edmmap.xml" out="${{build.dir}}/portmap.xml"
			...
			<target name="dist_se">
				...
				<jar compress="${{jar.compress}}"
					...
					<fileset
						includes="**/*_engine.xml,**/*.wsdl" dir="${{src.dir}}" />
					<fileset dir="${{src.dir}}/">
						<include name="edmmap.xml" />
					</fileset>
			...
			<target name="run-deploy">
				<!-- No more deploy action in subprojects
					...
					jarFileClasspath="${{module.install.dir}}/org-netbeans-modules-edm-project.jar"
