 ...
 */
package org.netbeans.modules.web.flyingsaucer;
...
public class CssPreviewPanel extends javax.swing.JPanel implements CssPreviewComponent {
    ...
    private static final String EMPTY_DOCUMENT_CONTENT = "<html><head><title>empty document</title></head><body></body></html>"; //NOI18N
    ...
    private final Collection<CssPreviewComponentListener> listeners = new LinkedList<CssPreviewComponentListener>();
        ...
        RequestProcessor.getDefault().execute(new FutureTask<XHTMLPanel>(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    InputSource inputSource = new InputSource(new StringReader(EMPTY_DOCUMENT_CONTENT));
    ...
    private void fireErrorEvent(String msg) {
        synchronized (listeners) {
            for(CssPreviewComponentListener l : listeners) {
                l.error(msg);
            }
        }
    }
    ...
    private class PatchedXHTMLPanel extends XHTMLPanel {
