 ...
 * @author tl
 */
public final class ConditionPanel extends JPanel implements ActionListener, PropertyChangeListener {
     ...
     */
    public ConditionPanel(Filter filter, AppliedFilterCondition cond) {
        this.filter = filter;
    ...
    public void actionPerformed(ActionEvent evt) {
        if (evt.getSource() == propertyCombo) {
	      ...
	      filter.createConditions((SuggestionProperty)propertyCombo.getSelectedItem()); 
    ...
    private static class ConditionCellRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list,
            ...
            if (c != null) setText(c.getCondition().getName());
            return this;
        }        
    }
    ...
    private static class PropertyCellRenderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list,
            ...
            super.getListCellRendererComponent(
                list, value, index, isSelected, cellHasFocus);
            SuggestionProperty prop = (SuggestionProperty)value;
