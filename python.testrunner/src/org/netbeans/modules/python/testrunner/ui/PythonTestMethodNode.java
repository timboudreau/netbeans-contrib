...
public final class PythonTestMethodNode extends TestMethodNode {
    ...
    public Action getPreferredAction() {
        ...
        return jumpToLocation == null
                ? new JumpToTestAction(testcase, getProject(), NbBundle.getMessage(PythonTestMethodNode.class, "LBL_GoToSource"), false)
...
//        }
    ...
    public Action[] getActions(boolean context) {
        ...
        actions.add(new RunTestMethodAction(testcase, getProject(), NbBundle.getMessage(PythonTestMethodNode.class, "LBL_RerunTest"), false));
        actions.add(new RunTestMethodAction(testcase, getProject(), NbBundle.getMessage(PythonTestMethodNode.class, "LBL_DebugTest"), true));
