...
public class FortressMimeResolver extends MIMEResolver {
    ...
    /**
     * Extensions recognized as being Fortress.
     */
    ...
    /**
     * MIME type for Fortress.
     */
    public static final String MIME_TYPE = "text/x-fortress"; // NOI18N
    
    public FortressMimeResolver() {
    }
    
    public static boolean isFortressExt(String ext) {
    ...
    public String findMIMEType(FileObject fo) {
        return isFortressExt(fo.getExt()) ? MIME_TYPE : null;
    }
}
