 ...
 */
public class ParameterDeclarationWithComma extends AbstractDeclarationAction {
    ...
    public String getName() {
        return NbBundle.getMessage(ParameterDeclarationWithComma.class, "CTL_ParameterDeclarationWithComma");
    }
}
