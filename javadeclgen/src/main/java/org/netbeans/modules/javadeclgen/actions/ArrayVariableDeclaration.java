 ...
 */
public class ArrayVariableDeclaration extends AbstractDeclarationAction {
    ...
    public String getName() {
        return NbBundle.getMessage(VariableDeclaration.class, "CTL_ArrayVariableDeclaration");
    }
}
