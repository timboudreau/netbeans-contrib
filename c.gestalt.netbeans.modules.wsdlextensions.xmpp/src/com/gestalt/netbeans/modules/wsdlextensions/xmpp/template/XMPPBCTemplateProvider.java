...
public class XMPPBCTemplateProvider extends ExtensibilityElementTemplateProvider {
    ...
    static final String templateUrl = "/com/gestalt/netbeans/modules/wsdlextensions/xmpp/template/template.xml";

    public InputStream getTemplateInputStream() {
        return XMPPBCTemplateProvider.class.getResourceAsStream(templateUrl);
    }

    public String getLocalizedMessage(String str, Object[] objects) {
        return NbBundle.getMessage(XMPPBCTemplateProvider.class, str, objects);
    }
