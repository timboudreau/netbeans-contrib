    ...
    private boolean installRequiredForPC() {
        ...
        try {
            ...
            if(psconfig.getProperty(JNPCConstants.SETUP_DONE) != null &&
                ...
                OutputWriter inOut = UISupport.getServerIO(dm.getUri()).getOut();
                ...
                if(responseCode == 404) //Not Found
                {
                    ...
                    NotifyDescriptor d = new NotifyDescriptor.Message(NbBundle.getMessage(SunASStartStopListener.class, "PORTLET_CONTAINER_IS_NOT_INSTALLED"), NotifyDescriptor.ERROR_MESSAGE);
