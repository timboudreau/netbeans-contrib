...
public class PCConfigPanel extends ConfigPanel implements DocumentListener{
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(PCConfigPanel.class, "LBL_OPEN_SOURCE_PORTLET_CONTAINER"));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel4.setText(org.openide.util.NbBundle.getMessage(PCConfigPanel.class, "LBL_PORTAL_URI"));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel3.setText(org.openide.util.NbBundle.getMessage(PCConfigPanel.class, "LBL_PC_HOME"));
