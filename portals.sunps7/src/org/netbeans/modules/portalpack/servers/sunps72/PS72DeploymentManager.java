...
import org.netbeans.modules.portalpack.servers.sunps7.PS71DeploymentManager;
 ...
 * @author Satyaranjan
 */
public class PS72DeploymentManager extends PS71DeploymentManager {

    private PSTaskHandler taskHandler;
    public PS72DeploymentManager(String uri,String psVersion){
        super(uri,psVersion);
    }
    ...
    public PSJ2eePlatformImpl createPSJ2eePlatformImpl(PSConfigObject psconfig) {
          return new PS72J2eePlatformImpl(psconfig);
    }
