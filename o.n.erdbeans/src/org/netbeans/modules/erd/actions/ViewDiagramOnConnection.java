...
public final class ViewDiagramOnConnection implements ActionListener {

    private final DatabaseConnection connection;

    public ViewDiagramOnConnection(DatabaseConnection context) {
    ...
    private void openDiagram(ERDContext context) throws DataObjectExistsException, IOException {
        ...
        erdDO.getNodeDelegate().setDisplayName(
                NbBundle.getMessage(ViewDiagramOnConnection.class, "ViewERD_DisplayNameInEditor", // NOI18N
