...
public class CreateDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("New Script");
        jLabel1.setText("Creating new script in the category:");

        jTextField1.setEditable(false);
        jTextField1.setBorder(null);

        jLabel2.setText("Enter new script name:");
...
// TODO add your handling code here:
    ...
    public String showDialog(String category) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateDialog(new javax.swing.JFrame(), true).setVisible(true);
            }
        });
    }
