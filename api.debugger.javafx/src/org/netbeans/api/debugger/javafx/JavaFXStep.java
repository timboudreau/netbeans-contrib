...
/**
 * Represents one JavaFX step.
 *
 * @author Roman Ondruska
 */
public abstract class JavaFXStep {
    private int size;
    private int depth;
    private boolean hidden;
    /** Associated JavaFX debugger */
    protected JavaFXDebugger debugger;
     ...
     * 
     *  @param debugger an associated JavaFXDebuger
     *  @param size step size
     *  @param depth step depth
     */
    public JavaFXStep(JavaFXDebugger debugger, int size, int depth) {
        this.size = size;
        this.depth = depth;
     ...
     *  {@link org.netbeans.api.debugger.JavaFX.JavaFXDebugger}.
     *  Method is not synchronized.
     *
     *  @param tr associated thread
     */
    public abstract void addStep(JavaFXThread tr);
