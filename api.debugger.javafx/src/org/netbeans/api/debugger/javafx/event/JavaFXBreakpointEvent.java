...
package org.netbeans.api.debugger.javafx.event;
...
/**
 * JavaFXBreakpoint event notification.
 *
 * @author   Jan Jancura
 */
public final class JavaFXBreakpointEvent extends EventObject {
    ...
    /**
     * Creates a new instance of JavaFXBreakpointEvent. This method should be
     * called from debuggerJavaFX module only. Do not create a new instances
     * of this class!
     *
     ...
     */
    public JavaFXBreakpointEvent (
        JavaFXBreakpoint  sourceBreakpoint, 
    ...
    /**
     * Creates a new instance of JavaFXBreakpointEvent.
     *
     * @param sourceBreakpoint a breakpoint
    ...
    /**
     * Returns JavaFXDebugger instance this breakpoint has been reached in.
     *
     * @return JavaFXDebugger instance this breakpoint has been reached in
     */
    public JavaFXDebugger getDebugger () {
        return debugger;
    }
     ...
     * You should not call JavaFXDebugger.resume () during breakpoint event 
     * evaluation!
     */
    public void resume () {
        resume = true;
