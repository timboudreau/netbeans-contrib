...
/**
 * Abstract definition of JavaFX breakpoint.
 *
 * @author   Jan Jancura
 */
public class JavaFXBreakpoint extends Breakpoint {
    ...
    private Collection<JavaFXBreakpointListener>  breakpointListeners = new HashSet<JavaFXBreakpointListener>();
    ...
    /** 
     * Adds a JavaFXBreakpointListener.
     *
     * @param listener the listener to add
     */
    public synchronized void addJavaFXBreakpointListener (
        JavaFXBreakpointListener listener
    ) {
        breakpointListeners.add (listener);
    }

    /** 
     * Removes a JavaFXBreakpointListener.
     *
     * @param listener the listener to remove
     */
    public synchronized void removeJavaFXBreakpointListener (
        JavaFXBreakpointListener listener
    ){
    ...
    /**
     * Fire JavaFXBreakpointEvent.
     *
     * @param event a event to be fired
     */
    public void fireJavaFXBreakpointChange (JavaFXBreakpointEvent event) {
        Iterator<JavaFXBreakpointListener> i =
                new HashSet<JavaFXBreakpointListener>(breakpointListeners).iterator();
        while (i.hasNext ())
