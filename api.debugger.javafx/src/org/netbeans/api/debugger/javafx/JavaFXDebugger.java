...
/**
 * Represents one JavaFX debugger session (one 
 * {@link com.sun.jdi.VirtualMachine}). 
 *
 * <br><br>
 * <b>How to obtain it from DebuggerEngine:</b>
 * <pre style="background-color: rgb(255, 255, 153);">
 *    JavaFXDebugger JavaFXDebugger = (JavaFXDebugger) debuggerEngine.lookup 
 *        (JavaFXDebugger.class);</pre>
 *
 * @author Jan Jancura
 */
public abstract class JavaFXDebugger {
    ...
    /**
     * This utility method helps to start a new JavaFX debugger session. 
    ...
    public static void launch (
        ...
        if (es.length == 0) {
            ...
            throw new DebuggerStartException(
                    NbBundle.getMessage(JavaFXDebugger.class, "MSG_NO_DEBUGGER")); */
     ...
     */
    public static JavaFXDebugger listen (
     ...
     */
    public static JavaFXDebugger attach (
        String          hostName,
        int             portNumber,
        Object[]        services
    ) throws DebuggerStartException {
     ...
     */
    public abstract JavaFXThread getCurrentThread ();
    ...
    protected void fireBreakpointEvent (
        ...
        breakpoint.fireJavaFXBreakpointChange (event);
    }
    ...
    /**
     * Creates a new {@link JavaFXStep}. 
     * Parameters correspond to {@link JavaFXStep} constructor.
     * 
     * @return {@link JavaFXStep} 
     ...
     * @see JavaFXClassType#getInstanceCount
     * @see JavaFXClassType#getInstances
