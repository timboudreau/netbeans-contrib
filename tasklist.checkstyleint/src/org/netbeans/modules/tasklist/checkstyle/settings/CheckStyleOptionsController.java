...
public class CheckStyleOptionsController extends OptionsPanelController {
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx ("netbeans.optionsDialog.advanced.checkstyle");
    }
    ...
    private CheckStyleCustomizer customizer;
    
    private CheckStyleCustomizer getCustomizer() {
        if( null == customizer ) {
            customizer = new CheckStyleCustomizer();
        }
        return customizer;
    }
}
