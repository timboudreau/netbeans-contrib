...
public enum AntlrTokenId implements TokenId {
    ...
    TOKEN_REF(ANTLRv3Lexer.TOKEN_REF, OTHERS),
    STRING_LITERAL(ANTLRv3Lexer.STRING_LITERAL, OTHERS),
    CHAR_LITERAL(ANTLRv3Lexer.CHAR_LITERAL, OTHERS),
    ...
    RULE_REF(ANTLRv3Lexer.RULE_REF, OTHERS),
    DOUBLE_QUOTE_STRING_LITERAL(ANTLRv3Lexer.DOUBLE_QUOTE_STRING_LITERAL, OTHERS),
    DOUBLE_ANGLE_STRING_LITERAL(ANTLRv3Lexer.DOUBLE_ANGLE_STRING_LITERAL, OTHERS),
    SRC(ANTLRv3Lexer.SRC, OTHERS),
    SL_COMMENT(ANTLRv3Lexer.SL_COMMENT, OTHERS),
    ML_COMMENT(ANTLRv3Lexer.ML_COMMENT, OTHERS),
    LITERAL_CHAR(ANTLRv3Lexer.LITERAL_CHAR, OTHERS),
    ESC(ANTLRv3Lexer.ESC, OTHERS),
    XDIGIT(ANTLRv3Lexer.XDIGIT, OTHERS),
    NESTED_ARG_ACTION(ANTLRv3Lexer.NESTED_ARG_ACTION, OTHERS),
    ACTION_STRING_LITERAL(ANTLRv3Lexer.ACTION_STRING_LITERAL, OTHERS),
    ACTION_CHAR_LITERAL(ANTLRv3Lexer.ACTION_CHAR_LITERAL, OTHERS),
