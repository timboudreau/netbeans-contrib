 ...
 * @author marekfukala
 */
public class ExtANTLRv3Lexer extends ANTLRv3Lexer {

//    private List<ProblemDescription> problems = new ArrayList<ProblemDescription>();

    public ExtANTLRv3Lexer(CharStream input, RecognizerSharedState state) {
        super(input, state);
    }

    public ExtANTLRv3Lexer(CharStream input) {
        super(input);
    }
     ...
     */
    public ExtANTLRv3Lexer(CharSequence charSequence) {
