 ...
 * @author satyaranjan
 */
public class ServiceBuilderEditorSupport extends DataEditorSupport
    ...
    private final SaveCookie saveCookie = new SaveCookie() {
        ...
        public void save() throws java.io.IOException {
            ServiceBuilderDataObject obj = (ServiceBuilderDataObject) getDataObject();
            ...
            if (obj.isDocumentValid()) {
                ...
                DialogDescriptor dialog = new DialogDescriptor(
                        NbBundle.getMessage(ServiceBuilderEditorSupport.class, "MSG_invalidXmlWarning"),
                        NbBundle.getMessage(ServiceBuilderEditorSupport.class, "TTL_invalidXmlWarning"));
    ...
    protected Pane createPane() {
        ServiceBuilderEditorContext context = new ServiceBuilderEditorContextImpl((ServiceBuilderDataObject)getDataObject());
        ArrayList<MultiViewDescription> descriptions =
                new ArrayList<MultiViewDescription> (ServiceBuilderEditorViewFactorySupport.createViewDescriptions(context));
        if (descriptions.size() > 0) {
            descriptions.add( new ServiceBuilderXMLMultiviewDescriptor(context));
            return (CloneableEditorSupport.Pane) MultiViewFactory.createCloneableMultiView(
                            ...
                            descriptions.get(0),
                            new CloseHandler((ServiceBuilderDataObject)getDataObject()));
        } else {
    ...
    public void saveDocument() throws java.io.IOException {
        ...
        if (!isSupportedEncoding(enc)){
            NotifyDescriptor nd = new NotifyDescriptor.Confirmation(
                    NbBundle.getMessage(ServiceBuilderEditorSupport.class, "MSG_BadEncodingDuringSave", //NOI18N
        ...
        if (!changeEncodingToDefault){
            ...
            try {
                ...
                if (!coder.canEncode(doc.getText(0, doc.getLength()))){
                    NotifyDescriptor nd = new NotifyDescriptor.Confirmation(
                            NbBundle.getMessage(ServiceBuilderEditorSupport.class, "MSG_BadCharConversion", //NOI18N
                            new Object [] { getDataObject().getPrimaryFile().getNameExt(),
                            enc}),
                            NotifyDescriptor.YES_NO_OPTION,
                            NotifyDescriptor.WARNING_MESSAGE);
    ...
    private static class CloseHandler implements CloseOperationHandler, Serializable {
        ...
        public CloseHandler(ServiceBuilderDataObject facesConfig) {
     ...
     private static class XmlEnv extends DataEditorSupport.Env {
         ...
         */
        public XmlEnv(ServiceBuilderDataObject obj) {
            super(obj); 
        }
        ...
        protected FileLock takeLock() throws java.io.IOException {
            return ((ServiceBuilderDataObject) getDataObject()).getPrimaryEntry().takeLock();
        }
        ...
        public org.openide.windows.CloneableOpenSupport findCloneableOpenSupport() {
            return (ServiceBuilderEditorSupport) getDataObject().getCookie(ServiceBuilderEditorSupport.class);
        }
    }
}
