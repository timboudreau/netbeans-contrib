 ...
 * @author satyaranjan
 */
public class FinderOutputWidget extends AbstractTitledWidget implements TabWidget{
     ...
     * @param method
     */
    public FinderOutputWidget(ObjectScene scene, Finder finder) {
    ...
    private void createContent() {
        ...
        LabelWidget returnWidget = new LabelWidget(getScene(), finder.getReturnType() == null?
            NbBundle.getMessage(OperationWidget.class, "LBL_ReturnTypeNone"):
            NbBundle.getMessage(OperationWidget.class, "LBL_ReturnType", finder.getReturnType()));
...
//            ("org/netbeans/modules/websvc/design/view/resources/output.png"); // NOI18N
    ...
    public Object hashKey() {
        return finder==null?null:finder.getReturnType();
    }
