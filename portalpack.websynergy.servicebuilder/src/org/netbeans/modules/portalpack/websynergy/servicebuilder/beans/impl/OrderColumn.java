/**
 *	This generated bean class OrderColumn
 *	matches the schema element 'order-column'.
...
public class OrderColumn extends org.netbeans.modules.schema2beans.BaseBean
 implements  
	...
	public static final String ORDERBY = "OrderBy";	// NOI18N
	...
	private java.lang.String _OrderBy;
	 ...
	 */
	public OrderColumn(java.util.Vector comps, org.netbeans.modules.schema2beans.Version baseBeanRuntimeVersion) {
	 ...
	 */
	public OrderColumn(java.lang.String name) {
		super(null, baseBeanRuntimeVersion);
		_Name = name;
	}
	 ...
	 * Deep copy
	 */
	public OrderColumn(org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn source) {
		this(source, false);
	}
	 ...
	 */
	public OrderColumn(org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn source, boolean justData) {
	 ...
	 * Deep copy
	 */
	public OrderColumn(org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn source, org.netbeans.modules.schema2beans.BaseBean parent, boolean justData) {
		super(null, baseBeanRuntimeVersion);
		this.parent = parent;
	...
	public void setOrderBy(java.lang.String value) {
		if (value == null ? _OrderBy == null : value.equals(_OrderBy)) {
			// No change.
			return;
		}
		java.beans.PropertyChangeEvent event = null;
		if (eventListeners != null) {
			event = new java.beans.PropertyChangeEvent(this, nameSelf()+"/OrderBy", getOrderBy(), value);
		}
		_OrderBy = value;
		if (event != null)
			eventListeners.firePropertyChange(event);
	...
	public String _getXPathExpr(Object childObj) {
		...
		if (childName == null) {
			throw new IllegalArgumentException("childObj ("+childObj.toString()+") is not a child of this bean (OrderColumn).");
		}
	...
	protected void writeNodeAttributes(java.io.Writer out, String nodeName, String namespace, String indent, java.util.Map namespaceMap) throws java.io.IOException {
		...
		if (_OrderBy != null) {
			out.write(" order-by='");
			org.netbeans.modules.schema2beans.XMLUtil.writeXML(out, _OrderBy, true);
			out.write("'");	// NOI18N
		}
	}
	...
	public void changePropertyByName(String name, Object value) {
		...
		if (name == "comments")
			...
			throw new IllegalArgumentException(name+" is not a valid property name for OrderColumn");
	}
	...
	public boolean equals(Object o) {
		return o instanceof org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn && equals((org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn) o);
	}

	public boolean equals(org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn inst) {
		if (inst == this) {
			return true;
		}
		if (inst == null) {
		...
		if (!(_OrderBy == null ? inst._OrderBy == null : _OrderBy.equals(inst._OrderBy))) {
			return false;
		}
	...
	public int hashCode1() {
		...
		result = 37*result + (_OrderBy == null ? 0 : _OrderBy.hashCode());
		...
		if (prop == null) {
			...
			try {
				if (name == COMMENTS) {
					...
					schemaName = "order-by";
					options = org.netbeans.modules.schema2beans.Common.TYPE_KEY | org.netbeans.modules.schema2beans.Common.TYPE_0_1|org.netbeans.modules.schema2beans.Common.TYPE_STRING;
					writer = getClass().getMethod("setOrderBy", new Class[] {java.lang.String.class});
					reader = getClass().getMethod("getOrderBy", new Class[] {});
	...
	public org.netbeans.modules.schema2beans.BeanProp beanProp() {
		if (parent == null) {
			...
			if (prop == null) {
				prop = new org.netbeans.modules.schema2beans.ReflectiveBeanProp(this, "order-column", "OrderColumn", org.netbeans.modules.schema2beans.Common.TYPE_1 | org.netbeans.modules.schema2beans.Common.TYPE_BEAN, OrderColumn.class, isRoot(), null, null, null, null, null, null);
				propByName.put("", prop);
			}
			return prop;
		}
	...
	public Object clone() {
		return new OrderColumn(this, null, false);
	}

	public Object cloneData() {
		return new OrderColumn(this, null, true);
	}
	...
	private void prepareBeanPropList() {
		if (beanPropList == null) {
			...
			beanPropList.add(beanProp(ORDERBY));
	...
	public void setValue(String name, Object value) {
		...
		if (name == COMMENTS || name == "comment") {
			...
			setCaseSensitive((java.lang.String)value);
		} else if (name == ORDERBY || name == "order-by") {
			setOrderBy((java.lang.String)value);
		} else if (name == DUMMY_ELM || name == "dummy_elm") {
			setDummyElm((String[]) value);
		} else throw new IllegalArgumentException(name+" is not a valid property name for OrderColumn");
	}
	...
	public void setValue(String name, int index, Object value) {
		...
		if (name == COMMENTS || name == "comment") {
			...
			throw new IllegalArgumentException(name+" is not an indexed property for OrderColumn");
		} else if (name == CASESENSITIVE || name == "case-sensitive") {
			throw new IllegalArgumentException(name+" is not an indexed property for OrderColumn");
		} else if (name == ORDERBY || name == "order-by") {
			throw new IllegalArgumentException(name+" is not an indexed property for OrderColumn");
	...
	public void mergeUpdate(org.netbeans.modules.schema2beans.BaseBean sourceBean) {
		org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn source = (org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.OrderColumn) sourceBean;
		{
		...
		{
			java.lang.String srcProperty = source.getOrderBy();
			setOrderBy(srcProperty);
		}
		{
