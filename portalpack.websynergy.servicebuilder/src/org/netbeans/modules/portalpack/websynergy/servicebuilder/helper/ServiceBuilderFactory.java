...
public class ServiceBuilderFactory {
    ...
    private static String IMPL_CLASS = "org.netbeans.modules.portalpack.websynergy.servicebuilder.beans.impl.ServiceBuilder";

    public static ServiceBuilder createGraph(FileObject file) throws Exception {
