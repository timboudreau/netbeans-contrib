...
package org.netbeans.modules.wsdlextensions.exec.template;
...
public class ExecTemplateProvider extends ExtensibilityElementTemplateProvider {
    ...
    public InputStream getTemplateInputStream() {
        return ExecTemplateProvider.class.getResourceAsStream(execTemplateUrl);
    }

    public String getLocalizedMessage(String str, Object[] objects) {
        return NbBundle.getMessage(ExecTemplateProvider.class, str, objects);
    }
}
