...
import org.netbeans.modules.wsdlextensions.exec.validator.*;
import java.net.URL;
...
public class SchemaTest extends TestCase {
    ...
    private URL schemaUrl = SchemaTest.class.getResource("/org/netbeans/modules/wsdlextensions/exec/resources/exec-ext.xsd");
    ...
    public void testSchema() throws Exception {
        ...
        ExecValidatorSchemaFactory fac = new ExecValidatorSchemaFactory();
