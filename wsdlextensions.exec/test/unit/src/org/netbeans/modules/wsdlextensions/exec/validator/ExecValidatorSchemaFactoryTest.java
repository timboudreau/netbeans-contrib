 ...
 * @author radval
 */
public class ExecValidatorSchemaFactoryTest extends TestCase {
    
    public ExecValidatorSchemaFactoryTest(String testName) {
        super(testName);
    }
    ...
    public void testGetNamespaceURI() {
        ...
        ExecValidatorSchemaFactory instance = new ExecValidatorSchemaFactory();
