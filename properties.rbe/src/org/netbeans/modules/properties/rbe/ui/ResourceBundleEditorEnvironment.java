...
/**
 * The Resource Bundle Editor Environment
 * @author Denis Stepanov <denis.stepanov at gmail.com>
 */
public class ResourceBundleEditorEnvironment implements CloneableOpenSupport.Env, PropertyChangeListener, VetoableChangeListener {

    /** The properties data object */
    private final PropertiesDataObject dataObject;
    /** The properties property change support */
    private PropertyChangeSupport propertyChangeSupport;
    /** The properties vetoable change support */
    private VetoableChangeSupport vetoableChangeSupport;

    public ResourceBundleEditorEnvironment(PropertiesDataObject dataObject) {
    ...
    public CloneableOpenSupport findCloneableOpenSupport() {
        return new ResourceBundleEditorOpen(dataObject);
    }
    ...
    protected VetoableChangeSupport getVetoableChangeSupport() {
        synchronized (this) {
            if (vetoableChangeSupport == null) {
                vetoableChangeSupport = new VetoableChangeSupport(dataObject);
            }
        }
