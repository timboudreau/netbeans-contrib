...
public class ExportZipDialog extends javax.swing.JFrame {
    ...
    public ExportZipDialog() {
        ...
        initComponents();
        targetDirectoryField.setText(System.getProperty("java.io.tmpdir")); // NOI18N
   ...
   projectList.setSelectedIndex(0);
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ExportZipUITools.processOkButton();//GEN-HEADEREND:event_mailCheckBoxActionPerformed
    }//GEN-LAST:event_mailCheckBoxActionPerformed
//GEN-FIRST:event_okButtonActionPerformed
    private void cancelButtonActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ExportZipUITools.processCancelButton();//GEN-HEADEREND:event_okButtonActionPerformed
    }//GEN-LAST:event_okButtonActionPerformed

    private void emailSettingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-HEADEREND:event_cancelButtonActionPerformed
        ExportZipUITools.showEmailSettings();//GEN-LAST:event_cancelButtonActionPerformed
    }//GEN-FIRST:event_emailSettingsActionPerformed

    private void chooseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-HEADEREND:event_emailSettingsActionPerformed
        ExportZipUITools.showFileChooser();//GEN-LAST:event_emailSettingsActionPerformed
     ...
     */
    public void setTargetDir(String targetDir) {//GEN-HEADEREND:event_chooseButtonActionPerformed
        targetDirectoryField.setText(targetDir);//GEN-LAST:event_chooseButtonActionPerformed
    }
