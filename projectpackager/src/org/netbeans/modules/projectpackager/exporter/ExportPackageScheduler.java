...
public class ExportPackageScheduler {
    ...
    public static void sendMail(ExportExecutorThread et) {
        ...
        props.setProperty("mail_from", ExportPackageInfo.mailFrom);
        props.setProperty("mail_subject", ExportPackageInfo.mailSubject);
        props.setProperty("mail_body", ExportPackageInfo.mailBody);
