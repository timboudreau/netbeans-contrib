...
public class JavaFXTokenContext extends TokenContext {
    ...
    //public static final int VOID_ID = OR_OR_ID + 1;

    // Other keywords numeric-ids
    // public static final int ABSTRACT_ID = VOID_ID + 1;
    public static final int ASSERT_ID = OR_OR_ID + 1;
    public static final int ATTRIBUTE_ID = ASSERT_ID + 1;
    public static final int BREAK_ID = ASSERT_ID + 1;
    // public static final int CASE_ID = BREAK_ID + 1;
    public static final int CATCH_ID = BREAK_ID + 1;
    public static final int CLASS_ID = CATCH_ID + 1;
    // public static final int CONST_ID = CLASS_ID + 1;
    public static final int CONTINUE_ID = CLASS_ID + 1;
    // public static final int DEFAULT_ID = CONTINUE_ID + 1;
    public static final int DO_ID = CONTINUE_ID + 1;
    public static final int ELSE_ID = DO_ID + 1;
    // public static final int ENUM_ID = ELSE_ID + 1;
    public static final int EXTENDS_ID = ELSE_ID+ 1;
    // public static final int FALSE_ID = EXTENDS_ID + 1;
    // public static final int FINAL_ID = EXTENDS_ID + 1;
    public static final int FINALLY_ID = EXTENDS_ID + 1;
    public static final int FOR_ID = FINALLY_ID + 1;
    public static final int FUNCTION_ID = FOR_ID + 1; // JavaFX
    // public static final int GOTO_ID = FUNCTION_ID + 1;
    ...
    public static final int OPERATION_ID = NULL_ID + 1; // JavaXF
    public static final int PACKAGE_ID = OPERATION_ID + 1;
    ...
    public static final int READONLY_ID = PUBLIC_ID + 1;
    public static final int RETURN_ID = READONLY_ID + 1;
    // public static final int STATIC_ID = RETURN_ID + 1;
    // public static final int STRICTFP_ID = STATIC_ID + 1;
    public static final int SUPER_ID = RETURN_ID + 1;
    // public static final int SWITCH_ID = SUPER_ID + 1;
    // public static final int SYNCHRONIZED_ID = SWITCH_ID + 1;
    public static final int THIS_ID = SUPER_ID + 1;
    // public static final int THROW_ID = THIS_ID + 1;
    // public static final int THROWS_ID = THROW_ID + 1;
    // public static final int TRANSIENT_ID = THIS_ID + 1;
    public static final int TRIGGER_ID = THIS_ID + 1;
    public static final int TRUE_ID = TRIGGER_ID + 1;
    ...
    = new BaseImageTokenID("attribute", ATTRIBUTE_ID, KEYWORDS); // NOI18N
    ...
    public static final BaseImageTokenID OPERATION
    = new BaseImageTokenID("operation", OPERATION_ID, KEYWORDS); // NOI18N
    ...
    = new BaseImageTokenID("readonly", READONLY_ID, KEYWORDS); // NOI18N
    ...
    public static final BaseImageTokenID TRIGGER
    = new BaseImageTokenID("trigger", TRIGGER_ID, KEYWORDS); // NOI18N
    ...
    = new BaseImageTokenID("VAR", VAR_ID, KEYWORDS); // NOI18N
    ...
    public static final JavaFXTokenContext context = new JavaFXTokenContext();
    ...
    static {
        /*BaseImageTokenID[] kwds = new BaseImageTokenID[] {
            ...
            ELSE, ENUM, EXTENDS, FALSE, FINAL, FINALLY, FOR, FUNCTION, GOTO, IF, IMPLEMENTS, 
            IMPORT, INSTANCEOF, INTERFACE, NATIVE, NEW, NULL, OPERATION, PACKAGE, PRIVATE, 
        ...
        BaseImageTokenID[] kwds = new BaseImageTokenID[] {
            ASSERT, ATTRIBUTE, BREAK, CATCH, CLASS, CONTINUE, DO, 
            ELSE, EXTENDS, FINALLY, FOR, FUNCTION, IF, 
            IMPORT, INSTANCEOF, NEW, NULL, OPERATION, PACKAGE, PRIVATE, 
            PROTECTED, PUBLIC, READONLY, RETURN, SUPER, THIS, TRIGGER, 
            TRUE, TRY, WHILE, VAR
        };
