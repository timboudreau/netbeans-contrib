 ...
 * @author David Strupl
 */
public class ForLoopTreeEnvironment extends JavaFXCompletionEnvironment<ForLoopTree> {
    
    private static final Logger logger = Logger.getLogger(ForLoopTreeEnvironment.class.getName());
    private static final boolean LOGGABLE = logger.isLoggable(Level.FINE);

    public ForLoopTreeEnvironment(ForLoopTree t, int offset, String prefix, CompilationController controller, TreePath path, SourcePositions sourcePositions, JavaFXCompletionQuery query) {
        super(t, offset, prefix, controller, path, sourcePositions, query);
    }
    
    @Override
    protected void inside(ForLoopTree t) throws IOException {
        log("inside ForLoopTree " + t);
        ForLoopTree fl = t;
        Tree lastTree = null;
