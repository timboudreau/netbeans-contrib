...
public class CaseTreeEnvironment extends JavaFXCompletionEnvironment<CaseTree> {
    ...
    public CaseTreeEnvironment(CaseTree t, int offset, String prefix, CompilationController controller, TreePath path, SourcePositions sourcePositions, JavaFXCompletionQuery query) {
