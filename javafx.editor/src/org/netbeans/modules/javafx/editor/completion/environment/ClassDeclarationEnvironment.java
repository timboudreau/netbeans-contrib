...
public class ClassDeclarationEnvironment extends JavaFXCompletionEnvironment<JFXClassDeclaration> {
    ...
    public ClassDeclarationEnvironment(JFXClassDeclaration t, int offset, String prefix, CompilationController controller, TreePath path, SourcePositions sourcePositions, JavaFXCompletionQuery query) {
