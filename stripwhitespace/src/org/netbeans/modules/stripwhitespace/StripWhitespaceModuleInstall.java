 ...
 * @author Andrei Badea
 */
public class StripWhitespaceModuleInstall extends ModuleInstall {
    ...
    public void restored() {
        ...
        listener =new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                HighlightWhitespace.getDefault().install(Registry.getMostActiveComponent());
            }
        };
        ...
        if (component != null) {
            HighlightWhitespace.getDefault().install(component);
        }
    }
    ...
    public void uninstalled() {
        ...
        listener = null;
        HighlightWhitespace.getDefault().uninstall();
    }
}
