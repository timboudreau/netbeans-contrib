...
public class CvsBranchFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        revALabel.setText(java.util.ResourceBundle.getBundle("vcs/commands/Bundle").getString("CvsBranchFrame.revALabel.text"));
          gridBagConstraints3 = new java.awt.GridBagConstraints();
          gridBagConstraints3.anchor = java.awt.GridBagConstraints.WEST;
          infoPanel1.add(revALabel, gridBagConstraints3);
          
          
        revATextField.setToolTipText(java.util.ResourceBundle.getBundle("vcs/commands/Bundle").getString("CvsBranchFrame.revATextField.toolTipText"));
        ...
        revBLabel.setText(java.util.ResourceBundle.getBundle("vcs/commands/Bundle").getString("CvsBranchFrame.revBLabel.text"));
          gridBagConstraints4 = new java.awt.GridBagConstraints();
          gridBagConstraints4.anchor = java.awt.GridBagConstraints.WEST;
          infoPanel2.add(revBLabel, gridBagConstraints4);
          
          
        revBTextField.setToolTipText(java.util.ResourceBundle.getBundle("vcs/commands/Bundle").getString("CvsBranchFrame.revBTextField.toolTipText"));
        ...
        hintLabel.setText(java.util.ResourceBundle.getBundle("vcs/commands/Bundle").getString("CvsBranchFrame.hintLabel.text"));
        
        gridBagConstraints1 = new java.awt.GridBagConstraints();
        gridBagConstraints1.gridy = 4;
        gridBagConstraints1.insets = new java.awt.Insets(0, 8, 8, 8);
        gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
        getContentPane().add(hintLabel, gridBagConstraints1);
        
        
        buttonPanel.setLayout(new java.awt.GridBagLayout());
        java.awt.GridBagConstraints gridBagConstraints6;
        
        diffButton.setText(java.util.ResourceBundle.getBundle("vcs/commands/Bundle").getString("CvsBranchFrame.diffButton.text"));
        ...
        closeButton.setText(java.util.ResourceBundle.getBundle("vcs/commands/Bundle").getString("CvsBranchFrame.closeButton.text"));
