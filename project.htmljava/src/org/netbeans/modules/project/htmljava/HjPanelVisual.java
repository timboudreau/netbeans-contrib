...
public class HjPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName"; //NOI18N

    private HjWizardPanel panel;

    public HjPanelVisual(HjWizardPanel panel) {
        initComponents();
        this.panel = panel;
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(projectNameLabel, getMessage("HjPanelVisual.projectNameLabel.text")); // NOI18N

        projectLocationLabel.setLabelFor(projectLocationTextField);
        org.openide.awt.Mnemonics.setLocalizedText(projectLocationLabel, getMessage("HjPanelVisual.projectLocationLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(browseButton, getMessage("HjPanelVisual.browseButton.text")); // NOI18N
        browseButton.setActionCommand("null");
        browseButton.addActionListener(formListener);

        createdFolderLabel.setLabelFor(createdFolderTextField);
        org.openide.awt.Mnemonics.setLocalizedText(createdFolderLabel, getMessage("HjPanelVisual.createdFolderLabel.text")); // NOI18N

        createdFolderTextField.setEditable(false);

        packageNameLabel.setLabelFor(projectNameTextField);
        org.openide.awt.Mnemonics.setLocalizedText(packageNameLabel, getMessage("HjPanelVisual.packageNameLabel.text")); // NOI18N

        groupIdLabel.setLabelFor(createdFolderTextField);
        org.openide.awt.Mnemonics.setLocalizedText(groupIdLabel, getMessage("HjPanelVisual.groupIdLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(artifactIdLabel, getMessage("HjPanelVisual.artifactIdLabel.text")); // NOI18N
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == browseButton) {
                HjPanelVisual.this.browseButtonActionPerformed(evt);
            }
        }
    ...
    private static String getMessage(String key) {
        return NbBundle.getMessage(HjPanelVisual.class, key);
    }
}
