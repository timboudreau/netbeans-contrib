...
public final class NewFilterWizardVisualPanel1 extends JPanel implements DocumentListener {
    ...
    public void initData() {
        DefaultCellEditor dce = new DefaultCellEditor(new CellText((InitParamsTable) initParamTable));
        dce.setClickCountToStart(1);
        initParamTable.getColumnModel().getColumn(0).setCellEditor(dce);
        initParamTable.getColumnModel().getColumn(1).setCellEditor(dce);
        renderCB.setSelected(true);
        initParamTable.getModel().addTableModelListener(new TableModelListener() {
        ...
        initParamTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
    ...
    private void initComponents() {
        ...
        initParamTable = new InitParamsTable();
...
private void addParamButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addParamButtonActionPerformed
    ...
    private void updateInitParam() {
        isParamOk = true;
        paramErrorMsg = "";
        List list = initParamTableModel.getInitParams();
        for (int i = 0; i < list.size(); i++) {
            InitParam intParam = (InitParam) list.get(i);
            if (intParam.getName() == null || intParam.getName().trim().length() == 0) {
                isParamOk = false;
                paramErrorMsg = "A param name is required";
                break;
            }
        }
    ...
    class CellText extends JTextField {
        ...
        public CellText(InitParamsTable table) {
            super();
