...
public final class NetbeansNewPortletClassVisualPanel1 extends JPanel implements DocumentListener{
    ...
    private void initComponents() {
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        .add(viewCB, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
                        .add(36, 36, 36)
                        .add(editCB, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE)
                        .add(33, 33, 33)
        ...
        jLabel1.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSN_Portlet_Name")); // NOI18N
        jLabel1.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Name")); // NOI18N
        pnameTf.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_NAME")); // NOI18N
        pnameTf.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Name")); // NOI18N
        jLabel2.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Display_Name")); // NOI18N
        portletDisplayNameTf.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_DISPLAY_NAME")); // NOI18N
        portletDisplayNameTf.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Display_Name")); // NOI18N
        jLabel3.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_DESC")); // NOI18N
        jLabel3.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Description")); // NOI18N
        portletDescTf.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_DESC")); // NOI18N
        portletDescTf.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Description")); // NOI18N
        jLabel4.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_TITLE")); // NOI18N
        jLabel4.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Title")); // NOI18N
        jLabel5.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_SHORT_TITLE")); // NOI18N
        jLabel5.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Short_Title")); // NOI18N
        portletShortTitleTf.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_SHORT_TITLE")); // NOI18N
        portletShortTitleTf.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_Portlet_Short_Title")); // NOI18N
        viewCB.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_VIEW")); // NOI18N
        viewCB.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_VIEW")); // NOI18N
        editCB.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LB_EDIT")); // NOI18N
        editCB.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_EDIT")); // NOI18N
        helpCB.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_HELP")); // NOI18N
        helpCB.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "ACSD_HELP")); // NOI18N
        jLabel6.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(NetbeansNewPortletClassVisualPanel1.class, "LBL_PORTLET_MODE")); // NOI18N
