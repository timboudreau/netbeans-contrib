...
public class MSMQBindingImpl extends MSMQComponentImpl implements MSMQBinding {
    public MSMQBindingImpl(WSDLModel model, Element e) {
        super(model, e);
    }
    
    public MSMQBindingImpl(WSDLModel model){
        this(model, createPrefixedElement(MSMQQName.BINDING.getQName(), model));
    }
