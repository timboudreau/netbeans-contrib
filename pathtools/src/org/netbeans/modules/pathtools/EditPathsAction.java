 ...
 */
public final class EditPathsAction extends CookieAction {
            ...
            if (filePath != null && filePath.trim().length() > 0) {
                String commandFormat = fileObject.isFolder() ? 
                    Preferences.userNodeForPackage(PathtoolsPanel.class).get(
                        ...
                        PathtoolsOptionsPanelController.getDEFAULT_FOLDER_EDIT_COMMAND())
                    : 
                    Preferences.userNodeForPackage(PathtoolsPanel.class).get(
                        PathtoolsOptionsPanelController.PROP_FILE_EDIT_COMMAND,
                        PathtoolsOptionsPanelController.getDEFAULT_FILE_EDIT_COMMAND());
    ...
    public String getName() {
        return NbBundle.getMessage(EditPathsAction.class, "CTL_EditPathsAction"); // NOI18N
    }
    
    protected String iconResource() {
        return "org/netbeans/modules/pathtools/editpaths.gif"; // NOI18N
    }
