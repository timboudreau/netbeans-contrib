 ...
 * @author Petr Jiricka
 * @Modified by Satya
 * This java file is copied from Tomcat netbeans module.
 */
public class TomcatFindJSPServletImpl implements FindJSPServlet {
    ...
    public TomcatFindJSPServletImpl(PSDeploymentManager manager) {
    ...
    public File getServletTempDirectory(String moduleContextPath) {
        File baseDir = new File(dm.getPSConfig().getProperty(TomcatConstant.CATALINA_HOME));
