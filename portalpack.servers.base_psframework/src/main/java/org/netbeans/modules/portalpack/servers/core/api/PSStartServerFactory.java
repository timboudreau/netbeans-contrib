 ...
 * @author Satya
 */
public class PSStartServerFactory {
    
    private static Logger logger = Logger.getLogger(NetbeanConstants.PORTAL_LOGGER);
    
    public PSStartServerFactory instance;
    /** Creates a new instance of ContainerServerFactory */
    private PSStartServerFactory() {
        if(instance == null)
            instance = new PSStartServerFactory();
    }
    
    public static PSStartServerInf getPSStartServerHandler(PSDeploymentManager dm)
    {
