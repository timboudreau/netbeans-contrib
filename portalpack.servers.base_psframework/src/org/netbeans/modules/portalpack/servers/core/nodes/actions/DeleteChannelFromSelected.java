 ...
 * @author Satya
 */
public class DeleteChannelFromSelected extends CookieAction {
    ...
    protected void performAction(Node[] nodes) {
        ...
        for(int i=0;i<nodes.length;i++) {
            ...
            ActionUtil.removeChannelFromSelectedList(cookie.getDn(),cookie.getKey(),chChildrenNode.getContainerName(),handler);
    ...
    public String getName(){
        return org.openide.util.NbBundle.getMessage(DeleteChannelFromSelected.class, "ACT_Delete_From_Selected_List");
    }
