 ...
 * @author Satya
 */
public class PSRegistryNodeFactory implements RegistryNodeFactory {
    
     /** Creates a new instance of PSRegistryNodeFactory */
    public PSRegistryNodeFactory() {
    }
    ...
    public Node getManagerNode(Lookup lookup) {
        PSInstanceNode tn = new PSInstanceNode (lookup);
        return tn;
    }
    ...
    public Node getTargetNode(Lookup lookup) {
        return new PSTargetNode(lookup);
