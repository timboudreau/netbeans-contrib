...
public abstract class ConfigPanel extends JPanel{
    ...
    /**
     * Implements this method to populate data in the config panel. This method
     * is called before showing the customization panel for a already added server instance.
     *
     * @param object PSConfigObject for a server instance
     */
    public abstract void populateDataForCustomizer(PSConfigObject object);
