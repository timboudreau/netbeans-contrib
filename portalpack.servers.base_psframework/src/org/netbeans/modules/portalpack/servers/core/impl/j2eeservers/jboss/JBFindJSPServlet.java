...
/**
 * FindJSPServlet implementation for JBoss
 * @author Libor Kotouc, John Platts
 */
public class JBFindJSPServlet implements FindJSPServlet {
    
    PSDeploymentManager dm;
    
    public JBFindJSPServlet(PSDeploymentManager manager) {
        dm = manager;
    }

    public File getServletTempDirectory(String moduleContextPath) {
        String domainPath = dm.getPSConfig().getProperty(JBConstant.SERVER_DIR);
