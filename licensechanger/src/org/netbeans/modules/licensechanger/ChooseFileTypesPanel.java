...
public class ChooseFileTypesPanel extends javax.swing.JPanel implements ExplorerManager.Provider, PropertyChangeListener, NodeCheckObserver {
    ...
    public ChooseFileTypesPanel(Map<Object, Object> settings) {
        initComponents();
        mgr.setRootContext(new AbstractNode (Children.create(new FileHandlerChildren(), false)));
        settings.put(KEY_FILE_HANDLERS, Lookup.getDefault().lookupAll(FileHandler.class));
    ...
    private void updateMap() {
        Set<FileHandler> handlers = new HashSet<FileHandler>();
        for (Node n : mgr.getRootContext().getChildren().getNodes(true)) {
            if (Boolean.TRUE.equals(n.getValue(CheckboxListView.SELECTED))) {
                handlers.addAll (n.getLookup().lookupAll(FileHandler.class));
            }
        }
        settings.put(KEY_FILE_HANDLERS, handlers);
    }
    ...
    private void initComponents() {
        ...
        lineEndingsPanel1 = new org.netbeans.modules.licensechanger.LineEndingsPanel();
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        .add(customizerPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 559, Short.MAX_VALUE)
                        .add(18, 18, 18)
                        .add(lineEndingsPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 227, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(customizerPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE)
                    .add(lineEndingsPanel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 361, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private org.netbeans.modules.licensechanger.LineEndingsPanel lineEndingsPanel1;
    ...
    private static final class FileHandlerChildren extends ChildFactory<FileHandler> {
        ...
        protected Node createNodeForKey(FileHandler key) {
            ...
            result.setValue (CheckboxListView.SELECTED, Boolean.TRUE);
            return result;
        }
    }
