...
public final class LicenseHeader {
	 ...
	 *
	 * <p>
	 * If the passed in licenseName starts with <em>license-</em>, that
	 * prefix is removed.</p>
	 *
	 * @param file               the FileObject containing the license header text
	 * @param licenseName        the name of the license
	 * @param isNetBeansTemplate whether the license is a netbeans template or not
	 ...
	 *
	 * <p>
	 * The new license template will have a name according to license
