...
import org.netbeans.modules.erlang.project.ui.customizer.RubyCompositePanelProvider;
 ...
 * @author Jesse Glick
 */
public final class RubyConfigurationProvider implements ProjectConfigurationProvider<RubyConfigurationProvider.Config> {
    ...
    public static final class Config implements ProjectConfiguration {
        ...
        public String toString() {
            return "RubyConfigurationProvider.Config[" + name + "," + displayName + "]"; // NOI18N
        }
    }
