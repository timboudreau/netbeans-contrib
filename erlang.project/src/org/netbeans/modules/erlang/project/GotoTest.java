 ...
 * @author Tor Norbye
 */
public class GotoTest extends AbstractAction /** @Caoyuan commented implements EditorAction */ {
    ...
    private boolean isRSpecInstalled(FileObject projectDir) {
        return new RSpecSupport(projectDir).isRSpecInstalled();
    }
...
//            if (fo != null) {
//                int offset = 0;
//                org.jruby.ast.Node node = AstUtilities.getForeignNode(c);
//
//                if (node != null) {
