...
public class GemProgressPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        messageLabel.setText(org.openide.util.NbBundle.getMessage(GemProgressPanel.class, "GemProgressPanel.messageLabel.text")); // NOI18N

        outputToggle.setSelected(true);
        outputToggle.setText(org.openide.util.NbBundle.getMessage(GemProgressPanel.class, "GemProgressPanel.outputToggle.text")); // NOI18N
