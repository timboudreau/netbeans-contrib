...
public class RubyFileLocator implements FileLocator {
    ...
    public FileObject find(String file) {
        ...
        /** @Caoyuan added */
        /** 
         * since the path of file may be relative to project root folder, 
         * for instance: src/main.erl, we should check from project root. 
         */
        FileObject projectRoot = project.getProjectDirectory();
        FileObject found = projectRoot.getFileObject(file);
        if (found != null) {
            return found;
        }
        /** end @caoyuan added */
