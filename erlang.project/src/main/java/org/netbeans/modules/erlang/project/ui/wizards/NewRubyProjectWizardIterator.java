...
import org.netbeans.modules.erlang.project.RubyProjectGenerator;
...
//    }
    ...
    public Set/*<FileObject>*/ instantiate (ProgressHandle handle) throws IOException {
        ...
        if (this.type == TYPE_EXT) {
            ...
            File[] includeFolders = (File[])wiz.getProperty("includeRoot");        //NOI18N
            File[] testFolders = (File[])wiz.getProperty("testRoot");            //NOI18N
            RubyProjectGenerator.createProject(dirF, name, sourceFolders, includeFolders, testFolders, null );
            handle.progress (2);
            ...
            if (mainClass != null && mainClass.length () > 0) {
                try {
                    //(String)j2seProperties.get (RubyProjectProperties.SRC_DIR);
...
//                break;
    ...
    public void initialize(WizardDescriptor wiz) {
        ...
        this.wiz.putProperty("includeRoot", new File[0]);    //NOI18N
    ...
    public void uninitialize(WizardDescriptor wiz) {
        if (this.wiz != null) {
            ...
            if (this.type == TYPE_EXT) {
                ...
                this.wiz.putProperty("includeRoot",null);    //NOI18N
