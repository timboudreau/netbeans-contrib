...
import org.netbeans.modules.helpbuilder.tree.TocTreeItem;
import org.netbeans.modules.helpbuilder.tree.TocTreeNode;
...
public class TocSetupPanel extends javax.swing.JPanel {
    ...
    public TocSetupPanel(final TocSetup descriptor) {
        ...
        setName(NbBundle.getMessage(ProjectSetupPanel.class, "TITLE_TocPanel"));
        /*
    ...
    private void initActions(){
        ...
        btnAdd.setAction(tree.getAddTocAction());
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtDesc.setText(java.util.ResourceBundle.getBundle("org/netbeans/modules/helpbuilder/ui/Bundle").getString("TXT_txtDesc"));
