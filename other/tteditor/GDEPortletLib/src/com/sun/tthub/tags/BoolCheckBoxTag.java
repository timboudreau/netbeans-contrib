...
public class BoolCheckBoxTag extends TagSupport {
    ...
    throws JspException {
        ...
        System.out.println("[BoolCheckBoxTag Entry]");
        System.out.println("[BoolCheckBoxTag-fieldName]-"+fieldName);
        ...
        //Print checkboxControl
        try{
            StringBuffer buffer=new StringBuffer();
            buffer.append("<input type=\"checkbox\" name=\"");
            buffer.append(fieldName);
            if(((String)fields[0]).equals("T")){
                buffer.append("\" value=\"T\" checked/>");
            }else{
