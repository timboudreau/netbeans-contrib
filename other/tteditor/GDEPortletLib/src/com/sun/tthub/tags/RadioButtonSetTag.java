...
public class RadioButtonSetTag extends TagSupport {
    ...
    throws JspException {
        ...
        System.out.println("[RadioButtonSetTag Entry]");
        System.out.println("[RadioButtonSetTag-fieldName]-"+fieldName);
        ...
        try{
            ...
            System.out.println("[RadioButtonSetTag-fieldList]-"+fieldList);
