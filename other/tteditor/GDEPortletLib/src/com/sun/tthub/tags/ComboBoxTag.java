...
public class ComboBoxTag extends TagSupport {
    ...
    throws JspException {
        System.out.println("[ComboBoxTag Entry]");
        System.out.println("[ComboBoxTag-fieldName]-"+fieldName);
        ...
        try{
            ...
            System.out.println("[ComboBoxTag-fieldList]-"+fieldList);
