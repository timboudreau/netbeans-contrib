 ...
 */
public class TextBoxControl extends TTValueControl {

    /** Creates a new instance of TextBoxControl */
    public TextBoxControl(FieldInfo fieldInfo) {
        super(fieldInfo);
    }
    ...
    public String getFieldInfoJspString() throws GDEException {
        ...
        String fieldName = "txt" + fieldInfo.getFieldMetaData().getFieldName();
