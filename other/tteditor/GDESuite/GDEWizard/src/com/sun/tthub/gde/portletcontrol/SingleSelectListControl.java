 ...
 *
 */
public class SingleSelectListControl extends TTValueControl {
    
    /** Creates a new instance of SingleSelectListControl */
    public SingleSelectListControl(FieldInfo fieldInfo) {
        super(fieldInfo);
    }
    
    public String getFieldInfoJspString() throws GDEException {
        StringBuffer buffer = new StringBuffer();
        String fieldName = "lstSingle" + 
