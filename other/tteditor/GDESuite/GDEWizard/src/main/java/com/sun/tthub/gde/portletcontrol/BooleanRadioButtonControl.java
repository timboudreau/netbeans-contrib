 ...
 */
public class BooleanRadioButtonControl extends TTValueControl {
    
    /** Creates a new instance of BooleanRadioButtonControl */
    public BooleanRadioButtonControl(FieldInfo fieldInfo) {
        super(fieldInfo);
    }
    ...
    public String getFieldInfoJspString() throws GDEException {
        ...
        buffer.append("\" value=\"Y\" />Yes</td></tr>");
        buffer.append("<tr><td><input type=\"radio\" name=\""); 
        buffer.append(fieldName);
        buffer.append("\" value=\"N\" />No</td></tr>");        
        buffer.append("</table>");
