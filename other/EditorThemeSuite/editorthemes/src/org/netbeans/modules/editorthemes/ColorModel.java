...
public final class ColorModel {
    ...
    //XXX should this really be localized?
...
//        System.err.println("Languages: " + langs);
	...
	Collection<AttributeSet> annotations
        ...
        String old = getCurrentProfile();
        if (!old.equals(profile)) {
            setCurrentProfile(profile);
        }
	//System.out.println("ColorModelImpl.setAnnotations ");
    ...
    public Map<String, AttributeSet> getHighlightingMap (String profile) {
        Map<String, AttributeSet> m = EditorSettings.getDefault().getHighlightings(profile);
        return m;
    }
    ...
    public void setHighlightings(String profile, Collection<AttributeSet> highlights) {
        EditorSettings.getDefault().setHighlightings(profile, toMap(highlights));
    }
    ...
    Preview getSyntaxColoringPreviewComponent(String language) {
