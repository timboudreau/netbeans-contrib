 ...
 * value argument.
 * <p>
 * This is used to handle caching of logical line lengths in the output window -
 ...
 * of the time the number of wrapped logical lines will turn out to be 1 - instead,
...
public final class SparseIntList {
     ...
     * to this method, and the index must be > than the last index passed to
     ...
     * But get(12) will return 21.  Adding a value affects the value <i>of</i>,
     * not <i>at</i> the index where it is added.
     */
