...
public class DeclarationAndJavadocJavaSourceTaskFactory extends CaretAwareJavaSourceTaskFactory {
    
    public DeclarationAndJavadocJavaSourceTaskFactory() {
        super(Phase.RESOLVED, Priority.LOW);
    }

    public CancellableTask<CompilationInfo> createTask(FileObject fileObject) {
        return new DeclarationAndJavadocTask(this, fileObject);
    }
}
