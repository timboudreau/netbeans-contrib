...
// Rats! Parser Generator, version 1.13.1,
// (C) 2004-2007 Robert Grimm,
// on Monday, October 15, 2007 at 8:27:57 PM.
...
public final class TypicalParser extends ParserBase {
  ...
  private Result pParameters(final int yyStart) throws IOException {
    ...
    while (true) {
      ...
      yyResult = pParameter(yyRepetition1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Node v$el$1 = yyResult.semanticValue();
  ...
  private Result pWhenPattern(final int yyStart) throws IOException {
    TypicalParserColumn yyColumn = (TypicalParserColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fWhenPattern) 
      yyColumn.chunk1.fWhenPattern = pWhenPattern$1(yyStart);
    return yyColumn.chunk1.fWhenPattern;
  }
  ...
  private Result pWhenPattern$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Node v$3 = yyResult.semanticValue();
  ...
  private Result pEqualityExpression(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Node v$4 = yyResult.semanticValue();
  ...
  private Result pArguments$$Plus1(final int yyStart) throws IOException {
    TypicalParserColumn yyColumn = (TypicalParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fArguments$$Plus1) 
      yyColumn.chunk2.fArguments$$Plus1 = pArguments$$Plus1$1(yyStart);
    return yyColumn.chunk2.fArguments$$Plus1;
  }
  ...
  private Result pLowerID(final int yyStart) throws IOException {
    TypicalParserColumn yyColumn = (TypicalParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fLowerID) 
      yyColumn.chunk3.fLowerID = pLowerID$1(yyStart);
    return yyColumn.chunk3.fLowerID;
  }
  ...
  private Result pUpperID(final int yyStart) throws IOException {
    TypicalParserColumn yyColumn = (TypicalParserColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fUpperID) 
      yyColumn.chunk3.fUpperID = pUpperID$1(yyStart);
    return yyColumn.chunk3.fUpperID;
  }
  ...
  private Result pConstructedType$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Node v$6 = yyResult.semanticValue();
  ...
  private Result pExponent$$Plus1(final int yyStart) throws IOException {
    TypicalParserColumn yyColumn = (TypicalParserColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fExponent$$Plus1) 
      yyColumn.chunk4.fExponent$$Plus1 = pExponent$$Plus1$1(yyStart);
    return yyColumn.chunk4.fExponent$$Plus1;
  }
  ...
  static {
    ...
    {"and", "any", "assert", "require", "attribute",
      ...
      "import", "eqattribute", "function", "let",
