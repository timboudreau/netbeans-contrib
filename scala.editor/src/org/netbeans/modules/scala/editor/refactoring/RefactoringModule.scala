...
object RefactoringModule {
  ...
  private val preferences = NbPreferences.forModule(classOf[RefactoringModule])
   ...
   */
  def getOption(key: String, defaultValue: Boolean): Boolean = {
   ...
   */
  def setOption(key: String, value: Boolean) {
    preferences.putBoolean(key, value)
  }

  def setOption(key: String, value: Int) {
