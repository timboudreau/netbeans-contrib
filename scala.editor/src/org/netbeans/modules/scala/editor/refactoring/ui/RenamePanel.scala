...
class RenamePanel(oldName: String, parent: ChangeListener, name: String, editable: Boolean, showUpdateReferences: Boolean) extends JPanel with CustomRefactoringPanel {
  ...
  private var warningLabel: javax.swing.JLabel = _
  ...
  private def initComponents {
    ...
    org.openide.awt.Mnemonics.setLocalizedText(warningLabel, org.openide.util.NbBundle.getMessage(classOf[RenamePanel], "LBL_NonAccurateRefactoringWarning")); // NOI18N
    ...
    textCheckBox.setSelected((RefactoringModule.getOption("searchInComments.rename", false).asInstanceOf[Boolean]).booleanValue());
