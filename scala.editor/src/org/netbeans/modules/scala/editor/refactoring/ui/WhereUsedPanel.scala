...
import org.netbeans.modules.scala.editor.refactoring.RefactoringModule;
/**
...
class WhereUsedPanel(name: String, element: ScalaItems#ScalaItem, parent: ChangeListener) extends JPanel with CustomRefactoringPanel {
  ...
  private def initComponents {
    ...
    val bundle = java.util.ResourceBundle.getBundle("org/netbeans/modules/scala/editor/refactoring/ui/Bundle"); // NOI18N
