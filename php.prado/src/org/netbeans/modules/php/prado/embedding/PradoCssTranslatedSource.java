 ...
 * @author Tor Norbye
 */
public class PradoCssTranslatedSource extends TranslatedSource {
    private PradoCssModel model;

    public PradoCssTranslatedSource(PradoCssEmbeddingModel embeddingModel, PradoCssModel model) {
