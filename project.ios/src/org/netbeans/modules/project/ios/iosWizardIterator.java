...
public class iosWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {

    private int index;
    private WizardDescriptor.Panel[] panels;
    private WizardDescriptor wiz;

    public iosWizardIterator() {
    }

    public static iosWizardIterator createIterator() {
        return new iosWizardIterator();
    }
    ...
    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(iosWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
    ...
    public Set/*<FileObject>*/ instantiate(/*ProgressHandle handle*/) throws IOException {
        ...
        copyProject(template, dir, 
            ...
            (String)wiz.getProperty("profile")
        );
    ...
    private static void copyProject(
        ...
        String prjname, String pkg, String profile
    ) throws IOException {
        ...
        while (all.hasMoreElements()) {
            ...
            if (entry.isData()) {
                ...
                if (entry.getMIMEType().startsWith("text/")) {
                    copyWithSubst(entry, fo, prjname, pkg, profile);
                    continue;
                }
                try (
    ...
    private static void copyWithSubst(FileObject from, FileObject to,
        String name, String pkg, String profile
    ) throws IOException {
