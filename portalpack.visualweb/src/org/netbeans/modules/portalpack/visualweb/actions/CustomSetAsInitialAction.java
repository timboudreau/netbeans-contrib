...
package org.netbeans.modules.portalpack.visualweb.actions;
...
import org.netbeans.modules.portalpack.visualweb.api.JsfPortletSupportException;
import org.netbeans.modules.portalpack.visualweb.ui.JsfProjectUtils;
 ...
 */
public class CustomSetAsInitialAction extends AbstractAction
    ...
    public CustomSetAsInitialAction() {
        this(TYPE_NONE, null); // Fake action -> The context aware is real one, drawback of the NB design?
    }

    private CustomSetAsInitialAction(int type, DataObject inDataObject) {
        this.type = type;
        ...
        if(type == TYPE_PORTLET) {
            name = NbBundle.getMessage(CustomSetAsInitialAction.class, "LBL_SetInitalPageAction_SETINITIALVIEWPAGE");
        } else {
            name = null;
        }
    ...
    public void actionPerformed(ActionEvent evt) {
        if(type == TYPE_PORTLET) {
            ...
            try {
                ...
                if(actionCommand.equals(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_VIEWMODE"))) {
                    /**
                    ...
                    if(null != currentViewPage) {
                        ...
                        if(null != currentFO) {
                            try {
                                ...
                                NbBundle.getMessage(CustomSetAsInitialAction.class,
                    ...
                    ((DataNode)dataObject.getNodeDelegate()).setShortDescription(NbBundle.getMessage(CustomSetAsInitialAction.class, "LBL_InitialViewShortDesc"));                    
                } else if(actionCommand.equals(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_EDITMODE"))) {
                    /**
                     * Set the icon for the current one for this mode to the default icon.
                     */
                    ...
                    ((DataNode)dataObject.getNodeDelegate()).setShortDescription(NbBundle.getMessage(CustomSetAsInitialAction.class, "LBL_InitialEditShortDesc"));
                } else if(actionCommand.equals(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_HELPMODE"))) {
                    /**
                     * Set the icon for the current one for this mode to the default icon.
                     */
                    ...
                    ((DataNode)dataObject.getNodeDelegate()).setShortDescription(NbBundle.getMessage(CustomSetAsInitialAction.class, "LBL_InitialHelpShortDesc"));
                } else if(actionCommand.equals(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_NONEMODE"))) {
                    /**
    ...
    public Action createContextAwareInstance(Lookup context) {
        ...
        if(isJspInPortletProject(fo)) {
            return new CustomSetAsInitialAction(TYPE_PORTLET, dob);
        }
        return null;
    }
    ...
    public JMenuItem getMenuPresenter() {
        if(isJspInPortletProject(fo)) {
            ...
            String name = NbBundle.getMessage(CustomSetAsInitialAction.class, "LBL_SetInitalPageAction_SETINITIALVIEWPAGE");
    ...
    private class InitialItemListener implements MenuListener {
        ...
        public void menuSelected(MenuEvent e) {
            ...
            JRadioButtonMenuItem rbViewItem = new JRadioButtonMenuItem(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_VIEWMODE"));
            rbViewItem.addActionListener(actionListener);
            group.add(rbViewItem);
            menu.add(rbViewItem);            
            rbViewItem.setMnemonic(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNE_VIEWMODE").charAt(0));
            
            JRadioButtonMenuItem rbEditItem = new JRadioButtonMenuItem(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_EDITMODE"));
            rbEditItem.addActionListener(actionListener);
            group.add(rbEditItem);
            menu.add(rbEditItem);            
            rbEditItem.setMnemonic(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNE_EDITMODE").charAt(0));
            
            JRadioButtonMenuItem rbHelpItem = new JRadioButtonMenuItem(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_HELPMODE"));
            rbHelpItem.addActionListener(actionListener);
            group.add(rbHelpItem);
            menu.add(rbHelpItem);            
            rbHelpItem.setMnemonic(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNE_HELPMODE").charAt(0));
            
            
            JRadioButtonMenuItem rbNoneItem = new JRadioButtonMenuItem(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNU_NONEMODE"));
            rbNoneItem.addActionListener(actionListener);
            group.add(rbNoneItem);
            menu.add(rbNoneItem);            
            rbNoneItem.setMnemonic(NbBundle.getMessage(CustomSetAsInitialAction.class, "MNE_NONEMODE").charAt(0));
