...
public class PreviewThread extends Thread{
            ...
            public void run() {
                try {
                    Compilation comp = JavaFXModel.getPreviewCompilation(doc);
                    CompilationUnit previewUnit = comp.getCompilationUnit("javafx.netbeans.preview");
//                    System.out.println("[PreviewThread] execute widget");
                    previewUnit.execute();
                } catch(Throwable e) {
                    e.printStackTrace();
                }
