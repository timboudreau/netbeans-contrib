...
/**
 * UnitTestForSourceQuerySupport is a support class for creating
 * a query to find Java package roots of unit tests for Java package root of sources and vice versa.
 * @since org.netbeans.modules.java.api.common/0 1.0
 * @author Tomas Mysik
 * @see MultipleRootsUnitTestForSourceQueryImplementation
 */
public final class UnitTestForSourceQuerySupport {

    private UnitTestForSourceQuerySupport() {
    }
