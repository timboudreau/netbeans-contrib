 ...
 */
public final class JavaEEClassPathProviderImpl implements ClassPathProvider, PropertyChangeListener {
    ...
    public JavaEEClassPathProviderImpl(AntProjectHelper helper, PropertyEvaluator evaluator, SourceRoots sourceRoots,
   ...
   private FileType getType(FileObject file) {
    ...
    public ClassPath findClassPath(FileObject file, String type) {
        ...
        switch (fileType) {
            case WEB_SOURCE:
                // XXX dirty dirty DIRTY hack
                cp = delegate.findClassPath(sourceRoots.getRoots()[0], type);
                break;
            default:
    ...
    public ClassPath[] getProjectClassPaths(String type) {
        if (ClassPath.SOURCE.equals(type)) {
            ...
            sourcePaths.add(0, getSourcePath(FileType.WEB_SOURCE));
    ...
    public static final class Properties {
        ...
        public Properties(String buildClassesDir, String buildTestClassesDir, String distJar, String webDocBaseDir,
            ...
            Parameters.notNull("javaEEPlatformClasspath", javaEEPlatformClasspath);
