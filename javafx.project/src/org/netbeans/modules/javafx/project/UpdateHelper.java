 ...
 * "http://www.netbeans.org/ns/javafx-project/1" to "http://www.netbeans.org/ns/javafx-project/2".
...
public class UpdateHelper {
    ...
    public EditableProperties getProperties (final String path) {
        //Properties are the same in both javafxproject/1 and javafxproject/2
    ...
    public synchronized boolean isCurrent () {
        if (this.isCurrent == null) {
            if ((this.cfg.getConfigurationFragment("data","http://www.netbeans.org/ns/javafx-project/1",true) != null) || 
                (this.cfg.getConfigurationFragment("data","http://www.netbeans.org/ns/javafx-project/2",true) != null)) {
