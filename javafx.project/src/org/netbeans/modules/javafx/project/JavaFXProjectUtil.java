...
/**
 * Miscellaneous utilities for the javafxproject module.
...
public class JavaFXProjectUtil {
    ...
    public static boolean isMainClass (final String className, ClassPath bootPath, ClassPath compilePath, ClassPath sourcePath) {
        ...
        return findMainClass( className , sourcePath ) || 
            findMainClass( className , compilePath ) 
                ||findMainClass( className , bootPath );
    }
    ...
    private static boolean findMainClass( String className, ClassPath sourcePath ) {
        String name = className.replace( '.', '/') +".fx";
        //System.out.println( "Name :" +name );
        return sourcePath.findResource(name)!=null;
    }
}
