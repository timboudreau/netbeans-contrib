...
public class PanelProjectTypesVisual extends SettingsPanel {
    ...
    boolean valid(WizardDescriptor wd) {
        // prohibits the project creation from sources when no sources selected
        boolean filesSelected = ((FolderList)this.sourcePanel).getFiles() != null &&
                                ((FolderList)this.sourcePanel).getFiles().length != 0;      
        return jRadioButton2.isSelected() ? filesSelected : true;
    }
    
    void read (WizardDescriptor wd) {
        this.wizardDescriptor = wd;
        File projectLocationFO = (File) wd.getProperty ("projdir");         //NOI18N
        ((FolderList)this.sourcePanel).setProjectFolder(projectLocationFO);
    ...
    private void initComponents() {
        ...
        sourcePanel.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                sourcePanelPropertyChange(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
...
private void projectTypeChanged(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_projectTypeChanged
    ...
    this.optionsPanel.fireChangeEvent();    
...
private void sourcePanelPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_sourcePanelPropertyChange
    this.optionsPanel.fireChangeEvent();    
}//GEN-LAST:event_sourcePanelPropertyChange
