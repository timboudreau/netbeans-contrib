...
public class CustomizerLibraries extends JPanel implements HelpCtx.Provider, ListDataListener {
    ...
    public CustomizerLibraries( JavaFXProjectProperties uiProperties, CustomizerProviderImpl.SubCategoryProvider subcat ) {
        ...
        testBroken();
        if (JavaFXCompositePanelProvider.LIBRARIES.equals(subcat.getCategory())) {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, java.util.ResourceBundle.getBundle("org/netbeans/modules/javafx/project/ui/customizer/Bundle").getString("MSG_CustomizerLibraries_CompileCpMessage"));
        gridBagConstraints = new java.awt.GridBagConstraints();
