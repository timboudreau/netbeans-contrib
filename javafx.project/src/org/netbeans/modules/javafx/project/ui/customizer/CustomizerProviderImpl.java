...
public class CustomizerProviderImpl implements CustomizerProvider {
    ...
    public static final String CUSTOMIZER_FOLDER_PATH = "Projects/org-netbeans-modules-javafx-project/Customizer"; //NO18N
    
    private static Map /*<Project,Dialog>*/project2Dialog = new HashMap(); 
    
    public CustomizerProviderImpl(Project project, UpdateHelper updateHelper, 
