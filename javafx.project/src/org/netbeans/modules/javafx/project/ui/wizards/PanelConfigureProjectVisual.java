...
public class PanelConfigureProjectVisual extends JPanel {
    ...
    boolean valid( WizardDescriptor wizardDescriptor ) {
        ...
        return projectLocationPanel.valid( wizardDescriptor ) && optionsPanel.valid(wizardDescriptor) && projectTypesPanel.valid(wizardDescriptor);
    }
    ...
    private void initComponents() {
        ...
        projecttypesContainer = new javax.swing.JPanel();
        ...
        projecttypesContainer.setLayout(new java.awt.BorderLayout());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        add(projecttypesContainer, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.REMAINDER;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
    ...
    private javax.swing.JPanel projecttypesContainer;
