...
//        JavaFXProjectProperties.JAVAC_TEST_CLASSPATH,
     ...
     */
    private final class JavaFXLogicalViewRootNode extends AbstractNode implements Runnable, FileStatusListener, ChangeListener, PropertyChangeListener {
        ...
        public HelpCtx getHelpCtx() {
            return new HelpCtx(JavaFXLogicalViewRootNode.class);
        }
