...
/**
 * Factory for simple JavaFX projects.
 * @author ads
 */
public final class JavaFXProjectType implements AntBasedProjectType {

    public static final     String TYPE     
                            = "org.netbeans.modules.javafx.project";                 // NOI18N
    private static final    String PROJECT_CONFIGURATION_NAME 
                            = "data";                                                // NOI18N
    public static final     String PROJECT_CONFIGURATION_NAMESPACE 
                            = "http://www.netbeans.org/ns/javafx-project/3";         // NOI18N
    private static final    String PRIVATE_CONFIGURATION_NAME 
                            = "data"; // NOI18N
    ...
    public Project createProject(AntProjectHelper helper) throws IOException {
        return new JavaFXProject(helper);
    }
