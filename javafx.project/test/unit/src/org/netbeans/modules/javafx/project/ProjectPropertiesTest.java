...
public class ProjectPropertiesTest extends NbTestCase {

    public ProjectPropertiesTest(String name) {
        super(name);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        clearWorkDir();
        JavaFXProjectGenerator.createProject(getWorkDir(), "test", null, null);
