 ...
 */
class ClassTypeList extends AbstractList<JavaFXClassType> {
    
    private JavaFXDebuggerImpl debugger;
    private List<ReferenceType> classes;
    
    /** Creates a new instance of ClassTypeList */
    ClassTypeList(JavaFXDebuggerImpl debugger, List<ReferenceType> classes) {
    ...
    public JavaFXClassType get(int i) {
