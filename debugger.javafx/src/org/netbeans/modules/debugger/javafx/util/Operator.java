...
public class Operator {
    ...
    */
    public Operator (
        ...
        final JavaFXDebuggerImpl debugger,
        Executor starter,
        Runnable finalizer,
       ...
       loop: for (;;) {
                 try {
                     ...
                     JavaFXThreadImpl suspendedThread = null;
                     ...
                     if (suspendPolicy == EventRequest.SUSPEND_EVENT_THREAD) {
                         ...
                         if (tref != null && !silent) {
                            suspendedThread = ((JavaFXThreadImpl) debugger.getThread(tref));
...
//                                 disconnected = true;
                     ...
                     if (!silent && !resume) { // Check for multiply-suspended threads
                         synchronized (resumeLock) {
                             ...
                             for (ThreadReference t : threads) {
                                 JavaFXThreadImpl jt = (JavaFXThreadImpl) debugger.getExistingThread(t);
    ...
    /**
    * Starts checking of JavaFX messages.
    */
    public void start () {
        thread.start ();
    }
