 ...
 */
 ...
 /*@bgen(jjtree) ArrayDimsAndInits */
  ...
  public JavaFXParserTokenManager token_source;
  ...
  public JavaFXParser(java.io.InputStream stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new JavaFXParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public JavaFXParser(java.io.Reader stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new JavaFXParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  public JavaFXParser(JavaFXParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(JavaFXParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
