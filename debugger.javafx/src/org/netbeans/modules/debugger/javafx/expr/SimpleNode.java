...
class SimpleNode implements Node {
  ...
  /** Accept the visitor. **/
  public Object jjtAccept(JavaFXParserVisitor visitor, Object data) {
  ...
  public String toString() { return JavaFXParserTreeConstants.jjtNodeName[id]; }
  ...
  public void dump(String prefix) {
    ...
    */
    ...
    private List<Object> getAttributeList(String name) {
        getAttributeMap();
        List<Object> list = (List<Object>) attributes.get(name);
        if (list == null) {
