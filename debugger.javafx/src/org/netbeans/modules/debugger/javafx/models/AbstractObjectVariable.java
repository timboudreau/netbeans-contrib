...
class AbstractObjectVariable extends AbstractVariable implements ObjectVariable {
    ...
    AbstractObjectVariable (JavaFXDebuggerImpl debugger, Value value, String genericSignature,
                      String id) {
    ...
    */
    ...
    static String getToStringValue (Value v, JavaFXDebuggerImpl debugger) throws InvalidExpressionException {
    ...
    org.netbeans.api.debugger.javafx.Field getField (
        com.sun.jdi.Field f, 
        ObjectReference or, 
        String parentID
    ) {
    ...
    private class DebuggetStateListener extends Object implements PropertyChangeListener {
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            if (JavaFXDebugger.PROP_STATE.equals(evt.getPropertyName())) {
                Object newValue = evt.getNewValue();
                if (newValue instanceof Integer &&
                    JavaFXDebugger.STATE_RUNNING == ((Integer) newValue).intValue()) {
