...
public class CallStackTreeModel implements TreeModel {
    ...
    throws UnknownTypeException {
        if ( parent.equals (ROOT) ||
             (parent instanceof JavaFXThread) 
        ) {
            // 1) get Thread
            JavaFXThread thread;
            if (parent.equals (ROOT)) {
    ...
    /**
     * Listens on JavaFXDebugger on PROP_STATE
     */
    private static class Listener implements PropertyChangeListener {
        ...
        public Listener (
            ...
            JavaFXThreadImpl lastCurrentThread = (JavaFXThreadImpl) debugger.getCurrentThread();
        ...
        public synchronized void propertyChange (PropertyChangeEvent e) {
            ...
            if (propertyName == JavaFXThreadImpl.PROP_SUSPENDED
