...
public class CallStackFrameImpl implements CallStackFrame {
    ...
    */
     ...
     */
    public org.netbeans.api.debugger.javafx.LocalVariable[] getLocalVariables () 
     ...
     */
    org.netbeans.api.debugger.javafx.LocalVariable getLocalVariable(String name) 
    throws AbsentInformationException {
        try {
            String className = getStackFrame ().location ().declaringType ().name ();
    ...
    List<LocalVariable> findOperationArguments(Operation operation) {
        ...
        JavaFXThreadImpl thread = (JavaFXThreadImpl) getThread();
     ...
     *
     * @see org.netbeans.api.debugger.javafx.JavaFXDebugger#getCurrentCallStackFrame
     */
