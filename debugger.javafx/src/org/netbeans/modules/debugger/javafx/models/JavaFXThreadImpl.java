...
/**
 * The implementation of JavaFXThread.
 */
public final class JavaFXThreadImpl implements JavaFXThread, Customizer {
    ...
    */
        ...
        try {
            ...
            ErrorManager.getDefault().notify(
                    ErrorManager.getDefault().annotate(nmex,
                        NbBundle.getMessage(JavaFXThreadImpl.class, "MSG_NativeMethodPop")));
     ...
     *
     * @see JavaFXDebugger#getCurrentThread
     */
