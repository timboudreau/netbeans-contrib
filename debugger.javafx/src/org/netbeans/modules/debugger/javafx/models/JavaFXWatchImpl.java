...
class JavaFXWatchImpl extends AbstractVariable implements JavaFXWatch {
    ...
    JavaFXWatchImpl (JavaFXDebuggerImpl debugger, Watch watch, PrimitiveValue v, Object node) {
        super (
            debugger,
            v, 
            "" + watch +
    ...
    *
    ...
    public JavaFXWatchImpl clone() {
        JavaFXWatchImpl clon;
        if (exceptionDescription == null) {
            clon = new JavaFXWatchImpl(getDebugger(), watch, (PrimitiveValue) getJDIValue(), nodeRef.get());
        } else {
            clon = new JavaFXWatchImpl(getDebugger(), watch, new Exception(exceptionDescription), nodeRef.get());
        }
        return clon;
    }
