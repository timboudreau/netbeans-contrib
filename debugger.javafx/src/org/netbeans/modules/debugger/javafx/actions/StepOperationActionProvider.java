...
public class StepOperationActionProvider extends ActionsProviderSupport
    ...
    public StepOperationActionProvider (ContextProvider lookupProvider) {
        ...
        debugger.addPropertyChangeListener (JavaFXDebugger.PROP_STATE, this);
    }
    
    private void destroy () {
        debugger.removePropertyChangeListener (JavaFXDebugger.PROP_STATE, this);
    }
    ...
    public void doAction (Object action) {
        JavaFXStep step = debugger.createJavaFXStep(JavaFXStep.STEP_OPERATION, JavaFXStep.STEP_OVER);
