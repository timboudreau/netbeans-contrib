...
*/
public class PauseActionProvider extends JavaFXDebuggerActionProvider {
    ...
    public void doAction (Object action) {
        doingAction = true;
        try {
            ((JavaFXDebuggerImpl) getDebuggerImpl ()).suspend ();
        } finally {
            doingAction = false;
        }
    }
    ...
    protected void checkEnabled (int debuggerState) {
        setEnabled (
            ...
            debuggerState == JavaFXDebugger.STATE_RUNNING
        );
    }
