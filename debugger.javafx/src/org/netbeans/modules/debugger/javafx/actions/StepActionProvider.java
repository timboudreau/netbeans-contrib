...
import org.netbeans.modules.debugger.javafx.ExpressionPool;
import org.netbeans.modules.debugger.javafx.JavaFXDebuggerImpl;
import org.netbeans.modules.debugger.javafx.JavaFXStepImpl.MethodExitBreakpointListener;
...
/**
 * Implements non visual part of stepping through code in JavaFX debugger.
 * It supports standart debugging actions StepInto, Over, Out, RunToCursor, 
 * and Go. And advanced "smart tracing" action.
 *
 * @author  Jan Jancura
 */
public class StepActionProvider extends JavaFXDebuggerActionProvider 
implements Executor {
    ...
    private static Logger logger = Logger.getLogger("org.netbeans.modules.debugger.javafx.jdievents"); // NOI18N
    ...
    public void runAction(final Object action) {
        synchronized (getDebuggerImpl ().LOCK) {
            ...
            try {
                ...
                JavaFXThreadImpl resumeThread = (JavaFXThreadImpl) getDebuggerImpl().getCurrentThread();
                ...
                // 3) resume JVM
                if (suspendPolicy == JavaFXDebugger.SUSPEND_EVENT_THREAD) {
    ...
    private void addMethodExitBP(ThreadReference tr, JavaFXThread jtr) {
        ...
        mb.setThreadFilters(getDebuggerImpl(), new JavaFXThread[] { jtr });
    ...
    private void setLastOperation(ThreadReference tr) {
        ...
        JavaFXThreadImpl jtr = (JavaFXThreadImpl) getDebuggerImpl().getThread(tr);
