...
public class SolBookEditorSupport extends DataEditorSupport implements EditorCookie, OpenCookie, CloseCookie, PrintCookie {
    private static final String IMG_TEMPLATE =
            "\n <figure id=\"$ID\">\n" + //NOI18N
            "       <title>$TITLE</title>\n" + //NOI18N
            "       <mediaobject>\n" + //NOI18N
            "           <imageobject>\n" + //NOI18N
            "               <imagedata entityref=\"$FILENAME\"/>\n" + //NOI18N
            "           </imageobject>\n" + //NOI18N
            "           <textobject>\n" + //NOI18N
            "               <simpara>XXX objectdescription</simpara>\n" + //NOI18N
            "           </textobject>\n" + //NOI18N
            "       </mediaobject>\n" + //NOI18N
            " </figure>\n";
                
          
    public SolBookEditorSupport(SolBookDataObject obj) {
    ...
    protected boolean notifyModified() {
        ...
        SolBookDataObject obj = (SolBookDataObject)getDataObject();
    ...
    private void refreshAnnotations() {
        ...
        if (serv != null) {
            serv.enqueue(new AnnotationCallback(this,
                    (SolBookDataObject) getDataObject()));
        }
    }
    ...
    private static class DocBookEnv extends DataEditorSupport.Env {
        ...
        public DocBookEnv(SolBookDataObject obj) {
            super(obj);
        }
        ...
        protected FileLock takeLock() throws IOException {
            return ((SolBookDataObject)getDataObject()).getPrimaryEntry().takeLock();
        }

        public CloneableOpenSupport findCloneableOpenSupport() {
            return getDataObject().getCookie(SolBookEditorSupport.class);
        }
    }
    ...
    private static final class AnnotationCallback extends ContentHandlerCallback implements Runnable {
        private final SolBookEditorSupport editor;

        public AnnotationCallback (SolBookEditorSupport editor, SolBookDataObject dob) {
    ...
    private static final class H extends DefaultHandler implements ErrorHandler {
        private final SolBookDataObject dob;
        private Locator loc;
        private final Set <Ann> annotations;
        H (SolBookDataObject dob, Set <Ann> annotations) {
            this.dob = dob;
    ...
    private static final class Ann extends Annotation implements Comparable {
        ...
        public String getAnnotationType() {
            return warn ? "org-netbeans-modules-solbook-warning" : //NOI18N
                "org-netbeans-modules-solbook-error"; //NOI18N
        }
