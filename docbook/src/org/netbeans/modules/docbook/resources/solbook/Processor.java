...
class Processor implements Runnable, ErrorListener, ErrorHandler {
    ...
    private final SolBookDataObject o;
    private final Renderer.JobStatus status;
    Processor(SolBookDataObject o) {
        this(o, null, null);
    }

    Processor(SolBookDataObject o, FileObject destFolder, Renderer.JobStatus status) {
        this.o = o;
        assert o != null;
    ...
    private void process(SolBookDataObject o, FileObject destFolder) {
        ...
        if (mime.equals(SolBookDataLoader.MIME_SOLBOOK)) {
                ...
                try {
                    ...
                    EntityResolver resolver = new SolBookCatalog.Reader();
