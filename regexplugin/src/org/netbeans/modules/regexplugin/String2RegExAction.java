 ...
 * @author Angad
 */
class String2RegExAction extends AbstractAction
{
    /**
     * Icon to displayed against this action.
     */
    //static final private ImageIcon icon =
//            new ImageIcon(ClassLoader.getSystemResource("images/arrow_left.png"));
     ...
     */
    public String2RegExAction(JTextComponent comp, ImageIcon icon)
    {
        super("Convert Java String to Regular Expression" ,icon);
        this.comp = comp;
    }
