 ...
 * @author Jan Lahoda
 */
public class SectionStructuralElementBeanInfo extends SimpleBeanInfo {

    // Bean descriptor //GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( SectionStructuralElement.class , null );//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_type] = new PropertyDescriptor ( "type", SectionStructuralElement.class, "getType", null );
