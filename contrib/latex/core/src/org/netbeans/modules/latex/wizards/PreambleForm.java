...
public class PreambleForm extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        documentClassCombo.setModel(new DefaultComboBoxModel(Storage.getDefault().getAllDocumentClasses(false).toArray()));
        ...
        inputEncoding.setModel(new DefaultComboBoxModel(Storage.getDefault().getOptions(Storage.getDefault().getInputEncPackageName()).toArray()));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
    ...
    private void adjustTo(String docclass) {
        optionsList.setListData(Storage.getDefault().getOptions(docclass).toArray());
        fontSizes.setModel(new DefaultComboBoxModel(Storage.getDefault().getSupportedFontSizes(docclass).toArray()));
        paperSizes.setModel(new DefaultComboBoxModel(Storage.getDefault().getSupportedPaperSizes(docclass).toArray()));
    }
    
    public String getDocumentClass() {
        return documentClassCombo.getSelectedItem().toString();
    }
    
    public void setDocumentClass(String docclass) {
        documentClassCombo.setSelectedItem(docclass); //!!!
    }
    
    public String getFontSize() {
        return fontSizes.getSelectedItem().toString();
    }
    
    public void setFontSize(String fontSizeVal) {
        fontSizes.setSelectedItem(fontSizeVal); //!!!
    }
    
    public String getPaperSize() {
        return paperSizes.getSelectedItem().toString();
    }
    
    public void setPaperSize(String paperSizeVal) {
        paperSizes.setSelectedItem(paperSizeVal);  //!!!!
    }
    
    public String getInputEnc() {
        return inputEncoding.getSelectedItem().toString();
    }
    
    public void setInputEnc(String inputEncVal) {
        inputEncoding.setSelectedItem(inputEncVal);
    }
    ...
    public String[] getOptions() {
        ...
        for (int cntr = 0; cntr < options.length; cntr++) {
            result[cntr] = options[cntr].toString();
        }
