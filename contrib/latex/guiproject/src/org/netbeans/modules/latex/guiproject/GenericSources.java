...
public class GenericSources {
     ...
     */
    public static Sources genericOnly(LaTeXGUIProject p) {
        return new GenericOnlySources(p);
    }
    
    private static final class GenericOnlySources implements Sources {
        
        private final LaTeXGUIProject p;
        
        GenericOnlySources(LaTeXGUIProject p) {
            this.p = p;
        }
        ...
        public SourceGroup[] getSourceGroups(String type) {
            if (type.equals(Sources.TYPE_GENERIC)) {
                return new SourceGroup[] {
                    group(p, p.getProjectDirectory().getParent(), "generic", // NOI18N
     ...
     */
    public static SourceGroup group(LaTeXGUIProject p, FileObject rootFolder, String name, String displayName, Icon icon, Icon openedIcon) {
    ...
    private static final class Group implements SourceGroup {
        ...
        Group(LaTeXGUIProject p, FileObject rootFolder, String name, String displayName, Icon icon, Icon openedIcon) {
            this.p = p;
