 ...
 * @author Jan Lahoda
 */
public final class LaTeXNavigatorFactory extends LookupBasedSourceTaskFactory {
    
    private CancellableTask<CompilationInfo> task;
    
    static LaTeXNavigatorFactory getInstance() {
        return Lookup.getDefault().lookup(LaTeXNavigatorFactory.class);
    }
    
    public LaTeXNavigatorFactory() {
