 ...
 * @author Satyaranjan
 */
public class RubyPortletDDHelper {
    ...
    public RubyPortletDDHelper(File inDDFile) {
        ddFile = inDDFile;
    ...
    public static boolean isRubyPortletEntryPresent(PortletApp portletApp) {
        ...
        for (PortletType portletType : portletTypes) {
            ...
            for (InitParamType ip : intParams) {
                if (ip.getName().equals(RubyPortletConstants.GLOBAL_FILES) || ip.getName().equals(RubyPortletConstants.ACTION_URI)) {
                    return true;
                }
            }
        }
