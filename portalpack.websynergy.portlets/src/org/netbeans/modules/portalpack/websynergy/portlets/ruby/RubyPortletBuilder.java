 ...
 * @author satyaranjan
 */
public class RubyPortletBuilder extends NonJavaPortletBuilder implements RubyPortletConstants{
    
    public static Logger logger = Logger.getLogger(NonJavaPortletConstants.NON_JAVA_PORTLET_LOGGER);

    public String getPortletType() {
        return NbBundle.getMessage(RubyPortletBuilder.class, "RUBY_PORTLET_TYPE");
    }

    public String getPortletTypeDesc() {
        return NbBundle.getMessage(RubyPortletBuilder.class, "RUBY_PORTLET_TYPE_DESC");
    }
    ...
    public String getRelativePageRoot() {
        return "WEB-INF" + File.separator + "ruby";
    }
    
    @Override
    public boolean isPortletOfType(PortletType portlet) {
        return RubyPortletDDHelper.isRubyPortlet(portlet);
    }
    ...
    public Set handleCreate(TemplateWizard wizard,boolean isNewPortlet) {
       ...
       //// DataObject dTemplate = DataObject.find(template);
        ...
        if(actionTemplate == null) {
            try {
                templateUtil.createFileFromTemplate("Action.template", dir, actionRbName, "rb");
            } catch (TemplateNotFoundException ex) {
                logger.log(Level.SEVERE,"",ex);
            }
        }
        ...
        addRubyPortlet(project,context, rubyFolderRelativePath + viewRuby,rubyFolderRelativePath + actionRbName + ".rb",globalfiles);
    ...
    private void addRubyPortlet(Project project, PortletContext pc, String viewPhp,String actionRb,String[] globalfiles) {
        ...
        //if (!RubyPortletDDHelper.isRubyPortletEntryPresent(portletApp)) {
            ...
            portletType.setPortletClass(RubyPortletConstants.RUBY_PORTLET_CLASS); //NOI18N
            ...
            RubyPortletProjectUtil.addRubyLibrary(webModule);
