...
public abstract class ConfigPanel extends JPanel {
    ...
    public final void readSettings(WizardDescriptor wizardDescriptor) {
        read(wizardDescriptor);
    }

    public final void writeSettings(WizardDescriptor wizardDescriptor) {
        store(wizardDescriptor);
    }
     ...
     */
    public abstract boolean validate(WizardDescriptor wizardDescriptor);
    ...
    public void setErrorMessage(WizardDescriptor wizardDescriptor,String msg) {
        wizardDescriptor.putProperty("WizardPanel_errorMessage",msg);
    }
}
