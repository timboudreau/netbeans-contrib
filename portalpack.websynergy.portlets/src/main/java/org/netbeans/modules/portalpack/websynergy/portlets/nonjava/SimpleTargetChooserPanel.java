...
final class SimpleTargetChooserPanel implements WizardDescriptor.Panel, ChangeListener {
    ...
    public void readSettings( Object settings ) {
        ...
        NonJavaPortletBuilder builder = 
            (NonJavaPortletBuilder)wizard.getProperty(NonJavaPortletConstants.PORTLET_BUILDER);
        
        String relativePageRoot = builder.getRelativePageRoot();
        ...
        // Init values
        gui.initValues( Templates.getTemplate( wizard ), preselectedTarget, relativePageRoot, targetName );
