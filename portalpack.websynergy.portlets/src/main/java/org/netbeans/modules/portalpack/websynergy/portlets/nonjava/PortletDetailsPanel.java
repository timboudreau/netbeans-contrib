...
public class PortletDetailsPanel implements WizardDescriptor.Panel, ChangeListener {
    ...
    public boolean isPortletOfTypeExists() {
        ...
        NonJavaPortletBuilder builder = (NonJavaPortletBuilder) wizardDescriptor.getProperty(NonJavaPortletConstants.PORTLET_BUILDER);
        ...
        try {
            ...
            for (PortletType portlet : portlets) {
                if (builder.isPortletOfType(portlet)) {
                    return true;
                }
            }
