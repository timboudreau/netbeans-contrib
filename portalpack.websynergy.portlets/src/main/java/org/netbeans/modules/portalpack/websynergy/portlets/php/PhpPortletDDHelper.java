 ...
 * @author satyaranjan
 */
public class PhpPortletDDHelper {

     public static boolean isPhpPortlet(PortletType portlet) {
        
        if(portlet.getPortletClass().equals(PhpPortletConstants.PHP_PORTLET_CLASS))
            return true;
