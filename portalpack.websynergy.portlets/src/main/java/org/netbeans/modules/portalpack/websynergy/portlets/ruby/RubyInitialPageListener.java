 ...
 * @author satyaranjan
 */
public class RubyInitialPageListener 
                implements InitialPageListener,RubyPortletConstants {
    ...
    public String initViewPage(PortletType portlet) {
        return getInitialPageFor(portlet, VIEW_URI);
    }

    public String initEditPage(PortletType portlet) {
        return getInitialPageFor(portlet, EDIT_URI);
    }

    public String initHelpPage(PortletType portlet) {
        return getInitialPageFor(portlet, HELP_URI);
    }
