...
package org.netbeans.modules.remotesfs;
 ...
 */
public class MemoryFileSystem extends AbstractFileSystem implements AbstractFileSystem.Info, AbstractFileSystem.Change, AbstractFileSystem.List, AbstractFileSystem.Attr {

    private static final Logger ERR = Logger.getLogger(MemoryFileSystem.class.getName());
    private static MemoryFileSystem instance;
    ...
    /**
     * Returns the singleton instance. But this method does NOT create
     * the instance - it must have been installed using the system
     * property or constructor directly.
     * @return The instance used by the system (if it has been initialized)
     * @throws IllegalStateException if the instance has not been installed.
     */
    public static MemoryFileSystem getInstance() {
        if (instance == null) {
            throw new IllegalStateException(
                "The MemoryFileSystem instance has not yet been initialized.\n" + // NOI18N
                "Do you have following in your master.jnlp file?:\n" + // NOI18N
                "<property name=\"org.netbeans.core.systemfilesystem.custom\" " + // NOI18N
                "value==\"org.netbeans.modules.remotesfs.MemoryFileSystem\"/>" + // NOI18N
                "<property name=\"netbeans.user\" value=\"memory\"/>\n" + // NOI18N
                "(the second property defined BELLOW the generated resources!)."); // NOI18N
        }
        return instance;
    }
    ...
    public MemoryFileSystem() {
        if (instance == null) {
            ...
            ERR.log(Level.FINE, 
                "More instances of MemoryFileSystem are being created.", // NOI18N
                new Exception());
        }
        attr = this;
        list = this;
    ...
    private boolean isValidEntry(String n, Boolean expectedResult) {
        ...
        if (ERR.isLoggable(Level.FINE) && expectedResult != null && retval != expectedResult.booleanValue()) {
            logMessage("entry: " + x + " isValidReference.fo: " + ((fo == null) ? "null" : (fo.isValid() ? "valid" : "invalid"))); //NOI18N
        }
