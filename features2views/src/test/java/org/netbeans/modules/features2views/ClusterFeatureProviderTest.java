 ...
 */
public class ClusterFeatureProviderTest extends NbTestCase {

    public ClusterFeatureProviderTest (String testName) {
        super (testName);
    }

    public void testGetName () {
        ClusterFeatureProvider instance = new ClusterFeatureProvider ();
        String expResult = "clusters2features-provider";
