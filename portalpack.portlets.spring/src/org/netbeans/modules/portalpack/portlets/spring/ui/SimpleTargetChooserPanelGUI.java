...
/**
 *
 * @author  Po-Ting Wu, phrebejk, Satyaranjan
 */
public class SimpleTargetChooserPanelGUI extends javax.swing.JPanel implements ActionListener, DocumentListener {
    ...
    public void initValues(FileObject template, FileObject preselectedFolder) {
        initValues(template, preselectedFolder, null, null);
    }

    public void initValues( FileObject template, FileObject preselectedFolder, String relativePageRoot, String documentName ) {
        assert project != null;
        ...
        if(relativePageRoot == null || relativePageRoot.length() == 0)
            folderTextField.setText( getRelativeNativeName( preselectedGroup.getRootFolder(), preselectedFolder )); //NOI18N
        else
            folderTextField.setText( getRelativeNativeName( preselectedGroup.getRootFolder(), preselectedFolder ) + File.separator + relativePageRoot); //NOI18N
        ...
        if (isFolder) {
            filenameLabel.setText (NbBundle.getMessage(SimpleTargetChooserPanelGUI.class, "LBL_TargetChooser_FolderName_Label")); // NOI18N
            filenameLabel.setDisplayedMnemonic (NbBundle.getMessage (SimpleTargetChooserPanelGUI.class, "MNE_TargetChooser_FolderName_Label").charAt (0)); // NOI18N
            ...
            filenameLabel.setText (NbBundle.getMessage(SimpleTargetChooserPanelGUI.class, "LBL_TargetChooser_FileName_Label")); // NOI18N
            ...
            filenameLabel.setDisplayedMnemonic (NbBundle.getMessage (SimpleTargetChooserPanelGUI.class, "MNE_TargetChooser_FileName_Label").charAt (0)); // NOI18N
    ...
    private void initComponents() {
        ...
        filenameLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/portalpack/portlets/spring/ui/Bundle").getString("MNE_TargetChooser_FileName_Label").charAt(0));
        filenameLabel.setLabelFor(documentNameTextField);
        filenameLabel.setText(org.openide.util.NbBundle.getMessage(SimpleTargetChooserPanelGUI.class, "LBL_TargetChooser_FileName_Label")); // NOI18N
        ...
        jLabel1.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/portalpack/portlets/spring/ui/Bundle").getString("MNE_TargetChooser_Project_Label").charAt(0));
        jLabel1.setLabelFor(projectTextField);
        jLabel1.setText(org.openide.util.NbBundle.getMessage(SimpleTargetChooserPanelGUI.class, "LBL_TargetChooser_Project_Label")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        locationLabel.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/portalpack/portlets/spring/ui/Bundle").getString("MNE_TargetChooser_Location_Label").charAt(0));
        ...
        jLabel2.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/portalpack/portlets/spring/ui/Bundle").getString("MNE_TargetChooser_FolderName_Label").charAt(0));
        ...
        browseButton.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/portalpack/portlets/spring/ui/Bundle").getString("MNE_TargetChooser_Browse_Button").charAt(0));
        ...
        jLabel4.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/portalpack/portlets/spring/ui/Bundle").getString("MNE_TargetChooser_CreatedFile_Label").charAt(0));
