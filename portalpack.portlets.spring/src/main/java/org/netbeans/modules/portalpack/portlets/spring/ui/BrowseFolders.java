...
public class BrowseFolders extends javax.swing.JPanel implements ExplorerManager.Provider {
    ...
    private void initComponents() {
        ...
        jLabel1.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/portalpack/portlets/spring/ui/Bundle").getString("LBL_BrowseFolders_jLabel1").charAt(0));
