...
import org.netbeans.api.debugger.javafx.LaunchingDICookie;
 ...
 * {@link org.netbeans.api.debugger.javafx.JavaFXDebugger#PROP_STATE}
...
PropertyChangeListener {
    ...
    public void propertyChange (java.beans.PropertyChangeEvent evt) {
        ...
        if (debuggerState == JavaFXDebugger.STATE_STARTING) {
...
//                where,
        ...
        if (debuggerState == JavaFXDebugger.STATE_DISCONNECTED) {
            Throwable e = null;
            try {
                synchronized (this) {
                    if (debugger != null) {
        ...
        if (debuggerState == JavaFXDebugger.STATE_STOPPED) {
