...
public class WatchesNodeModel extends VariablesNodeModel {
    ...
    public String getDisplayName (Object o) throws UnknownTypeException {
        ...
        if (o instanceof JavaFXWatch) {
            /*if (isEmptyWatch(o)) {
                return "<html><font color=\"#808080\">&lt;Enter new watch&gt;</font></html>";
            }*/
            return ((JavaFXWatch) o).getExpression ();
        }
    ...
    protected void testKnown(Object o) throws UnknownTypeException {
        if (o instanceof JavaFXWatch) return ;
        super.testKnown(o);
    }
    
    public boolean canRename(Object node) throws UnknownTypeException {
        return false;//(node instanceof JavaFXWatch);
    }

    public boolean canCopy(Object node) throws UnknownTypeException {
        return (node instanceof JavaFXWatch) && !isEmptyWatch(node);
    }
    ...
    public Transferable clipboardCopy(Object node) throws IOException,
        ...
        return new StringSelection(((JavaFXWatch) node).getExpression());
    }
    ...
    public PasteType[] getPasteTypes(final Object node, final Transferable t) throws UnknownTypeException {
        if (node != TreeModel.ROOT && !(node instanceof JavaFXWatch)) {
            return null;
        }
            ...
            return new PasteType[] { new PasteType() {
                ...
                public Transferable paste() {
                    try {
                        ...
                        cb.flip();
                        if (node instanceof JavaFXWatch) {
                            ((JavaFXWatch) node).setExpression(cb.toString());
    ...
    public void setName(Object node, String name) throws UnknownTypeException {
        ((JavaFXWatch) node).setExpression(name);
    }
