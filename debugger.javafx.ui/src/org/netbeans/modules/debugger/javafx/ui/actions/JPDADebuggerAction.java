...
*/
abstract class JavaFXDebuggerAction extends ActionsProviderSupport implements
PropertyChangeListener {

    private JavaFXDebugger debugger;

    JavaFXDebuggerAction (JavaFXDebugger debugger) {
    ...
    JavaFXDebugger getDebuggerImpl () {
        return debugger;
    }
}
