...
* @author   Jan Jancura
*/
public class MakeCallerCurrentActionProvider extends JavaFXDebuggerAction {
    ...
    public MakeCallerCurrentActionProvider (ContextProvider lookupProvider) {
        super (
            lookupProvider.lookupFirst(null, JavaFXDebugger.class)
        );
        this.lookupProvider = lookupProvider;
        getDebuggerImpl ().addPropertyChangeListener 
            (JavaFXDebugger.PROP_CURRENT_CALL_STACK_FRAME, this);
    }
    ...
    static int getCurrentCallStackFrameIndex (JavaFXDebugger debuggerImpl) {
        try {
            JavaFXThread t = debuggerImpl.getCurrentThread ();
            if (t == null) return -1;
