...
//    
    ...
    void fireNodeChanged (JavaFXBreakpoint b) {
        Vector v = (Vector) listeners.clone ();
        int i, k = v.size ();
        for (i = 0; i < k; i++)
    ...
    private JavaFXBreakpoint currentBreakpoint;
    private String bold (JavaFXBreakpoint b, String name) {
    ...
    public void setCurrentBreakpoint (JavaFXBreakpoint currentBreakpoint) {
        JavaFXBreakpoint oldCurrentBreakpoint = this.currentBreakpoint;
