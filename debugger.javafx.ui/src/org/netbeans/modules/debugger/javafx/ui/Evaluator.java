...
import org.netbeans.modules.debugger.javafx.ui.models.WatchesNodeModel;
...
public class Evaluator extends javax.swing.JPanel {
    ...
    public Evaluator(JavaFXDebugger debugger) {
    ...
    private void setDebugger(JavaFXDebugger debugger) {
        this.debugger = debugger;
        this.csfListener = new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                if (JavaFXDebugger.PROP_CURRENT_CALL_STACK_FRAME.equals(evt.getPropertyName())) {
    ...
    public static void open(JavaFXDebugger debugger) {
        if (evalDialog != null) {
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if (currentSession != null && "JavaFX".equals(currentSession.getCurrentLanguage())) {
                if (autoClosed) {
                    ...
                    if (de == null) return ;
                    JavaFXDebugger debugger = de.lookupFirst(null, JavaFXDebugger.class);
    ...
    /**
     * Inspired by org.netbeans.modules.debugger.javafx.ui.views.ViewModelListener.
     */
