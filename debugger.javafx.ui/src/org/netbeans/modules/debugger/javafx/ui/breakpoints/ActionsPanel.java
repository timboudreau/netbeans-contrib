...
public class ActionsPanel extends javax.swing.JPanel {
    ...
    public ActionsPanel (JavaFXBreakpoint b) {
        breakpoint = b;
        initComponents ();

        cbSuspend.addItem (java.util.ResourceBundle.getBundle("org/netbeans/modules/debugger/javafx/ui/breakpoints/Bundle").getString("LBL_CB_Actions_Panel_Suspend_None"));
        cbSuspend.addItem (java.util.ResourceBundle.getBundle("org/netbeans/modules/debugger/javafx/ui/breakpoints/Bundle").getString("LBL_CB_Actions_Panel_Suspend_Current"));
        cbSuspend.addItem (java.util.ResourceBundle.getBundle("org/netbeans/modules/debugger/javafx/ui/breakpoints/Bundle").getString("LBL_CB_Actions_Panel_Suspend_All"));
        switch (b.getSuspend ()) {
            case JavaFXBreakpoint.SUSPEND_NONE:
                cbSuspend.setSelectedIndex (0);
                break;
            case JavaFXBreakpoint.SUSPEND_EVENT_THREAD:
                cbSuspend.setSelectedIndex (1);
                break;
            case JavaFXBreakpoint.SUSPEND_ALL:
    ...
    public void ok () {
        ...
        switch (cbSuspend.getSelectedIndex ()) {
            case 0:
                breakpoint.setSuspend (JavaFXBreakpoint.SUSPEND_NONE);
                break;
            case 1:
                breakpoint.setSuspend (JavaFXBreakpoint.SUSPEND_EVENT_THREAD);
                break;
            case 2:
                breakpoint.setSuspend (JavaFXBreakpoint.SUSPEND_ALL);
                break;
        }
    }
