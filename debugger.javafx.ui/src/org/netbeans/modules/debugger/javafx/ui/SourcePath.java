 ...
 *
 * @see Similar class in debuggerjavafx when modifying this.
 *
 * @author Jan Jancura
 */
public class SourcePath {
    ...
    private static List annotateOperations(JavaFXDebugger debugger, String url,
    ...
    private static Object createAnnotation(JavaFXDebugger debugger, String url,
