...
/**
 * WebServer70 instance customizer which is accessible from server manager.
 *
 * @author Stepan Herold
 * Adapted by Mukesh Garg for Webserver70 customizer.
 */

public class WS70Customizer extends JTabbedPane {
    ...
    public WS70Customizer(J2eePlatformImpl aPlatform, WS70SunDeploymentManager dm) {
        platform = aPlatform;
        this.dm = dm;
        initComponents ();
    }
    ...
    private void initComponents() {
        getAccessibleContext().setAccessibleName (NbBundle.getMessage(WS70Customizer.class,"ACS_Customizer")); // NOI18N
        ...
        addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                ...
                switch (getSelectedIndex()) {
                    case 0 : helpID = "ws7_customizer_connection"; // NOI18N
                             break;
                    case 1 : helpID = "ws7_customizer_classes";    // NOI18N
                             break;
                    case 2 : helpID = "ws7_customizer_sources";    // NOI18N
                             break;
                    case 3 : helpID = "ws7_customizer_javadoc";    // NOI18N
                             break;
                }
                putClientProperty("HelpID", helpID); // NOI18N
            }
        });
        addTab(NbBundle.getMessage(WS70Customizer.class,"TXT_Connection"), new WS70ConnectionTabVisualPanel(dm));
        addTab(NbBundle.getMessage(WS70Customizer.class,"TXT_Classes"), createPathTab(CLASSPATH)); // NOI18N
    ...
    private static class PathView extends JPanel {
        ...
        private void initComponents() {
            ...
            label.setText(NbBundle.getMessage(WS70Customizer.class,key));
            label.setDisplayedMnemonic(NbBundle.getMessage(WS70Customizer.class,mneKey).charAt(0));
            ...
            resources.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(WS70Customizer.class,ad));
