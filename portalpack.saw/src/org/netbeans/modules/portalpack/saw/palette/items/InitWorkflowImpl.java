...
public class InitWorkflowImpl implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        ...
        Class clazz = null;
        boolean flag = false;
        return RefactoringUtil.addMethod(fObject,NbBundle.getBundle(InitWorkflowImpl.class).getString("InitWorkflowImpl"),false);
