 ...
 * @author Vihang
 */
public class DeleteTask implements ActiveEditorDrop {
private static Logger logger = Logger.getLogger("SAW_Logger");
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        ...
        Class clazz = null;
        boolean flag = false;
         return RefactoringUtil.addMethod(fObject,NbBundle.getBundle(DeleteTask.class).getString("Delete_tasks"),false);
