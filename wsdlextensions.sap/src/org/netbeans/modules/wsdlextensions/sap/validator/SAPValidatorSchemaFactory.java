...
public class SAPValidatorSchemaFactory extends ValidatorSchemaFactory{
    ...
    public String getNamespaceURI() {
        return "http://schemas.sun.com/jbi/wsdl-extensions/sap/";
    }
    
    public InputStream getSchemaInputStream() {
        return SAPValidatorSchemaFactory.class.getResourceAsStream(sapXSDUrl);
    }
    ...
    public Source getSchemaSource() {
        InputStream in = SAPValidatorSchemaFactory.class.getResourceAsStream(sapXSDUrl);
        Source s = new StreamSource(in);
        s.setSystemId(SAPValidatorSchemaFactory.class.getResource(sapXSDUrl).toString());
        return s;
    }
}
