...
package org.netbeans.modules.clearcase.ui.wizard;
...
import org.netbeans.modules.clearcase.RepositoryFile;
import org.netbeans.modules.clearcase.Clearcase;
import org.netbeans.modules.clearcase.ClearcaseException;
import org.netbeans.modules.clearcase.client.LsVobCommand;
...
public class Repository implements ActionListener, DocumentListener, FocusListener, ItemListener {
    ...
    public Repository(int modeMask, String titleLabel) {
        ...
        // TODO: MERGE - populate combo
/*
        ClearcaseCommand cmd1 = new ClearcaseCommand();
        try {
            result1 = cmd1.getClearcaseViews();
        } catch (ClearcaseException ce) {
...
*/
        ...
        for (int i=0; i<result1.size(); i++)
            repositoryPanel.urlComboBox2.addItem(result1.get(i));
