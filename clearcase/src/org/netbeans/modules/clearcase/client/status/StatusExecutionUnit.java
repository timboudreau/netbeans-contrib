 ...
 * @author Tomas Stupka
 */
public abstract class StatusExecutionUnit extends ExecutionUnit implements NotificationListener {
  
    public StatusExecutionUnit(Command ... commands) {
        super("", commands);
        for(Command cmd : commands) {
            cmd.setDelegateListener(this);
        }        
    }         
    
    public void commandStarted()        { /* boring */ }    
    public void errorText(String line)  { /* boring */ }
    public void commandFinished()       { /* boring */ }
    
    protected static abstract class Command extends ClearcaseCommand {
    
        /** The file to get the status for **/
        protected final File file;    
        
        private NotificationListener delegateListener;

        /**
         * Creates a status command.
         * 
         * @param file file to get the status for
        ...
        private void setDelegateListener(NotificationListener l) {
        ...
        public void outputText(String line) {
            ...
            delegateListener.outputText(line);
        }
    }
