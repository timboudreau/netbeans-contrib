...
public class HighlightBoxingUnboxingVarargsTaskFactory extends EditorAwareJavaSourceTaskFactory
        implements ChangeListener, PropertyChangeListener {

        /** Creates a new instance of SemanticHighlighterFactory */
    public HighlightBoxingUnboxingVarargsTaskFactory() {
        super(Phase.RESOLVED, Priority.BELOW_NORMAL, "*");
        
        HighlightBoxingUnboxingVarargs.addChangeListener(this);
        HighlightBoxingUnboxingVarargs.addPropertyChangeListener(this);
    }
    ...
    protected CancellableTask<CompilationInfo> createTask(FileObject file) {
        ...
        if (sourceLevel.equals("1.5")
                ...
                return new HighlightBoxingUnboxingVarargsTask(file);
        }
        return null;
    }
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        HighlightBoxingUnboxingVarargsTask.initKind2Coloring();
        for (FileObject file : getFileObjects()) {
            reschedule(file);
        }
    }
