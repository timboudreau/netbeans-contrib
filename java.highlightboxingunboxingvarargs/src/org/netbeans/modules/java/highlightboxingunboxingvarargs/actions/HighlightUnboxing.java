 ...
 */
public final class HighlightUnboxing extends BooleanStateAction {
    ...
    public String getName() {
        return NbBundle.getMessage(HighlightUnboxing.class, "CTL_HighlightUnboxing");
    }

    @Override
    protected String iconResource() {
        return "org/netbeans/modules/java/highlightboxingunboxingvarargs/actions/resources/unbox.gif";
    }
