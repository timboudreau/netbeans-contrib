...
public class MainClassWarning extends JPanel {
    ...
    private final Collection<TypeElement> mainClasses;
    ...
    public MainClassWarning (String message, final Collection<TypeElement> mainClasses) {
        this (message,null,mainClasses);
    }
    
    private MainClassWarning (final String message, final FileObject[] sourcesRoots, final Collection<TypeElement> mainClasses) {
    ...
    private static MainClassChooser createMainClassChooser (final Collection<TypeElement> mainClasses) {
