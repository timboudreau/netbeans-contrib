 ...
 */
final class JavaSourcePathImplementation implements ClassPathImplementation, PropertyChangeListener {
     ...
     */
    public JavaSourcePathImplementation(SourceRoots sourceRoots, AntProjectHelper projectHelper, PropertyEvaluator evaluator) {
    ...
    private static class SourceRootScannerTask implements Runnable {
        ...
        JavaSourcePathImplementation spi = null;
        ...
        public SourceRootScannerTask(JavaSourcePathImplementation s,
        ...
        public void fileFolderCreated(FileEvent fe) {
            synchronized (this) {
                SourceRootScannerTask task = new SourceRootScannerTask(
                        JavaSourcePathImplementation.this,
                        this,
                        this.paths,
                        (FileObject) fe.getSource(),
                        fe.getFile());
                JavaSourcePathImplementation.REQ_PROCESSOR.post(task);
            }
        }
    }
}
