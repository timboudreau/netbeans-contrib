...
/**
 * Supplies classpath information for Scala installation files such as
 * the standard library, corelibrary stubs, etc.  Based on the
...
//            if (systemRoot != null) {
//                return getScalaClassPaths(file, type, systemRoot);
//            }
//        }
    ...
    private ClassPath getScalaClassPaths(FileObject file, String type, FileObject systemRoot) {
        // Default provider - do this for things like Scala library files
        synchronized (this) {
            ClassPath cp = null;
            if (!file.isFolder()) {
                file = systemRoot;
