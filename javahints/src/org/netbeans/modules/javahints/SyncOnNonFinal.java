...
public class SyncOnNonFinal extends AbstractHint {
    ...
    public List<ErrorDescription> run(CompilationInfo compilationInfo, TreePath treePath) {
        ...
        return Collections.singletonList(ErrorDescriptionFactory.createErrorDescription(getSeverity().toEditorSeverity(), "Synchronization on non-final field", compilationInfo.getFileObject(), start, end));
    }
