...
public class EqualsHint extends AbstractHint {
    ...
    static final String KEY_ARRAY_EQUALS = "arrayequals";
    static final String KEY_INCOMPATIBLE_EQUALS = "incompatibleequals";
    ...
    public EqualsHint(String kind) {
        super(kind == KEY_DELEGATE, false, HintSeverity.WARNING, "array-equals");
        this.kind = kind;
    }
    ...
    static final class ReplaceFixImpl implements Fix {
        ...
        public String getText() {
            return arraysEquals ? "Replace with Arrays.equals" : "Replace with ==";
        }
        ...
        private ModificationResult computeResult() throws Exception {
            return js.runModificationTask(new Task<WorkingCopy>() {
                public void run(WorkingCopy parameter) throws Exception {
                    ...
                    TypeElement arrays = parameter.getElements().getTypeElement("java.util.Arrays");
                    ...
                    if (arraysEquals) {
                        ExpressionTree nueMethod = parameter.getTreeMaker().MemberSelect(parameter.getTreeMaker().QualIdent(arrays), "equals");
