...
public class YiiPhpModuleExtender extends PhpModuleExtender{
    ...
    public Set<FileObject> extend(PhpModule phpModule) throws ExtendingException {
        ...
        assert yiiScript.isValid() : "Yii script has to be valid!";
    ...
    public String getErrorMessage() {
        try {
            YiiScript.getDefault();
        } catch (InvalidPhpProgramException ex) {
            return NbBundle.getMessage(YiiPhpModuleExtender.class, "MSG_CannotExtend", ex.getMessage());
        }
