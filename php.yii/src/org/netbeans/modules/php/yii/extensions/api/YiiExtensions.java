 ...
 */
public class YiiExtensions {
 
    public static String EXTENSIONS_PATH = "PHP/Frameworks/Yii/Extensions";
    private static final Lookup.Result<YiiExtensionProvider> EXTENSIONS = Lookups.forPath(EXTENSIONS_PATH).lookupResult(YiiExtensionProvider.class);
