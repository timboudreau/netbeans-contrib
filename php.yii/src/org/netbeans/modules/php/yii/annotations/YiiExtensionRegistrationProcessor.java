 ...
 */
package org.netbeans.modules.php.yii.annotations;
...
public class YiiExtensionRegistrationProcessor extends BaseRegistrationProcessor<YiiExtensionProvider, YiiExtensionProvider.Registration> {
    ...
    protected String getPath() {
        return YiiExtensions.EXTENSIONS_PATH;
    }

    @Override
    protected int getPosition(YiiExtensionProvider.Registration registration) {
