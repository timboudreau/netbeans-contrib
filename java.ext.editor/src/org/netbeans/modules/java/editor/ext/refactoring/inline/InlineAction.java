...
import org.netbeans.modules.java.editor.ext.refactoring.RefactoringActionsProviderExt;
...
public class InlineAction extends JavaRefactoringGlobalAction {
    ...
    public final void performAction(Lookup context) {
        RefactoringActionsProviderExt.doInlineImpl(context);
    }
    ...
    protected boolean enable(Lookup context) {
        return RefactoringActionsProviderExt.canInline(context);
    }
