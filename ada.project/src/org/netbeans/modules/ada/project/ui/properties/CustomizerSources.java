...
public class CustomizerSources extends javax.swing.JPanel implements HelpCtx.Provider {
    ...
    public CustomizerSources(AdaProjectProperties uiProperties) {
    ...
    private void initComponents() {
        ...
        jLabel1.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_ProjectFolder").charAt(0));
        jLabel1.setLabelFor(projectLocation);
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle"); // NOI18N
        ...
        jLabel2.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_SourceRoots").charAt(0));
        ...
        addSourceRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_AddSourceRoot").charAt(0));
        ...
        removeSourceRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_RemoveSourceRoot").charAt(0));
        ...
        upSourceRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_UpSourceRoot").charAt(0));
        ...
        downSourceRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_DownSourceRoot").charAt(0));
        ...
        jLabel3.setDisplayedMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_TestRoots").charAt(0));
        ...
        jScrollPane2.getAccessibleContext().setAccessibleDescription("null");

        addTestRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_AddTestRoot").charAt(0));
        ...
        removeTestRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_RemoveTestRoot").charAt(0));
        ...
        upTestRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_UpTestRoot").charAt(0));
        ...
        downTestRoot.setMnemonic(java.util.ResourceBundle.getBundle("org/netbeans/modules/ada/project/ui/properties/Bundle").getString("MNE_DownTestRoot").charAt(0));
        ...
        encoding.getAccessibleContext().setAccessibleDescription("null");
