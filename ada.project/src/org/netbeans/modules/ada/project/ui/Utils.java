...
public class Utils {
    ...
    public static SourceRootsMediator registerEditMediator(final AdaProject project,
    ...
    private static class PlatformModel extends DefaultComboBoxModel {
        ...
        private void init () {
            ...
            for (String id : ids) {
                AdaPlatform platform = manager.getPlatform(id);
    ...
    private static class PlatformRenderer implements ListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            if (value instanceof AdaPlatform) {
                AdaPlatform key = (AdaPlatform) value;
                name = key.getName();
            }
...
out:        for( int i = 0; i < files.length; i++ ) {
                ...
                if ((p=FileOwnerQuery.getOwner(normalizedFile.toURI()))!=null && !p.getProjectDirectory().equals(project.getProjectDirectory())) {
                    ...
                    final SourceGroup[] javaGroups = sources.getSourceGroups(AdaProjectType.SOURCES_TYPE_ADA);
