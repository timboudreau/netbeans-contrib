...
public class EmptyAdaProjectPanelVisual extends SettingsPanel implements DocumentListener {
    ...
    public EmptyAdaProjectPanelVisual(PanelConfigureProject panel) {
        initComponents();
        this.panel = panel;
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        .add(projectLocationTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(browseButton))
    ...
    void store(WizardDescriptor d) {
        ...
        d.putProperty(NewAdaProjectWizardIterator.PROP_PROJECT_LOCATION, new File(folder));
        d.putProperty(NewAdaProjectWizardIterator.PROP_PROJECT_NAME, name);
    }
    ...
    public void changedUpdate(DocumentEvent e) {
        ...
        if (this.projectNameTextField.getDocument() == e.getDocument()) {
            firePropertyChange(NewAdaProjectWizardIterator.PROP_PROJECT_NAME, null, this.projectNameTextField.getText());
        }
    }
