...
public final class AdaSourcePath {
    ...
    public static FileType getType(FileObject file) {
        AdaClassPathProvider.FileType type = AdaClassPathProvider.getType(file);
        if (type == AdaClassPathProvider.FileType.SOURCE){
            return FileType.SOURCE;
        }
        else if (type == AdaClassPathProvider.FileType.TEST){
