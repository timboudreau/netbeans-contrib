 ...
 */
public class JavaFXFormatterUnitTest extends JavaFXFormatterUnitTestCase {
    
    public JavaFXFormatterUnitTest(String testMethodName) {
...
/*    public void testReformatArrayInitializerWithNewline() {
        Settings.setValue(JavaFXEditorKit.class, JavaSettingsNames.JAVA_FORMAT_NEWLINE_BEFORE_BRACE, Boolean.TRUE);
        setLoadDocumentText(
                "int[] foo = new int[] {1, 2, 3};");
        reformat();
        assertDocumentText("Incorrect array initializer with newline reformatting",
                "int[] foo = new int[] {1, 2, 3};");
        Settings.setValue(JavaFXEditorKit.class, JavaSettingsNames.JAVA_FORMAT_NEWLINE_BEFORE_BRACE, Boolean.FALSE);
    }
*/    
    /**
