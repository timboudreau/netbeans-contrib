...
public class ElementNode extends AbstractNode implements OffsetProvider {
    ...
    public static Node getTree(CompilationInfo info, Element element) {
        ...
        return new ElementNode(info, element, getSubNodes(info, element));
    }
    ...
    private static List<Node> getSubNodes(CompilationInfo info, Element e) {
        List<Node> ret = new ArrayList<Node>();
        for (Element sub : e.getEnclosedElements()) ret.add(new ElementNode(info, sub, getSubNodes(info, sub)));
        return ret;
    }
