 ...
 * @author leon chiver
 */
public class HibernateDocletSettingsBeanInfo extends SimpleBeanInfo {

    private PropertyDescriptor[] arr;

    public HibernateDocletSettingsBeanInfo() throws IntrospectionException {
        arr = new PropertyDescriptor[1];
        arr[0] = CompletionPrefixSettings.getCompletionPrefixDescriptor(HibernateDocletSettings.class);
    }
