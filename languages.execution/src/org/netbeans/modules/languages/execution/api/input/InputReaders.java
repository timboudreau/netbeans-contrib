...
import org.netbeans.modules.languages.execution.input.FileInputReader;
import org.netbeans.modules.languages.execution.input.StreamInputReader;
...
public final class InputReaders {
    ...
    public static InputReader forReader(Reader reader, Charset charset, boolean greedy) {
        return forStream(new ReaderAdapter(reader, charset), greedy);
    }

    public static InputReader forStream(InputStream stream, boolean greedy) {
        Parameters.notNull("stream", stream);

        return new StreamInputReader(stream, greedy);
    }
