...
public class WeatherFXApplicationWizardIterator implements WizardDescriptor.InstantiatingIterator {

    private int index;
    private WizardDescriptor.Panel[] panels;
    private WizardDescriptor wiz;

    public WeatherFXApplicationWizardIterator() {
    }

    public static WeatherFXApplicationWizardIterator createIterator() {
        return new WeatherFXApplicationWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{new WeatherFXApplicationWizardPanel()};
    }
